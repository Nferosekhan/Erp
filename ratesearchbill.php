...
$query = "SELECT * FROM pairbills where createdid='$companymainid' and franchisesession='".$fsess."' and productid='".$term."' and vendorid='".$custid."' ".$ratedef." group by billno order by billdate desc";
...
{
  $ratedatas['billno'] = $maincategory['billno'];
}
...
{
  $ratedatas['billdate'] = date($datefor,strtotime($maincategory['billdate']));
}
