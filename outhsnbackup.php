...
if (isset($_POST['submitcustomizes'])) {
  ...
  $sqlreportmodules=mysqli_query($con, "select * from pairreportmodules where types='ouwhsn' order by id  asc");
...
$modcolumncol=$coltypemod."ouwhsn";
...
$sqlupreport = "update pairreports set rowcolumns='$modcolumncolchanges' where franchiseid='".$_SESSION['franchisesession']."' and types='ouwhsn' and createdid='$companymainid'"; 
$sqlreportup = mysqli_query($con, $sqlupreport);
  ...
  $sqlreport = mysqli_query($con,"update pairreports set reportperiod='$reportperiod',filtername='$filtername',companyname='$companyname',dateprepare='$dateprepare',timeprepare='$timeprepare' where franchiseid='".$_SESSION['franchisesession']."' and types='ouwhsn' and createdid='$companymainid'");
  header("Location:outwardreporthsn.php?invfrom=".date($datenxt,strtotime($from))."&invto=".date($datenxt,strtotime($to))."");
}
$sqlreportview = mysqli_query($con,"select * from pairreports where franchiseid='".$_SESSION['franchisesession']."' and types='ouwhsn' and createdid='$companymainid'");
...
<div class="row">
<div class="col-lg-6">
<p class="mb-3" style="color:black;font-size: 20px;margin-top: -8px;"> <a href="reports.php" style="color: #1878F1"> <i class="fa fa-pie-chart" aria-hidden="true"></i> <?= $infomainaccessuser['groupname']; ?> </a> &gt; <a href="outwardreport.php?invfrom=<?=$invfrom?>&invto=<?=$invto?>" style="color: #1878F1"> Summary of Outward Supplies (GSTR-1) </a> &gt; HSN-wise summary of outward supplies</p>
</div>
<div class="col-lg-6">
...
<?php
$newans=array();
$sqlreportaccess=mysqli_query($con, "select * from pairreports where franchiseid='".$_SESSION['franchisesession']."' and types='ouwhsn' and createdid='$companymainid' order by id  asc");
...
<input type="checkbox" class="custom-control-input" name="<?= $coltypemod; ?>ouwhsn" id="<?= $coltypemod; ?>ouwhsn" checked disabled>
<label class="custom-control-label custom-label" for="<?= $coltypemod; ?>ouwhsn"> <?= str_replace(" or ", " / ",$newmoduleskey) ?></label>
</div>
</div>                  
</div>
</div>
...
<label class="custom-control-label custom-label" for="taxableamount"> Product Name</label>
</div>
</div>                  
</div>
</div>
...
<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
  <div class="table-responsive m-3" id="histables">
    <table class="table table-bordered">
      ...
      <tbody>
      <?php
      $sqluse=mysqli_query($con, "select * from pairusehistory where usetype='REPouwhsn' and useid='$companymainid' order by createdon desc");
...
<thead>
<tr>
<td class="text-uppercase" style="text-align: left !important;border:1px solid #eee;padding-left: 10px;"><span style="font-size:12px;color:black;"> HSN/SAC</span></td>
<td class="text-uppercase" style="text-align: left !important;border:1px solid #eee;padding-left: 10px;"><span style="font-size:12px;color:black;"> Product Name</span></td>
<td class="text-uppercase" style="text-align: left !important;border:1px solid #eee;padding-left: 10px;"><span style="font-size:12px;color:black;"> Unit</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Quantity</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Total Value</span></td>
...
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Taxable Value</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> CGST</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> SGST</span></td>
<!-- <td class="text-uppercase" style="text-align: right !important;"><span style="font-size:13px;color:black;"> CESS AMOUNT </span></td> -->
</tr>
</thead>
<tbody id="myTable">
<?php
$sql=mysqli_query($con, "select * from pairinvoices where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and (invoicedate>='".$invfrom."' and invoicedate<='".$invto."') and cancelstatus='0' order by producthsn asc,productname asc limit 36");
...
<span style="display: inline-flex;max-width: 100px;min-width: 100px;white-space: nowrap;overflow: hidden;justify-content: start;"><span><?=$info['productname']?></span></span>
</td>
...
<td data-label="Total Value" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><span style="display: inline-flex;max-width: 60px;min-width: 60px;white-space: nowrap;overflow: hidden;justify-content: end;"><span><?=$resmaincurrencyans.number_format((float)$info['productnetvalue'],2,'.',',')?></span></span>
</td>
<td data-label="GST" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;">
<?php
echo '<span style="display: inline-flex;max-width: 60px;min-width: 60px;white-space: nowrap;overflow: hidden;justify-content: end;"><span>'.$info['vat'].'</span>%</span>';
?>
</td>
<td data-label="Taxable Value" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><span style="display: inline-flex;max-width: 60px;min-width: 60px;white-space: nowrap;overflow: hidden;justify-content: end;"><span><?=$resmaincurrencyans.number_format((float)$info['productvalue'],2,'.',',')?></span></span>
</td>
<td data-label="CGST" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;">
<?php
echo '<span style="display: inline-flex;max-width: 60px;min-width: 60px;white-space: nowrap;overflow: hidden;justify-content: end;"><span>'.$resmaincurrencyans.''.number_format((float)$info['cgstvat'],2,'.',',').'</span></span>';
?>
</td>
<td data-label="SGST" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;">
<?php
echo '<span style="display: inline-flex;max-width: 60px;min-width: 60px;white-space: nowrap;overflow: hidden;justify-content: end;"><span>'.$resmaincurrencyans.''.number_format((float)$info['sgstvat'],2,'.',',').'</span></span>';
?>
</td>
...
$sqltotlistpage = mysqli_query($con,"select * from pairinvoices where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and (invoicedate>='".$invfrom."' and invoicedate<='".$invto."') and cancelstatus='0' order by producthsn asc,productname asc");
$chekcspage=0;
while($sqlfetlist = mysqli_fetch_array($sqltotlistpage)){
$chekcspage++;
}
if ($chekcspage==0) {
$pageinitnumpage = 1;
...
$pagetotnumpage = ceil($chekcspage/36);
}
...
<?php
$sqltotlist = mysqli_query($con,"select * from pairinvoices where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and (invoicedate>='".$invfrom."' and invoicedate<='".$invto."') and cancelstatus='0' order by producthsn asc,productname asc");
$chekcs=0;
...
const App = () => (React.createElement(Pagination, { total: <?=ceil($chekcs)?>, showSizeChanger: false, showQuickJumper: true, showTotal: (total, range) => `Total ${range[0]} - ${range[1]} of ${total} items`,
        onChange: pagechanges,defaultPageSize: 36 }));
...
$.ajax({
type: "GET",
url: 'reportviewsearch.php?term='+perpages+'&limitings='+($('#limitforpagenum').val())+'&invfrom=<?=$invfrom?>&invto=<?=$invto?>&dif=outwardhsn',
...
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Product Name</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Unit</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Quantity</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Total Value</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> GST</span></td>
<td class="text-uppercase" style="text-align: right !important;border:1px solid #eee;padding-right: 10px;"><span style="font-size:12px;color:black;"> Taxable Value</span></td>
...
$(function() {
  ...
  $('#calendars').daterangepicker({
    ...
    let invto = $("#invto").val();
    window.open("outwardreporthsn.php?invfrom="+invfrom+"&invto="+invto+"","_self");
  });
});
</script>
<script type="text/javascript">
...
$("#myTables").html("");
<?php
$sql=mysqli_query($con, "select * from pairinvoices where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and (invoicedate>='".$invfrom."' and invoicedate<='".$invto."') and cancelstatus='0' order by producthsn asc,productname asc limit 10");
if (mysqli_num_rows($sql)==0) {
?>
$("#myTables").html('<tr style="vertical-align: middle;"><td data-label="HSN/SAC" style="text-align: left !important;font-size:12px;color:black;border:1px solid #eee;padding-left: 10px;"></td><td data-label="Product Name" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="Unit" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="Quantity" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="Total Value" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="GST" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="Taxable Value" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="CGST" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><td data-label="SGST" style="text-align: right !important;font-size:12px;color:black;border:1px solid #eee;padding-right: 10px;"><?=number_format((float)0,2,'.',',')?></td><!-- <td data-label="CESS AMOUNT " style="text-align: right !important;">0</td> --></tr>');
<?php
}
$sqlbranch=mysqli_query($con, "select franchisename from pairfranchises where id='".$_SESSION['franchisesession']."' ");
$branch=mysqli_fetch_array($sqlbranch);
$sqllimit = mysqli_query($con,"select * from pairinvoices where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and (invoicedate>='".$invfrom."' and invoicedate<='".$invto."') and cancelstatus='0' order by producthsn asc,productname asc");
$countoftotal=0;
while($sqllimits = mysqli_fetch_array($sqllimit)){
$countoftotal++;
}
?>
...
$('#pdfObj').html('<div class="text-center"><span id="timer">Please wait <span id="time"></span> Seconds</span></div><br><img src="loading.gif" width="100%">');
  ...
  sIndex = 0;
  dt = 5000;
var countering = <?=((ceil($countoftotal/500)>0)?ceil($countoftotal/500):1)?>;
...
var finaltimer = setTimeout(function() 
  {
   ...
   doc.setFont(undefined, 'bold');
    ...
    var headtext1 = "HSN-wise summary of outward supplies";
     var fontSize = doc.internal.getFontSize();
     var pageWidth = doc.internal.pageSize.width;
...
var botforprint = 50;
        doc.autoTable({ html: '#print-are3' ,theme: 'plain',headStyles :{fillColor : [245, 242, 242]},margin: {top: 80,bottom: botforprint},styles: { overflow: "hidden",fontSize: 8,fontStyle: 'normal',halign : 'center',fillColor: [255,255,255],lineColor: [204, 204, 204], lineWidth: 0.1},
              didDrawPage: header, 
              columnStyles: { 
                  0: { halign: 'left', cellWidth: 101},
                  1: { halign: 'left', cellWidth: 53},
                  2: { halign: 'left', cellWidth: 53},
                  3: { halign: 'right', cellWidth: 53},
                  4: { halign: 'right', cellWidth: 53},
                  5: { halign: 'right', cellWidth: 53},
                  6: { halign: 'right', cellWidth: 53},
                  7: { halign: 'right', cellWidth: 53},
                  8: { halign: 'right', cellWidth: 53}
              }});
// if (typeof doc.putTotalPages === 'function') { 
...
$.ajax({
type: "GET",
url: 'reporthistory.php?types=ouwhsn&titles=HSN-wise summary of outward supplies&printdownpdfcsv=Printed PDF&fromto='+fromtopdf+'',
success: function (result) {
console.log(result);
},
error: function (error) {
console.log(error);
    ...
    $('#pdfObj').html(obj);
}, <?=((ceil($countoftotal/500)*1000)+1000)?>);
        return;
    }
    else{
      // ajax for get
$.ajax({
type: "GET",
url: 'check.php?term=outwardhsn&invfrom=<?=$invfrom?>&invto=<?=$invto?>&limitfrom='+sIndex+'&limitto='+dt+'',
success: function (result) {
    if (result!=mytabprev) {
...
$.ajax({
type: "GET",
url: 'reporthistory.php?types=ouwhsn&titles=HSN-wise summary of outward supplies&printdownpdfcsv=Downloaded PDF&fromto='+fromtopdf+'',
success: function (result) {
console.log(result);
},
error: function (error) {
console.log(error);
    ...
    doc.save('Outward-Hsn-Reports-<?=$invfrom?>-To-<?=$invto?>');
...
$.ajax({
type: "GET",
url: 'reportcsv.php?term=outwardhsn&from=<?=$invfrom?>&to=<?=$invto?>&branch=<?=(($sqlviewreport['companyname']=='1')?$branch['franchisename']:'')?>&type=HSN-wise summary of outward supplies&fromto='+fromtopdf+'',
success: function (result) {
if(checkdown){
if (result.split(',')[0]=='downloaded') {
for(i=1;i<result.split(',').length;i++){
var filename = result.split(',')[i]+".csv";
var req = new XMLHttpRequest();
req.open("GET", "reports/"+result.split(',')[i]+".csv", true);
...
$.ajax({
type: "GET",
url: 'reporthistory.php?types=ouwhsn&titles=HSN-wise summary of outward supplies&printdownpdfcsv=Downloaded CSV&fromto='+fromtopdf+'',
success: function (result) {
console.log(result);
},
error: function (error) {
