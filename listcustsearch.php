...
if (isset($_GET['term'])) {
$count=1;
                  $sqli=mysqli_query($con, "select * from paircustomers where (franchisesession='".$_SESSION["franchisesession"]."' or cvisiblity='PUBLIC') and (createdid='$companymainid' and moduletype='Customers') ".$_GET['typesforlisting']." order by customername asc limit ".$_GET['term'].",".$_GET['limitings']."");
