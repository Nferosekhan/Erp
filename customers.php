...
<div class="col-lg-3" style="margin-bottom: 57px !important;">
                                 <input class="form-control" id="cussearch" type="text" placeholder="Search.." style="height:24px;">
                                  </div> 
                                 </div>
								<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Customers' order by id  asc");
...
if (($infomainaccessuser['useraccesscreate']==1&&$infomainaccessuser['createdid']!=0)||($infomainaccessuser['createdid']==0)) {
								...
								<a href="customeradd.php" class="btn btn-sm btn-custom"
											style="padding: 0.2rem 0.4rem;"><i class="fa fa-plus"
												style="font-size:13px;"></i> &nbsp; New Customer</a>
...
<li><a class="dropdown-item" href="customerimport.php"><i class="fa fa-download"></i> <?= $infomainaccessuser['modulename'] ?> Import</a></li>
</ul>
<?php
}
?>
...
<div style="visibility: visible;" id="arrowsalltabs">
   ...
   <div class="tab-content" id="nav-tabContent" style="position:relative;top: -88px;">
      <div class="tab-pane fade show active p-3" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
         ...
         {
        ?>
                                            <td class="text-uppercase" style="width:3px;"><span style="font-size:13px;color:black;">#</span></td>
                                            <?php
}
?>
<?php
         ...
         // {
        ?>
                                            <td class="text-uppercase" style="width:130px;"><span style="font-size:13px;color:black;">Name</span></td>
                                            <?php
// }
?>
<?php
         ...
         {
        ?>
                                            <td class="text-uppercase" style="width:36px;"><span style="font-size:13px;color:black;">City</span></td>
                                            <?php
}
?>
<?php
         ...
         {
        ?>
                                            <td class="text-uppercase" style="width:36px;"><span style="font-size:13px;color:black;">E-mail</span></td>
                                            <?php
}
?>
<?php
         ...
         {
        ?>
                                            <td class="text-uppercase" style="width:36px;"><span style="font-size:13px;color:black;">Mobile Number</span></td>
                                            <?php
}
?>
<?php
         ...
         {
        ?>
                                            <td class="text-uppercase" style="width:18px;"><span style="font-size:13px;color:black;">Action</span></td>
                                            <?php
}
?>
<?php
        ...
        ?>
          ...
          ?>
				  ...
				  <?php
				  $count=1;
				  $sqli=mysqli_query($con, "select * from paircustomers where (franchisesession='".$_SESSION["franchisesession"]."' or cvisiblity='PUBLIC') and (createdid='$companymainid' and moduletype='Customers') ".$typesforlisting." order by customername asc limit ".(($access['custpageload']=='pagenum')?'10':'15')."");
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT id) from paircustomers where (franchisesession='".$_SESSION["franchisesession"]."' or cvisiblity='PUBLIC') and (createdid='$companymainid' and moduletype='Customers') ".$typesforlisting."");
...
<?php
if ($access['custpageload']=='pageauto') {
?>
<script type="text/javascript">
...
$.ajax({
type: "GET",
url: 'listcustsearch.php?term=' + sIndex + '&limitings=15&typesforlisting=<?=$typesforlisting?>',
...
$.ajax({
type: "GET",
url: 'listcustsearch.php?term='+perpages+'&limitings='+($('#limitforpagenum').val())+'&typesforlisting=<?=$typesforlisting?>',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
...
function submitthesorting(value) {
  $.ajax({
    type: "GET",
    url: 'listingsortfilters.php?moduletype=Customers&typesforlisting='+value+'',
    success: function (result) {
      console.log(result);
      window.location = 'customers.php?remarks='+result+'';
    },
    error: function (error) {
      console.log(error);
    }
