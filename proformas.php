                    ...
                    <div class="col-12">
                        <div class="card mb-4 mt-5">
                            <div class="card-body p-3" style="color:black;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
								...
								<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Proforma Invoices' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
?>
                      <td class="text-uppercase" style="width:35%;"><span style="font-size:13px;color:black;">Name</span></td>
                      <?php
                                            // }
                                                ?>
                      <?php
...
?>
                      ...
                      <?php
                                                ...
                                                ?>
                      <!-- <td class="text-uppercase" style="width:50px;"><span style="font-size:13px;">Cancel Invoice</span></td> -->
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT proformano,proformadate) from pairproformas where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid'");
...
<?php
if ($access['proformapageload']=='pageauto') {
?>
...
$.ajax({
type: "GET",
url: 'listproformasearch.php?term=' + sIndex + '',
...
?>
<?php
if ($access['proformapageload']=='pagenum') {
?>
<br>
...
$.ajax({
type: "GET",
url: 'listproformasearch.php?term=<?=$i?>0',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to Generate this Proforma Invoice Invoice as Invoice?
            </div>
...
<div class="modal fade" id="deleteconfirm1-adddelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to Generate this Proforma Invoice Invoice as Estimate?
            </div>
