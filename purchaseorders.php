                    ...
                    <div class="col-12">
                        <div class="card mb-4 mt-5">
                            <div class="card-body p-3" style="color:black;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
								...
								<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Purchase Orders' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
<?php
                      ...
                      <?php
                                            ...
                                            // if ((in_array('Name', $modulecolumns))) {
                                                ?>
                      <td class="text-uppercase" style="width:26%;"><span style="font-size:13px;color:black;">Name</span></td>
                      <?php
                                            // }
                                                ?>
                                                <?php
                      ...
                      <?php
                                            ...
                                            // if ((in_array('Edit', $modulecolumns))) {
                                                ?>
                      <!-- <td class="text-uppercase" style="width:10%;"><span style="font-size:13px;color:black;">Edit</span></td> -->
                      <?php
                                            // }
                                                ?>
                                                <?php
                      ...
                      <?php
                                            ...
                                            if ((in_array('Bill', $modulecolumns))) {
                                                ?>
					  <td class="text-uppercase" style="width:10%;"><span style="font-size:13px;color:black;"><?= $infomainaccessbill['modulename'] ?></span></td>
                      <?php
                                            }
                                                ?>
					  <!-- <td class="text-uppercase" style="width:10%;"><span style="font-size:13px;color:black;"><?= $infomainaccessbill['modulename'] ?></span></td> -->
                      <!--td class="text-uppercase" style="width:50px;"><span style="font-size:13px;">Cancel Purchase Order</span></td-->
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT purchaseorderno,purchaseorderdate) from pairpurchaseorders where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid'");
...
<?php
if ($access['purorderpageload']=='pageauto') {
?>
...
$.ajax({
type: "GET",
url: 'listpurordersearch.php?term=' + sIndex + '',
...
?>
<?php
if ($access['purorderpageload']=='pagenum') {
?>
<br>
...
$.ajax({
type: "GET",
url: 'listpurordersearch.php?term=<?=$i?>0',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
...
<div class="modal fade" id="deleteconfirm-adddelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<form action="purchaseordercancel.php" method="post">
		<input type="hidden" name="cancelstatus" id="cancelstatus">
            ...
            <div class="modal-body">
				...
				<table class="table">
				<tr>
				<th>Purchase Order No</th><td><input type="text" name="purchaseorderno" id="purchaseorderno" class
				="form-control form-control-sm" readonly required></td>
				</tr>
				<tr>
				<th>Purchase Order Date</th><td><input type="text" name="purchaseorderdate" id="purchaseorderdate" class
				="form-control form-control-sm" readonly required></td>
				</tr>
				<tr>
				<th>Total Amount</th><td><input type="text" name="purchaseorderamount" id="purchaseorderamount" class
				="form-control form-control-sm" readonly required></td>
				</tr>
				<tr>
...
<div class="modal fade" id="deleteconfirm1-adddelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
 ...
 ?>
 <script>
function deleteitem(purchaseorderno,purchaseorderdate,purchaseorderamount,cancelstatus)
{
	$('#purchaseorderno').val(purchaseorderno);
	$('#purchaseorderdate').val(purchaseorderdate);
	$('#purchaseorderamount').val(purchaseorderamount);
