...
?>
    <title>
        Configuration &gt; Country & Time Zone &gt; Label
    </title>
    <style>
                        ...
                        <div class="card mb-4 mt-5">
                            <div class="card-body py-2"
                                ...
                                <p style="color:black;font-size: 14.6px;border-bottom: 1px solid #dee2e6;" class="mb-3"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration </a><span>&gt;</span><a href="configuration_country_view.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Country & Time Zone </a> <span>&gt;</span> Label  <!-- <i class="fa fa-file-import"></i> --></p>
                                <p class="mb-3" style="color:black;font-size: 20px;"><i
                                        class="fa fa-file-import"></i> Country & Time Zone</p>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select style=" width: 100%"
                                                                        ...
                                                                        <?php
$sqlis = mysqli_query($con, "select country from paricountry");
while ($infos = mysqli_fetch_array($sqlis)) {
?>
                                                                        <option value="<?= $infos['country'] ?>">
                                                                            <?= $infos['country'] ?>
                                                                        </option>
                                                                        <?php
}
...
?>
    ...
    <button
                                                                            ...
                                                                            <span class="label">Save</span> <span
                                                                                class="spinner"></span>
                                                                        </button>  <a class="btn btn-primary btn-sm btn-custom-grey" href="franchises.php">Cancel</a>
    </div>
</div>
