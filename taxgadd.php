...
$msg_class = "";
	...
	{		
        ...
        if($rowCountcon == 0) 
		{	
			$sqlup = "insert into pairtaxrates set createdon='$times', createdid='$companymainid', createdby='".$_SESSION["unqwerty"]."', tax='$tax',  taxname='$taxname', taxgroups='$taxgroups'";
			...
			else
			{
                ...
                $sqluphis = "insert into pairusehistory set usetype='TAXG',useid='$tid',createdon='$times', createdby='".$_SESSION["unqwerty"]."',useremarks='Tax Group Created'";
...
?>
  <title>
    Configuration &gt; Tax Rates &gt; New Tax Group
  </title>
<style>
          ...
          <div class="card mb-4 mt-5">
             <div class="card-body py-1" style="font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
                                <p style="color:black;font-size: 14.6px;border-bottom: 1px solid #dee2e6;" class="mb-2"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration </a><span>&gt;</span><a href="taxs.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Tax Rates </a> <span>&gt;</span> New Tax Group  <!-- <i class="fa fa-file-import"></i> --></p>
             	<p class="mb-3"style="font-size: 20px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;"><i class="fa fa-file-import"></i>   New Tax Group</p>
...
<div class="col-lg-6">
  <div class="form-group row">
  	<div class="col-sm-4">
    <label for="taxname" class="custom-label text-danger">Tax Group Name *</label>
     </div>
     <div class="col-sm-8">
    <input type="text" class="form-control  form-control-sm" id="taxname" name="taxname" required>
    </div>
  </div>
</div>
</div>
        ...
        <div class="table-responsive p-3" style="width:100%;">
               ...
               <?php
                  ...
                  while($infos=mysqli_fetch_array($sqlis))
                  {
                      ?><br>
                     <tr>
                     <td class="tsno" data-label="Select"><input type="checkbox" name="taxes[]" value="<?=$infos['id']?>"></td><td class="ttname" data-label="Tax Name"> <?=$infos['taxname']?></td>  <td style="text-align:right;" class="ttrate" data-label="Tax Rate"><?=$infos['tax']?> %</td></tr>
                      <?php
