...
if((($infomainaccessuser['createdid']=='0')&&($infomainaccessuser['groupaccess']=='0'))||((($infomainaccessuser['createdid']!='0'))&&(($infomainaccessuser['groupaccess']=='0')||($infomainaccessuser['useraccessview']==0)||($infomainaccessuser['useraccessedit']==0)))) {
...
?>
  <title>
    Edit <?= $infomainaccessuser['groupname'] ?>
  </title>
</head>
...
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
 ...
 <p class="mb-3" style="font-size:20px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;"><i class="fa fa-file-import"></i> Edit <?= $infomainaccessuser['groupname'] ?></p>
...
<form action="expenseadds.php" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
...
?>
<option value="<?= $infos['headername'] ?>" <?=($infos['headername']==$info['headername'])?'selected':''?>><?= $infos['headername'] ?></option>
<?php
}
?>
  </select>
    ...
    <div class="col-lg-6">
        <div class="form-group row">
		  ...
		  <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control  form-control-sm" id="paymentmode" name="paymentmode" placeholder="Mode of Payment" value="<?=$info['paymentmode']?>">			  
            </div>
			</div>
            ...
            <div class="col-sm-8">
              <input type="number" class="form-control  form-control-sm" id="amount" name="amount" placeholder="Amount" required value="<?=$info['amount']?>">
