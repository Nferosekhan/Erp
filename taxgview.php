...
?>
    <title>
        Configuration &gt; Tax Rates &gt; Tax Group Details
    </title>
    <style>
...
window.setTimeout(function() {
    $(".alert").fadeTo(1000, 0).slideUp(1000, function(){
                        ...
                        <div class="card mb-4 mt-5">
                            <div class="card-body py-1"
                                ...
                                <p style="color:black;font-size: 14.6px;border-bottom: 1px solid #dee2e6;" class="mb-2"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration </a><span>&gt;</span><a href="taxs.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Tax Rates </a> <span>&gt;</span> Tax Group Details  <!-- <i class="fa fa-file-import"></i> --></p>
                                <div class="row">
                                    <div class="col-lg-6">
                  ...
                  $info=mysqli_fetch_array($sqli);
                      ?>
                                                <a class="btn btn-primary btn-sm btn-custom-grey"
                                                    onclick="window.open('taxgedit.php?id=<?=$info['id']?>', '_self')"
                                        ...
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                            ...
                                            <div class="row m-3" style="align-items: center;">
                                                <div class="col-sm-3 col-md-2 col-6">
                                                    <span style="font-size:13px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
                                                    Tax Group Name</span>
                                                </div>
        ...
        <div class="form-group row">
            <div class="col-lg-2">
            <span for="tax" class="custom-label" style="color:black;font-size: 13px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">Associate Taxes %</span>
            </div>
            <div class="col-lg-6">
                <div class="table-responsive p-3" style="width:100%;">
                    <br><br><br><br>
                <table class="table align-items-center table-bordered mb-0 gsttable" style="width:100%;margin-left: -12.3px !important;">
                                                    <thead>
                                                        <tr>
               ...
               <?php
                  ...
                  {
                      ?><br><tr>
                     <td class="tsno" data-label="Select"><input type="checkbox" name="taxes[]" value="<?=$infos['id']?>" <?=(in_array($infos['id'],$taxes))?'checked':''?> disabled></td><td class="ttname" data-label="Tax Name"><?=$infos['taxname']?></td> <td style="text-align:right;" class="ttrate" data-label="Tax Rate"><?=$infos['tax']?> %</td></tr>
                      <?php
                                        ...
                                        <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                            ...
                                            <div class="table-responsive m-3">
                                                <table class="table table-bordered" style="table-layout: fixed;">
                                                    ...
                                                    <tbody>
                                                        <?php
      $sqluse=mysqli_query($con, "select * from pairusehistory where usetype='TAXG' and useid='$id' order by createdon desc");
      ...
      <td data-label="DETAILS"><?=$infouse['useremarks']?> <br> <span><?=(($infouse['useremarks']=='Tax Group Created')?'Created By':'Changed By')?></span> <span  style="color:grey"><?=$info['createdby']?></span></td>
    </tr>
                                                        <?php
    }
      ?>
