...
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">'.(strtoupper($infomainaccesscreditnote['modulename'])).' DATE</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">'.(strtoupper($infomainaccesscreditnote['modulename'])).' NUMBER</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:right;">'.(strtoupper($infomainaccesscreditnote['modulename'])).' AMOUNT</span></th>
...
$html .= '<input type="hidden" name="nos[]" id="creditnote'.$i.'" value="'.$infos['creditnoteno'].'">
...
<td data-label="'. strtoupper($infomainaccesscreditnote['modulename']) .' DATE" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.date('d/m/Y',strtotime($infos['creditnotedate'])).'</td>
<td data-label="'. strtoupper($infomainaccesscreditnote['modulename']) .' NUMBER" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.$infos['creditnoteno'].'</td>
<td data-label="'. strtoupper($infomainaccesscreditnote['modulename']) .' AMOUNT" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:right;border: 1px solid #cccccc !important;padding:0px 3px;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.(number_format((float)$infos['grandtotal'],2,'.','')).'</td>
