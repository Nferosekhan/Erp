	 ...
	 <div style="max-width: 1650px;">
              ...
              <div class="row">
                ...
                <div class="col-lg-3" style="margin-bottom: 57px !important;"> 
                  <input class="form-control" id="venrefsearch" type="text" placeholder="Search.." style="height:24px;">
                </div>
              </div>
                                <?php 
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Vendor Refunds' order by id  asc");
...
if (($infomainaccessuser['useraccesscreate']==1&&$infomainaccessuser['createdid']!=0)||($infomainaccessuser['createdid']==0)) {
       ...
       <?php
                            ...
                            ?>
			<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Vendor Refunds' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
$sql=mysqli_query($con,"select id, createdon, term, receiptdate, receiptno, cancelstatus, vendorid, vendorname, paymentmode, amount, notes,publicid,privateid from pairdebitnotepayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' ".$typesforlisting." order by id desc limit ".(($access['purreturnpaypageload']=='pagenum')?'10':'15')."");
$count=1;
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT id) from pairdebitnotepayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' ".$typesforlisting."");
...
$.ajax({
type: "GET",
url: 'listvendorrefundssearch.php?term=' + sIndex + '&limitings=15&typesforlisting=<?=$typesforlisting?>',
...
$.ajax({
type: "GET",
url: 'listvendorrefundssearch.php?term='+perpages+'&limitings='+($('#limitforpagenum').val())+'&typesforlisting=<?=$typesforlisting?>',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
...
function submitthesorting(value) {
  $.ajax({
    type: "GET",
    url: 'listingsortfilters.php?moduletype=Vendor Refunds&typesforlisting='+value+'',
    success: function (result) {
      console.log(result);
      window.location = 'vendorrefunds.php?remarks='+result+'';
    },
    error: function (error) {
      console.log(error);
    }
