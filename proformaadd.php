...
if (($infomainaccessuser['proformacustinfo']=='defone')||($infomainaccessuser['proformacustinfo']=='deftwo')) {
...
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Proforma Invoices' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
if ($infomainaccessuser['proformacustinfo']=='one'||($scriptonetwo=='one')) {
...
$proformaterm=mysqli_real_escape_string($con, $_POST['proformaterm']);

$sqlismainaccessuser=mysqli_query($con, "select moduleno, moduleprefix, modulesuffix from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Proforma Invoices' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
$proformano=mysqli_real_escape_string($con, $infomainaccessuser['moduleprefix'].(str_pad($infomainaccessuser['modulesuffix']+1, 0, "0", STR_PAD_LEFT)));

$proformadate=mysqli_real_escape_string($con, $_POST['proformadate']);
...
$proformaamount=mysqli_real_escape_string($con, $_POST['grandtotal']);
...
$custsqluse=mysqli_query($con, "insert into pairusehistory set usetype='CUSTOMERS', createdon='$times',  createdby='".$_SESSION["unqwerty"]."', useid='$custid', useremarks='".$custch."' ");
               ...
               if ($infomainaccessuser['proformacustinfo']=='two'||($scriptonetwo=='two')) {
$address1 = '';
$address2 = '';
$saddress1 = '';
$saddress2 = '';
...
$sql2=mysqli_query($con, "select id from pairproformas where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and proformano='$proformano' and proformadate='$proformadate'");
...
$tid=mysqli_insert_id($con);
mysqli_query($con, "INSERT INTO pairhistory (user, ipaddress, times, remarks, tid) VALUES ('{$username}', '{$ip}', '{$times}', 'Insert A Proforma', '{$tid}')");

$sql3=mysqli_query($con, "update pairmainaccess set modulesuffix=modulesuffix+1 where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Proforma Invoices'");
if($sql3)
{
 if(isset($_POST['submit1']))
{
echo '<script> window.open("proformaprint.php?proformano='.$proformano.'&proformadate='.$proformadate.'", "_blank");</script>';
echo '<script> window.location.href="proformas.php?remarks=Added Successfully";</script>'; 
}
else
{
echo '<script> window.location.href="proformaview.php?proformano='.$proformano.'&proformadate='.$proformadate.'&remarks=Added Successfully";</script>';
}
}
}
else
{
header("Location: proformas.php?error=Error Data");
}
}
...
$sqlismainaccessuser=mysqli_query($con, "select moduleno, moduleprefix, modulesuffix,modulename from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Proforma Invoices' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
?>
...
<!-------------------customer add info end ------------------------------->
<form id="proformaform" action="" onsubmit="return checkvalidate()" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
<div class="row">
<!-- <div class="col-lg-6">
...
<?php
     if ((in_array('Proforma Invoice Information', $fieldadd))) {
        ?>
<div class="col-lg-4">
<div class="accordion" id="accordionRental">
<div class="accordion-item mb-1">
...
<div class="col-lg-5">
<label for="proformano" class="custom-label"><span class="text-danger"><?= $infomainaccessuser['modulename'] ?> Number *</span></label>
</div>
<div class="col-lg-7">
<input type="text" class="form-control  form-control-sm" id="proformano" name="proformano" required value="<?=$infomainaccessuser['moduleprefix']?><?=str_pad(($infomainaccessuser['modulesuffix']+1), 0, "0", STR_PAD_LEFT)?>" readonly>
</div>
</div>
</div>
<div class="col-lg-12">
...
<label for="proformadate" class="custom-label"><span class="text-danger"><?= $infomainaccessuser['modulename'] ?> Date *</span></label>
</div>
<div class="col-lg-7">
<?php
...
$dt = new DateTime();
?>
<input type="date" class="form-control  form-control-sm" id="proformadate" name="proformadate" value="<?= $dt->format('Y-m-d') ?>" required>
</div>
</div>
</div>
<?php
...
<div class="form-group row" style="align-items: center !important;">
<div class="col-lg-5" style="padding-right:0px">
<label for="proformadate" class="custom-label"><span class="text-danger"><?= $infomainaccessuser['modulename'] ?> Term *</span></label>
</div>
<div class="col-lg-7">
<select class="select2-field form-control  form-control-sm" name="proformaterm" id="proformaterm" required>
...
today=addDays(proformadate, duedates);
...
<input type="radio" class="custom-control-input" name="customerinfodefault" id="onecustomerinfo" value="one" <?= ($infomainaccessuser['proformacustinfo']=='defone')?'checked':'' ?> onclick="onetwo()">
<label class="custom-control-label custom-label" for="onecustomerinfo">B2B</label>
</div>
</div>
<div class="col-lg-2 col-md-2 col-3">
<div class="custom-control custom-radio mr-sm-2">
<input type="radio" class="custom-control-input" name="customerinfodefault" id="twocustomerinfo" value="two" <?= ($infomainaccessuser['proformacustinfo']=='deftwo')?'checked':'' ?> onclick="onetwo()">
...
<?php
if ($access['proformabtwocnamerequired']=='Yes') {
?>
$("#twocustomername").removeAttr("required");
<?php
}
if ($access['proformabtwocwphonerequired']=='Yes') {
?>
...
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Proforma Invoices' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
if ($infomainaccessuser['proformacustinfo']=='one'||(($infomainaccessuser['proformacustinfo']=='defone')||($infomainaccessuser['proformacustinfo']=='deftwo'))) {
?>
<div id="one">
<div class="row">
<div class="col-lg-12">
...
if ($infomainaccessuser['proformacustinfo']=='two'||(($infomainaccessuser['proformacustinfo']=='defone')||($infomainaccessuser['proformacustinfo']=='deftwo'))) {
?>
<script type="text/javascript">
function twoposans() {
...
<?= ($access['proformabtwocnamerequired']=='Yes')? '<span class="text-danger">'. $infomainaccessusercus['modulename'] . ' Name * </span>': $infomainaccessusercus['modulename'] . ' Name ' ?>
</label>
</div>
<div class="col-lg-9">
<input type="text" name="twocustomername" id="twocustomername" class="form-control form-control-sm" placeholder="<?= $infomainaccessusercus['modulename'] ?> Name" <?= ($access['proformabtwocnamerequired']=='Yes')? 'required': ' ' ?>>
</div>
</div>
<div class="row mt-1">
<div class="col-lg-12">
...
<?= ($access['proformabtwocwphonerequired']=='Yes')? '<span class="text-danger"> WORK PHONE * </span>': ' WORK PHONE ' ?>
</label>
<input type="text" class="form-control form-control-sm" id="twoworkphone" name="twoworkphone" placeholder="Work Phone" <?= ($access['proformabtwocwphonerequired']=='Yes')? 'required': ' ' ?>>
</div>
...
<input type="text" class="form-control form-control-sm" id="twogsttreatment" name="twogsttreatment" placeholder="GST TREATMENT" value="<?= $infomainaccessuser['proformatwogst'] ?>" readonly>
</div>
...
<option disabled value="" <?=($infomainaccessuser['proformatwopos']=='manual'||'auto')?'selected':''?>>Select The Place</option>
<option value="JAMMU AND KASHMIR (1)" <?=($infomainaccessuser['proformatwopos']=="JAMMU AND KASHMIR (1)")?'selected':''?>>JAMMU AND KASHMIR (1)</option>
<option value="ANDAMAN AND NICOBAR ISLANDS (35)" <?=($infomainaccessuser['proformatwopos']=="ANDAMAN AND NICOBAR ISLANDS (35)")?'selected':''?>>ANDAMAN AND NICOBAR ISLANDS (35)</option>
<option value="ANDHRA PRADESH (NEWLY ADDED) (37)" <?=($infomainaccessuser['proformatwopos']=="ANDHRA PRADESH (NEWLY ADDED) (37)")?'selected':''?>>ANDHRA PRADESH (NEWLY ADDED) (37)</option>
<option value="ANDHRA PRADESH(BEFORE DIVISION) (28)" <?=($infomainaccessuser['proformatwopos']=="ANDHRA PRADESH(BEFORE DIVISION) (28)")?'selected':''?>>ANDHRA PRADESH(BEFORE DIVISION) (28)</option>
<option value="ARUNACHAL PRADESH (12)" <?=($infomainaccessuser['proformatwopos']=="ARUNACHAL PRADESH (12)")?'selected':''?>>ARUNACHAL PRADESH (12)</option>
<option value="ASSAM (18)" <?=($infomainaccessuser['proformatwopos']=="ASSAM (18)")?'selected':''?>>ASSAM (18)</option>
<option value="BIHAR (10)" <?=($infomainaccessuser['proformatwopos']=="BIHAR (10)")?'selected':''?>>BIHAR (10)</option>
<option value="CENTRE JURISDICTION (99)" <?=($infomainaccessuser['proformatwopos']=="CENTRE JURISDICTION (99)")?'selected':''?>>CENTRE JURISDICTION (99)</option>
<option value="CHANDIGARH (4)" <?=($infomainaccessuser['proformatwopos']=="CHANDIGARH (4)")?'selected':''?>>CHANDIGARH (4)</option>
<option value="CHATTISGARH (22)" <?=($infomainaccessuser['proformatwopos']=="CHATTISGARH (22)")?'selected':''?>>CHATTISGARH (22)</option>
<option value="DADRA AND NAGAR HAVELI AND DAMAN AND DIU (NEWLY MERGED UT) (26*)" <?=($infomainaccessuser['proformatwopos']=="DADRA AND NAGAR HAVELI AND DAMAN AND DIU (NEWLY MERGED UT) (26*)")?'selected':''?>>DADRA AND NAGAR HAVELI AND DAMAN AND DIU (NEWLY MERGED UT) (26*)</option>
<option value="DELHI (7)" <?=($infomainaccessuser['proformatwopos']=="DELHI (7)")?'selected':''?>>DELHI (7)</option>
<option value="GOA (30)" <?=($infomainaccessuser['proformatwopos']=="GOA (30)")?'selected':''?>>GOA (30)</option>
<option value="GUJARAT (24)" <?=($infomainaccessuser['proformatwopos']=="GUJARAT (24)")?'selected':''?>>GUJARAT (24)</option>
<option value="HARYANA (6)" <?=($infomainaccessuser['proformatwopos']=="HARYANA (6)")?'selected':''?>>HARYANA (6)</option>
<option value="HIMACHAL PRADESH (2)" <?=($infomainaccessuser['proformatwopos']=="HIMACHAL PRADESH (2)")?'selected':''?>>HIMACHAL PRADESH (2)</option>
<option value="JHARKHAND (20)" <?=($infomainaccessuser['proformatwopos']=="JHARKHAND (20)")?'selected':''?>>JHARKHAND (20)</option>
<option value="KARNATAKA (29)" <?=($infomainaccessuser['proformatwopos']=="KARNATAKA (29)")?'selected':''?>>KARNATAKA (29)</option>
<option value="KERALA (32)" <?=($infomainaccessuser['proformatwopos']=="KERALA (32)")?'selected':''?>>KERALA (32)</option>
<option value="LADAKH (NEWLY ADDED) (38)" <?=($infomainaccessuser['proformatwopos']=="LADAKH (NEWLY ADDED) (38)")?'selected':''?>>LADAKH (NEWLY ADDED) (38)</option>
<option value="LAKSHADWEEP (31)" <?=($infomainaccessuser['proformatwopos']=="LAKSHADWEEP (31)")?'selected':''?>>LAKSHADWEEP (31)</option>
<option value="MADHYA PRADESH (23)" <?=($infomainaccessuser['proformatwopos']=="MADHYA PRADESH (23)")?'selected':''?>>MADHYA PRADESH (23)</option>
<option value="MAHARASHTRA (27)" <?=($infomainaccessuser['proformatwopos']=="MAHARASHTRA (27)")?'selected':''?>>MAHARASHTRA (27)</option>
<option value="MANIPUR (14)" <?=($infomainaccessuser['proformatwopos']=="MANIPUR (14)")?'selected':''?>>MANIPUR (14)</option>
<option value="MEGHALAYA (17)" <?=($infomainaccessuser['proformatwopos']=="MEGHALAYA (17)")?'selected':''?>>MEGHALAYA (17)</option>
<option value="MIZORAM (15)" <?=($infomainaccessuser['proformatwopos']=="MIZORAM (15)")?'selected':''?>>MIZORAM (15)</option>
<option value="NAGALAND (13)" <?=($infomainaccessuser['proformatwopos']=="NAGALAND (13)")?'selected':''?>>NAGALAND (13)</option>
<option value="ODISHA (21)" <?=($infomainaccessuser['proformatwopos']=="ODISHA (21)")?'selected':''?>>ODISHA (21)</option>
<option value="OTHER TERRITORY (97)" <?=($infomainaccessuser['proformatwopos']=="OTHER TERRITORY (97)")?'selected':''?>>OTHER TERRITORY (97)</option>
<option value="PUDUCHERRY (34)" <?=($infomainaccessuser['proformatwopos']=="PUDUCHERRY (34)")?'selected':''?>>PUDUCHERRY (34)</option>
<option value="PUNJAB (3)" <?=($infomainaccessuser['proformatwopos']=="PUNJAB (3)")?'selected':''?>>PUNJAB (3)</option>
<option value="RAJASTHAN (8)" <?=($infomainaccessuser['proformatwopos']=="RAJASTHAN (8)")?'selected':''?>>RAJASTHAN (8)</option>
<option value="SIKKIM (11)" <?=($infomainaccessuser['proformatwopos']=="SIKKIM (11)")?'selected':''?>>SIKKIM (11)</option>
<option value="TAMIL NADU (33)"  <?=($infomainaccessuser['proformatwopos']=="TAMIL NADU (33)")?'selected':''?>>TAMIL NADU (33)</option>
<option value="TELANGANA (36)" <?=($infomainaccessuser['proformatwopos']=="TELANGANA (36)")?'selected':''?>>TELANGANA (36)</option>
<option value="TRIPURA (16)" <?=($infomainaccessuser['proformatwopos']=="TRIPURA (16)")?'selected':''?>>TRIPURA (16)</option>
<option value="UTTAR PRADESH (9)" <?=($infomainaccessuser['proformatwopos']=="UTTAR PRADESH (9)")?'selected':''?>>UTTAR PRADESH (9)</option>
<option value="UTTARAKHAND (5)" <?=($infomainaccessuser['proformatwopos']=="UTTARAKHAND (5)")?'selected':''?>>UTTARAKHAND (5)</option>
<option value="WEST BENGAL (19)" <?=($infomainaccessuser['proformatwopos']=="WEST BENGAL (19)")?'selected':''?>>WEST BENGAL (19)</option>
</select>
</div>
</div>
</div>
...
href="proformas.php" style="margin-top:-3px !important;">Cancel</a>
...
$("#customer").on("select2:open", function() {
<?php
if($access['proformanewcustomerdef']=='1'){
?>
$("#configureunits").show();
...
$("#product1").on("select2:open", function() {
<?php
if($access['proformanewproductdef']=='1'){
?>
$("#configureunits").show();
...
<script type="text/javascript">
$(function() {
$("#proformasuffix").autocomplete({
source: 'proformasuffixsearch.php',
select: function(event, ui) {
$("#proformasuffix").val(ui.item.proformasuffix);
...
<!------------------------------------------- pro script end ------------------------------------------->
<!--term start-->
<div class="modal fade" id="AddNewProformaTerm" tabindex="-1" role="dialog" style="z-index: 1051;">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title">New <?= $infomainaccessuser['modulename'] ?> Term</h5>
<span type="button" onclick="funesproformaterm()" class="close" data-dismiss="modal"
aria-label="Close">
...
<div class="form-group row">
<div class="col-sm-6">
<label for="missingproformaterm" class="custom-label"><span class="text-danger">
<?= $infomainaccessuser['modulename'] ?> Term *</span></label>
</div>
<div class="col-sm-6">
<input type="text" name="proformaterm" class="form-control form-control-sm mb-4" id="missingproformaterm" placeholder="Name" required>
</div>
</div>
</div>
</div>
...
<div class="col">
<button   onclick="funaddproformaterm()" class="btn btn-primary btn-sm btn-custom arlina-button expand-left"   type="submit"  name="submitproformaterm" value="Submit">
<span class="label">Save</span> <span class="spinner"></span>
</button>
<button type="button"
class="btn btn-primary btn-sm btn-custom-grey"
onclick="funesproformaterm()">Cancel</button> </div>
</div>
</div>
</div>
</div>
<script>
$("#proformaterm").on("change", function() {
var sOptionVal = $(this).val();
if (sOptionVal == '#AddNewProformaTerm') {
$('#AddNewProformaTerm').modal('show');
}
});
function funaddproformaterm() {
var missingproformaterm = document.getElementById('missingproformaterm');
if (missingproformaterm.value == '') {
alert('Please Enter New ProformaTerm Name');
missingproformaterm.focus();
return false;
} else {
...
{
$('#proformaterm').append('<option value="' + missingproformaterm.value + '">' + missingproformaterm.value +
'</option>');
$('#proformaterm').val(missingproformaterm.value).change();
$("#proformaterm").select2();
$('#AddNewProformaTerm').modal('hide');
return false;
}
}});
...
function funesproformaterm() {
//$('#proformaterm').val('').change();
$("#proformaterm").select2();
$('#AddNewProformaTerm').modal('hide');
return false;
}
...
$("#proformaterm").on("select2:open", function() {
$("#configureunits").attr("data-bs-target","#AddNewProformaTerm");
});
$("#proformaterm").on("select2:open", function() {
document.getElementById("configureunits").innerHTML = "New ProformaTerm";
});
</script>
...
<!---payment confirm---->
<script>
function triggerpayment(proformano,proformadate,proformaamount,cancelstatus)
{
let allAreFilled = true;
document.getElementById("proformaform").querySelectorAll("[required]").forEach(function(i) {
if (!allAreFilled) return;
if (i.type === "radio") {
let radioValueCheck = false;
document.getElementById("proformaform").querySelectorAll(`[name=${i.name}]`).forEach(function(r) {
...
{
$('#validproformano').val($('#proformano').val());
$('#validproformadate').val($('#proformadate').val());
$('#validproformaamount').val($('#grandtotal').val());
