...
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">'.(strtoupper($infomainaccessdebitnote['modulename'])).' DATE</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">'.(strtoupper($infomainaccessdebitnote['modulename'])).' NUMBER</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:right;">'.(strtoupper($infomainaccessdebitnote['modulename'])).' AMOUNT</span></th>
...
$html .= '<input type="hidden" name="nos[]" id="debitnote'.$i.'" value="'.$infos['debitnoteno'].'">
...
<td data-label="'. strtoupper($infomainaccessdebitnote['modulename']) .' DATE" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.date('d/m/Y',strtotime($infos['debitnotedate'])).'</td>
<td data-label="'. strtoupper($infomainaccessdebitnote['modulename']) .' NUMBER" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.$infos['debitnoteno'].'</td>
<td data-label="'. strtoupper($infomainaccessdebitnote['modulename']) .' AMOUNT" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:right;border: 1px solid #cccccc !important;padding:0px 3px;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.(number_format((float)$infos['grandtotal'],2,'.','')).'</td>
