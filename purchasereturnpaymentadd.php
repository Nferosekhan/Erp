...
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
            ...
            ?>
                                                    <?php
     if ((in_array('Public Id', $fieldadd))) {
        ?>
...
<?php
            ...
            ?>
<?php
     if ((in_array('Private Id', $fieldadd))) {
        ?>
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
...
<input type="number" class="form-control  form-control-sm" id="amount" name="amount" placeholder="Amount Received" required style="border-left: 1px solid #ced4da !important;border-radius: 0px !important;margin-left: 3px !important;">
</div>
