                ...
                <div class="row min-height-480">
                  ...
                  <!-- </p> -->
                                ...
                                <!-- <div class="row"> -->
                                 ...
                                 <input class="form-control" id="servsearch" type="text" placeholder="Search.." style="height:24px;">
                                  </div> 
                                 </div>
                             <!-- </div>     -->
                             <?php 
...
?>
  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
    <li><a class="dropdown-item" href="serviceimport.php"><i class="fa fa-download"></i> Service Import</a></li>
  </ul>
<?php
}
?>
...
<?php
         ...
         {
        ?>
                                                <td class="text-uppercase category" style="width:25px;"><span style="font-size:13px;color:black;">Category</span></td>
                                                <?php
          }
          ?>
<?php
...
<?php
         ...
         {
        ?>
                                                <td class="text-uppercase saleprice" style="width:30px;"
...
<?php
        ...
        ?>
          ...
          ?>
                  ...
                  $count=1;
                  $sqli=mysqli_query($con, "select * from pairproducts where createdid='$companymainid' and ((franchisesession='".$_SESSION["franchisesession"]."' and pvisiblity='PRIVATE') or pvisiblity='PUBLIC') and itemmodule='Services' ".$typesforlisting." order by productname asc limit ".(($access['servpageload']=='pagenum')?'10':'15')."");
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT id) from pairproducts where createdid='$companymainid' and ((franchisesession='".$_SESSION["franchisesession"]."' and pvisiblity='PRIVATE') or pvisiblity='PUBLIC') and itemmodule='Services' ".$typesforlisting."");
...
<?php
if ($access['servpageload']=='pageauto') {
?>
<script type="text/javascript">
...
$.ajax({
type: "GET",
url: 'listservsearch.php?term=' + sIndex + '&typesforlisting=<?=$typesforlisting?>',
...
$.ajax({
type: "GET",
url: 'listservsearch.php?term='+perpages+'&limitings='+($('#limitforpagenum').val())+'&typesforlisting=<?=$typesforlisting?>',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
...
function submitthesorting(value) {
  $.ajax({
    type: "GET",
    url: 'listingsortfilters.php?moduletype=Services&typesforlisting='+value+'',
    success: function (result) {
      console.log(result);
      window.location = 'services.php?remarks='+result+'';
    },
    error: function (error) {
      console.log(error);
    }
