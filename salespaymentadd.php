...
<input type="number" step="any" class="form-control  form-control-sm" id="advamount" name="advamount" placeholder="Amount Received" min='1' required style="border-left: 0px solid #ced4da !important;border-radius: 0px !important;margin-left: 0px !important;padding-left: 3px;">
      ...
      <div class="form-group row" <?=((in_array('Notes', $fieldadd))?'':'style="display:none;"')?>>
        ...
        <div class="row justify-content-center" style="margin-bottom: -14px;">
    <div class="col-lg-12"><hr>
        <button name="advadvcuspayaddsubmit" class="btn btn-primary btn-sm btn-custom arlina-button expand-left" type="submit" id="advadvcuspayaddsubmit" value="Save" style="margin-bottom: 15px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
                                                            <span class="label">Save</span> <span
                                                                class="spinner"></span>
                                                        </button>  <a class="btn btn-primary btn-sm btn-custom-grey" href="salespayments.php" style="font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">Cancel</a>
    </div>
