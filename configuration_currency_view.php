...
?>
    <title>
        Configuration &gt; Currencies &gt; Currency
    </title>
    <style>
                        ...
                        <div class="card mb-4 mt-5">
                            <div class="card-body py-1"
                                ...
                                <p style="color:black;font-size: 14.6px;border-bottom: 1px solid #dee2e6;" class="mb-3"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration </a><span>&gt;</span><a href="configuration_currency_list.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Currencies </a> <span>&gt;</span> Currency  <!-- <i class="fa fa-file-import"></i> --></p>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <span style="float:right" class="mb-0">
                                            ...
                                            <form action="franchisechange.php" method="get">
                                                <a class="btn btn-primary btn-sm btn-custom-grey"
                                                    href="configuration_currency_edit.php"
                                        ...
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                            ...
                                            <div class="row m-3" style="align-items: center;">
                                                <div class="col-sm-3 col-md-2 col-6"
                                                        style="color:black;font-size: 13px;">Currency
                                                        Name
                                                </div>
                                            ...
                                            <div class="row m-3" style="align-items: center;">
                                                <div class="col-sm-3 col-md-2 col-6"
                                                        style="color:black;font-size: 13px;">Decimal Places
                                            ...
                                            <div class="row m-3" style="align-items: center;">
                                                <div class="col-sm-3 col-md-2 col-6"
                                                        style="color:black;font-size: 13px;">Number 
                                                        Format
                                                </div>
                                                <div class="col-md-8 col-6" style="font-size:13px;">
                                                   1,23,45,678,90
