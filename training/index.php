              ...
              <div class="card card-plain mt-3">
				...
				?>
                  <form role="form" method="post">
                    <div class="mb-3">
                      <input type="text" class="form-control" name="user" placeholder="Email Address or username" aria-label="Email Address or username" aria-describedby="email-addon" required style="font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
                    </div>
                    <div class="mb-3">
                      <input type="password" class="form-control" name="pass" placeholder="Password" aria-label="Password" aria-describedby="password-addon" required style="font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
                    </div>
