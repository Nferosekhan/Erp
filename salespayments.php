	 ...
	 <div style="max-width: 1650px;">
              ...
              <div class="row">
                ...
                <div class="col-lg-3" style="margin-bottom: 57px !important;"> 
                  <input class="form-control" id="salepaysearch" type="text" placeholder="Search.." style="height:24px;">
                </div>
              </div>
                                <?php 
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Payments Received' order by id  asc");
...
if (($infomainaccessuser['useraccesscreate']==1&&$infomainaccessuser['createdid']!=0)||($infomainaccessuser['createdid']==0)) {
       ...
       <?php
                            ...
                            ?>
			<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Payments Received' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT id) from pairsalespayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' ".$typesforlisting."");
...
<?php
if ($access['salepaypageload']=='pageauto') {
?>
<script type="text/javascript">
...
$.ajax({
type: "GET",
url: 'listsalepaymentsearch.php?term=' + sIndex + '&limitings=15&typesforlisting=<?=$typesforlisting?>',
...
$.ajax({
type: "GET",
url: 'listsalepaymentsearch.php?term='+perpages+'&limitings='+($('#limitforpagenum').val())+'&typesforlisting=<?=$typesforlisting?>',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
...
function submitthesorting(value) {
  $.ajax({
    type: "GET",
    url: 'listingsortfilters.php?moduletype=Payments Received&typesforlisting='+value+'',
    success: function (result) {
      console.log(result);
      window.location = 'salespayments.php?remarks='+result+'';
    },
    error: function (error) {
      console.log(error);
    }
