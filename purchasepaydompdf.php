...
if (($_GET['term']=='purchasepayment')&&($_GET['sizes']=='a4')) {
...
<span style="'.(($access['purpaymadebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 18%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['purpaymadebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 80%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($infofranch['mobile']).'</span>
<span style="'.(($access['purpaymadebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 18%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['purpaymadebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 47%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($infofranch['email']).'</span>
<span style="'.(($access['purpaymadeprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 13%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['purpaymadeprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 19%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($infofranch['dlno20']).'</span>
<span style="'.(($access['purpaymadebranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 18%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['purpaymadebranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 47%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($infofranch['gstno']).'</span>
<span style="'.(($access['purpaymadeprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 13%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['purpaymadeprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 19%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($infofranch['dlno21']).'</span>
</span>
</div>
...
<strong style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.((($sqlcusfetch['customername']!='')&&(in_array('Billing Name', $fieldview)))?'display:inline-block;':'display:none;').'font-weight:bold;font-size: 13px !important;width: 245px;overflow: hidden;height: 15px;white-space: nowrap;">'.(ucwords(strtolower($sqlcusfetch['customername']))).'</strong>
...
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">'.(strtoupper($infomainaccessbill['modulename'])).' DATE</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">'.(strtoupper($infomainaccessbill['modulename'])).' NUMBER</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:left;">INVOICE NUMBER</span></th>
<th style="border:1px solid #ddd !important;vertical-align:middle !important;padding:0px 6px !important;"><span style="display:inline-block;width:100%;color:black !important;font-size:12px !important;text-align:right;">'.(strtoupper($infomainaccessbill['modulename'])).' AMOUNT</span></th>
...
<tbody>';
    ...
    $countt=1;
    $totpros=1;
$sqls=mysqli_query($con,"select invnumber,billno, billdate, grandtotal, paidstatus, vendorid, vendorname from pairbills where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and vendorid='$vendorid' GROUP BY billdate, billno  order by billdate asc, billno asc");
...
$html .= '<input type="hidden" name="nos[]" id="bill'.$i.'" value="'.$infos['billno'].'">
...
<td style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;"><input type="checkbox" name="payments'.$i.'" id="payments'.$i.'" onchange="return changeval('.$i.')" value="'.(number_format((float)$bal,2,'.','')).'" checked disabled style="position:relative;top:0px;"></td>
<td data-label="'. strtoupper($infomainaccessbill['modulename']) .' DATE" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.date('d/m/Y',strtotime($infos['billdate'])).'</td>
<td data-label="'. strtoupper($infomainaccessbill['modulename']) .' NUMBER" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.$infos['billno'].'</td>
<td data-label="INVOICE NUMBER" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.$infos['invnumber'].'</td>
<td data-label="'. strtoupper($infomainaccessbill['modulename']) .' AMOUNT" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:right;border: 1px solid #cccccc !important;padding:0px 3px;"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>'.(number_format((float)$infos['grandtotal'],2,'.','')).'</td>
...
<tbody>
<tr style="height:28px !important;border:1px solid #cccccc !important;">
<td data-label="DESCRIPTION" style="font-size:12px !important;vertical-align:middle !important;padding: 1px 6px !important;text-align:left;border: 1px solid #cccccc !important;">'.strtoupper($infomainaccessuserven['modulename']).' ADVANCE RECEIVED</td>
...
$mask = 'dompdf/PurchasePayments-*.*';
array_map('unlink', glob($mask));
$output = $dompdf->output();
file_put_contents("dompdf/".$_GET['names'].".pdf", $output);
}
if (($_GET['term']=='purchasepayment')&&($_GET['sizes']=='a5')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$sqlismainaccessuserven=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Vendors' order by id  asc");
...
<div style="border:1px solid #cccccc;padding-top:3px;text-align: left;border-top:none;border-bottom:none;">
<span style="width: 33%;display:inline-block;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:3px 6px !important;margin-bottom:-10px;">
<strong style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.((($sqlcusfetch['customername']!='')&&(in_array('Billing Name', $fieldview)))?'display:inline-block;':'display:none;').'font-weight:bold;font-size: 13px !important;width: 253px;overflow: hidden;height: 15px;white-space: nowrap;">'.(ucwords(strtolower($sqlcusfetch['customername']))).'</strong>
