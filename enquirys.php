                    ...
                    <div class="col-12">
                        <div class="card mb-4 mt-5">
                            <div class="card-body p-3" style="color:black;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
								...
								<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Enquiries' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
?>
                      <td class="text-uppercase" style="width:40%;"><span style="font-size:13px;color:black;"> Name</span></td>
                      <?php
                                            // }
                                                ?>
                      <?php
...
?>
                      ...
                      <td class="text-uppercase" style="width:50px;"><span style="font-size:13px;">Cancel Enquiry</span></td-->
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT enquiryno,enquirydate) from pairenquirys where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid'");
...
<?php
if ($access['enqpageload']=='pageauto') {
?>
...
$.ajax({
type: "GET",
url: 'listenqsearch.php?term=' + sIndex + '',
...
$.ajax({
type: "GET",
url: 'listenqsearch.php?term=<?=$i?>0',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to Generate this Enquiry as Invoice?
            </div>
...
<div class="modal fade" id="deleteconfirm1-adddelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to Generate this Enquiry as Estimate?
            </div>
 ...
 ?>
 <script>
 function deleteitem(enquiryno,enquirydate,cancelstatus)
{
	$('#deleteconfirm-adddelete').modal('show');
	$("#deleteconfirm-adddelete #deleteitem").attr("href","enquirycancel.php?enquiryno="+enquiryno+"&enquirydate="+enquirydate+"&cancelstatus="+cancelstatus);
}
 function deleteitem1(enquiryno,enquirydate,cancelstatus)
{
	$('#deleteconfirm1-adddelete').modal('show');
	$("#deleteconfirm1-adddelete #deleteitem1").attr("href","estimatecancel.php?enquiryno="+enquiryno+"&enquirydate="+enquirydate+"&estimatestatus="+cancelstatus);
}
 </script>
</body>
