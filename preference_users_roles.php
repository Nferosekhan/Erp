...
?>
    <title>
        Preference &gt; <?= $row['userandroles'] ?> & Roles
    </title>
</head>
    ...
    <i class="fa fa-times"></i> &nbsp;<?=$_GET['error']?></p>
     ...
     ?>
             <div class="card card-body mt-5" style="font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;max-width: 1650px;">
                <p class="mb-0" style="font-size: 14.6px;color: black;position: relative;top: -12px;border-bottom: 1px solid #dee2e6;"><a href="preference.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Preference</a> <span>&gt;</span> <?= $row['userandroles'] ?> & Roles</p>
    <p class="mb-0" style="font-size: 20px;color: black;"><i class="fa fa-user"></i>
                                    <?= $row['userandroles'] ?> & Roles</p>
...
<div class="tab-content" id="nav-tabContent">
 ...
 <div class="card card-body mt-3 totedits" style="width: max-content;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;box-shadow: 0 1px 5px 0 rgb(0 0 0 / 20%);">
                                                                ...
                                                                <p class="card-subtitle mb-2 text-muted" style="margin-top: 0px;font-size: 16px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;color: black;">Label</p>
                                                                    <p class="card-text" style="margin-top:-10px;color: grey;font-size: 14px;font-family: 'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;"><?= $row['userandroles']
                                                                ?> & Roles</p>
                                                                ...
                                                                <!-- <a class="btn btn-primary btn-sm btn-custom-grey"  style=" margin-top: 5px; margin-bottom: 0px;margin-left: 0px;text-align:right;cursor: pointer;" href="preference_users_roles_label.php"><span style="color: black;font-size: 15px;">&#128393;</span> Edit</a> -->
                                                                <a class="btn btn-primary btn-sm btn-custom-grey" href="preference_users_roles_label.php" style="margin-top: 6px;margin-bottom:0rem; margin-right:0px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;"><i class="fa fa-pencil-alt"></i> Edit</a>
                                                                ...
                                                                <a href="preference-user-roles.php" style="font-size:18px;padding: 20px 0px 14px;width: 61.25;height: 55.5;color: black;"><?= $row['userandroles'] ?> & Roles</a>
                                                                </div>
    </div>
    <div class="tab-pane fade" id="nav-history" role="tabpanel" aria-labelledby="nav-history-tab">
      ...
      <tbody>
        <?php
        $pairuse="SELECT * FROM pairusehistory WHERE createdby='".$_SESSION["unqwerty"]."' and usetype='Userroles' order by createdon desc";
