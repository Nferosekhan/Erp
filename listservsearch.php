...
if (isset($_GET['term'])) {
                  $count=1;
                  $sqli=mysqli_query($con, "select * from pairproducts where createdid='$companymainid' and ((franchisesession='".$_SESSION["franchisesession"]."' and pvisiblity='PRIVATE') or pvisiblity='PUBLIC') and itemmodule='Services' ".$_GET['typesforlisting']." order by productname asc limit ".$_GET['term'].",".$_GET['limitings']."");
