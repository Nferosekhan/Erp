...
if ($infomainaccesstimetracking['groupaccess']=='0') {
...
$sqlismodules=mysqli_query($con, "select * from pairmodules where moduletype='Projects' order by id  asc");
while($infomodules=mysqli_fetch_array($sqlismodules)){
  ...
  foreach ($newmodules as $newmoduleskey) {
                ...
                $modcolumncol=$coltypemod."colproject";
                ...
                $sqlmainaccessprojectup = "update pairmainaccess set modulecolumns='$modcolumncolchanges' where (userid='$companymainid' or createdid='$companymainid') and moduletype='Projects'"; 
                $sqlmainaccessupproject = mysqli_query($con, $sqlmainaccessprojectup);
if ($sqlmainaccessupproject) {
$sqlismodules=mysqli_query($con, "select * from pairmodules where moduletype='Timesheet' order by id  asc");
while($infomodules=mysqli_fetch_array($sqlismodules)){
    $coltypemodule = preg_replace('/\s+/', '', $infomodules['moduletype']);
    $ansmodules = $infomodules[4];
    $newmodules = explode(',',$ansmodules);
  ...
  foreach ($newmodules as $newmoduleskey) {
                $coltypemod = preg_replace('/\s+/', '',$newmoduleskey);
                $modcolumncol=$coltypemod."coltimesheet";
                $modcolumncol=mysqli_real_escape_string($con, (isset($_POST[$modcolumncol]))?$newmoduleskey:' ');
                if($modcolumncolchanges!='')
                {
                    $modcolumncolchanges.=','.$modcolumncol;
                ...
                $sqlmainaccesstimesheetup = "update pairmainaccess set modulecolumns='$modcolumncolchanges' where (userid='$companymainid' or createdid='$companymainid') and moduletype='Timesheet'"; 
                $sqlmainaccessuptimesheet = mysqli_query($con, $sqlmainaccesstimesheetup);
            }
...
?>
    <title>
        Preference &gt; <?= $row['books'] ?> &gt; <?= $infomainaccesstimetracking['groupname'] ?>
    </title>
<style type="text/css">
   ...
   // notifications
    ...
    <i class="fa fa-times"></i> &nbsp;<?=$_GET['error']?></p>
     ...
     ?>
      ...
      $sqlismainaccesstimetracking=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and grouptype='Time Tracking' order by id  asc");
      $infomainaccesstimetracking=mysqli_fetch_array($sqlismainaccesstimetracking);
$sqlismainaccessproject=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Projects' order by id  asc");
$infomainaccessproject=mysqli_fetch_array($sqlismainaccessproject);
$sqlismainaccesstimesheet=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Timesheet' order by id  asc");
$infomainaccesstimesheet=mysqli_fetch_array($sqlismainaccesstimesheet);
        ?>
    ...
    <p class="mb-3" style="font-size: 14.6px;color: black;position: relative;top: 15px;"><a href="preference.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Preference </a><span>&gt;</span><a href="preference_billing.php" style="color: #1878F1"> <!-- <i class="fa fa-book"></i> -->
                                    <?= $row['books'] ?> </a> &gt; <!-- <i class="fa fa-shopping-basket"></i>  --><?= $infomainaccesstimetracking['groupname'] ?></p>
                                    <div class="mt-3" style="border-top: 1px solid #dee2e6;position: relative;top: 0px;"></div>
                                    <p class="mb-2" style="font-size: 20px;color: black;position: relative;top: 12px;"><?= $infomainaccesstimetracking['groupname'] ?></p>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <?php
        if ($infomainaccessproject['moduleaccess']=='1') {
        ?>
<button class="nav-link active" id="nav-general-tab" data-bs-toggle="tab" data-bs-target="#nav-general" type="button" role="tab" aria-controls="nav-general" aria-selected="true"><div class="customcont-header ml-0">
        ...
        <a class="customcont-heading"><?= $infomainaccessproject['modulename'] ?> 
</a>  
             
                </div></button>
                <?php
                }
                if ($infomainaccesstimesheet['moduleaccess']=='1') {
                ?>
<button class="nav-link" id="nav-timesheet-tab" data-bs-toggle="tab" data-bs-target="#nav-timesheet" type="button" role="tab" aria-controls="nav-timesheet" aria-selected="true"><div class="customcont-header ml-0">
    
        <a class="customcont-heading"><?= $infomainaccesstimesheet['modulename'] ?> 
</a>  
...
<div class="tab-pane fade show active mt-4 p-3" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
    <div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="projectfield">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#projectfields"
                                                    aria-expanded="true" aria-controls="projectfields">
                                            ...
                                            <div id="projectfields" class="accordion-collapse collapse show"
                                                aria-labelledby="projectfield">
...
<div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="projectcolumn">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#projectcolumns"
                                                    aria-expanded="true" aria-controls="projectcolumns">
                                                    <div class="customcont-header ml-0 mb-1 mt-3">
                                            ...
                                            <div id="projectcolumns" class="accordion-collapse collapse show"
                                                aria-labelledby="projectcolumn">
                                                <div class="accordion-body text-sm">
                                                  <?php
...
$sqlismainaccess=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Projects' order by id  asc");
...
?>
           <div class="row" style=" border-top:1.5px solid #eee; border-bottom:1.5px solid #eee; padding:5px 0">
            <div class="col-lg-2">
                <div class="custom-control custom-checkbox mr-sm-2">
                        <input type="checkbox" class="custom-control-input" name="<?= $coltypemod; ?>colproject" id="<?= $coltypemod; ?>colproject" <?= ((in_array($newmoduleskey, $newans)))?'checked':'' ?> <?= (($newmoduleskey=='Name'))?'disabled checked':'' ?>>
                        <label class="custom-control-label custom-label" for="<?= $coltypemod; ?>colproject" style="font-size: 14.6px;color:royalblue !important;"> <?= $newmoduleskey; ?></label>
                      </div>
            </div>
            <div class="col-lg-10">
    ...
    <div class="col-lg-12"><hr>
        <button name="submit"
                ...
                if ($infomainaccesstimesheet['moduleaccess']=='1') {
                ?>
<div class="tab-pane fade show mt-4 p-3" id="nav-timesheet" role="tabpanel" aria-labelledby="nav-timesheet-tab">
    <div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="timesheetfield">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#timesheetfields"
                                                    aria-expanded="true" aria-controls="timesheetfields">
                                                    <div class="customcont-header ml-0 mb-1 mt-3">
                                                        <a class="customcont-heading" style="font-size: 18px;"> Select the fields you would like to enable</a>
                                                    </div>
                                                </button>
                                            ...
                                            <div id="timesheetfields" class="accordion-collapse collapse show"
                                                aria-labelledby="timesheetfield">
                                                <div class="accordion-body text-sm">
</div>
</div>
</div>
<div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="timesheetcolumn">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#timesheetcolumns"
                                                    aria-expanded="true" aria-controls="timesheetcolumns">
                                                    <div class="customcont-header ml-0 mb-1 mt-3">
                                                        <a class="customcont-heading" style="font-size: 18px;"> Select the columns you would like to enable</a>
                                                    </div>
                                                </button>
                                            ...
                                            <div id="timesheetcolumns" class="accordion-collapse collapse show"
                                                aria-labelledby="timesheetcolumn">
                                                <div class="accordion-body text-sm">
                                                  <?php
...
$sqlismainaccess=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Timesheet' order by id  asc");
while($infomainaccess=mysqli_fetch_array($sqlismainaccess)){
    $coltype = preg_replace('/\s+/', '', $infomainaccess['moduletype']);
    $ans = $infomainaccess[24];
    $newans = explode(',',$ans);
...
?>
           <div class="row" style=" border-top:1.5px solid #eee; border-bottom:1.5px solid #eee; padding:5px 0">
            <div class="col-lg-2">
                <div class="custom-control custom-checkbox mr-sm-2">
                        <input type="checkbox" class="custom-control-input" name="<?= $coltypemod; ?>coltimesheet" id="<?= $coltypemod; ?>coltimesheet" <?= ((in_array($newmoduleskey, $newans)))?'checked':'' ?> <?= (($newmoduleskey=='Name'))?'disabled checked':'' ?>>
                        <label class="custom-control-label custom-label" for="<?= $coltypemod; ?>coltimesheet" style="font-size: 14.6px;color:royalblue !important;"> <?= $newmoduleskey; ?></label>
                      </div>
            </div>
            <div class="col-lg-10">
