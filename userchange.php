...
if(($id!="")&&($val!=""))
	{	
		...
		{	
			// Query if email exists in db
			$sqlup = "update paircontrols set is_active='$val' where id='$id'";
			...
			else
			{
				...
				$sqluse=mysqli_query($con, "insert into pairusehistory set usetype='USER', createdon='$times',  createdby='".$_SESSION["unqwerty"]."', useid='$id', useremarks='$useremarks' ");
			...
			{
				header("Location: users.php?error=This record is Not Found! Kindly check in All Users List");
			}
	}
	else
			{
