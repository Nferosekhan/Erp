...
$query = "SELECT * from paircustomers WHERE franchisesession='".$_SESSION["franchisesession"]."' and LOWER(customername) LIKE LOWER('%".$term."%') and moduletype='Customers' ORDER BY customername ASC";
