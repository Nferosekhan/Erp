	...
	{	
		...
		{	
			...
			else
			{
				...
				$sqluse=mysqli_query($con, "insert into pairusehistory set usetype='PRODUCTS', createdon='$times',  createdby='".$_SESSION["unqwerty"]."', useid='$id', useremarks='$useremarks' ");
			...
			{
				header("Location: products.php?error=This record is Not Found! Kindly check in All Users List");
			}
	}
	else
			{
