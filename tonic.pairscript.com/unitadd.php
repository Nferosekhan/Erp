...
$msg_class = "";
	if(($unitname!=""))
	{		
        $sqlcon = "SELECT id From pairunits WHERE unitname = '{$unitname}'";
        ...
        if($rowCountcon == 0) 
		{	
			$sqlup = "insert into pairunits set createdon='$times', createdid='$companymainid', createdby='".$_SESSION["unqwerty"]."', uqc='$uqc',  unitname='$unitname'";
			...
			else
			{
				...
				header("Location: units.php?remarks=Added Successfully");
			} 
	    }
		else
			{
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-0 " style="overflow-y: scroll !important;">
    ...
    <!-- End Navbar -->
     <div class="container-fluid py-4 bg-body">
          <h6 class="font-weight-bolder mb-3">Add Unit</h6>
	 <?php
...
<div class="col-lg-6">
  <div class="form-group">
    ...
    <input type="text" class="form-control  form-control-sm" id="unitname" name="unitname" required>
  </div>
</div>
<div class="col-lg-6">
  <div class="form-group">
    <label for="uqc">UQC</label>
    <input type="text" class="form-control  form-control-sm" id="uqc" name="uqc" required>
  </div>
</div>
  </div>
