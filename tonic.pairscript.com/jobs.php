...
$sqlismainaccessquotation=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Quotations' order by id  asc");
$infomainaccessquotation=mysqli_fetch_array($sqlismainaccessquotation);
                                ?>
                    ...
                    <div class="col-12">
                        <div class="card mb-4 mt-5">
                            <div class="card-body p-3" style="color:black;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
								...
								<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Jobs' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
<?php
                      ...
                      <?php
                                            ...
                                            if ((in_array('Quotation', $modulecolumns))) {
                                                ?>
					  <td class="text-uppercase" style="width:11%;"><span style="font-size:13px;color:black;"><?= $infomainaccessquotation['modulename'] ?></span></td>
                      <?php
                                            }
                                                ?>
                      <!--td class="text-uppercase" style="width:50px;"><span style="font-size:13px;">Cancel <?=$pmsaleorderch?></span></td-->
...
<?php
        ...
        ?>
          ...
          ?>		
				  ...
				  $totaljobno=array();
				  $totaljobdate=array();
				  $sql=mysqli_query($con, "select jobdate, jobno, customername, jobterm, duedate, jobamount, cancelstatus, estimatestatus,id from pairjobs where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' GROUP BY jobdate, jobno order by jobdate desc, jobno desc limit ".(($access['jobpageload']=='pagenum')?'10':'15')."");
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT jobno,jobdate) from pairjobs where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid'");
...
<?php
if ($access['jobpageload']=='pageauto') {
?>
...
$.ajax({
type: "GET",
url: 'listjobsearch.php?term=' + sIndex + '',
...
$.ajax({
type: "GET",
url: 'listjobsearch.php?term=<?=$i?>0',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to Generate this <?=$pmsaleorderch?> as Quotation?
            </div>
