...
$id=custom_escape_string($con, $_GET['id']);
$sqlcushis=mysqli_query($con,"select * from paircustomers where (franchisesession='".$_SESSION["franchisesession"]."' or cvisiblity='PUBLIC') and (createdid='$companymainid' and moduletype='Customers') and id='".$id."'");
$sqlanscus = mysqli_fetch_array($sqlcushis);
$oldsalute = custom_escape_string($con,$sqlanscus['primarysalutation']);
$oldpcontact = custom_escape_string($con,$sqlanscus['primarycontact']);
$oldcompanyname = custom_escape_string($con,$sqlanscus['companyname']);
$oldcustomerdname = custom_escape_string($con,$sqlanscus['customername']);
$oldage = custom_escape_string($con,$sqlanscus['age']);
$oldsex = custom_escape_string($con,$sqlanscus['sex']);
$oldcategory = custom_escape_string($con,$sqlanscus['category']);
$oldsubcategory = custom_escape_string($con,$sqlanscus['subcategory']);
$oldworkphone = custom_escape_string($con,$sqlanscus['workphone']);
$oldmobilephone = custom_escape_string($con,$sqlanscus['mobile']);
$oldemail = custom_escape_string($con,$sqlanscus['email']);
$oldwebsite = custom_escape_string($con,$sqlanscus['website']);
$oldbillstreet = custom_escape_string($con,$sqlanscus['billstreet']);
$oldbillcity = custom_escape_string($con,$sqlanscus['billcity']);
$oldbillstate = custom_escape_string($con,$sqlanscus['billstate']);
$oldbillpincode = custom_escape_string($con,$sqlanscus['billpincode']);
$oldbillcountry = custom_escape_string($con,$sqlanscus['billcountry']);
$oldshipstreet = custom_escape_string($con,$sqlanscus['shipstreet']);
$oldshipcity = custom_escape_string($con,$sqlanscus['shipcity']);
$oldshipstate = custom_escape_string($con,$sqlanscus['shipstate']);
$oldshippincode = custom_escape_string($con,$sqlanscus['shippincode']);
$oldshipcountry = custom_escape_string($con,$sqlanscus['shipcountry']);
$oldcvisibility = custom_escape_string($con,$sqlanscus['cvisiblity']);
$oldtaxpreference = custom_escape_string($con,$sqlanscus['custaxprefer']);
$oldgstrtype = custom_escape_string($con,$sqlanscus['gstrtype']);
$oldgstin = custom_escape_string($con,$sqlanscus['gstin']);
$oldbusinesslegalname = custom_escape_string($con,$sqlanscus['buslegname']);
$oldbusinesstradename = custom_escape_string($con,$sqlanscus['bustrdname']);
$oldpan = custom_escape_string($con,$sqlanscus['pan']);
$oldplaceos = custom_escape_string($con,$sqlanscus['placeos']);
...
$age= custom_escape_string($con, $_POST['age']);
$sex= custom_escape_string($con, $_POST['sex']);
        ...
        // {   
            ...
            else
            {
                ...
                if($customerdname!=$oldcustomerdname)
                {
                    if($ch!='')
                    {
                        $ch.='<br> '.$cushead.' Name<span style="color:green;" id="prohisfromtospan">( From '.$oldcustomerdname.' To '.$customerdname.' ) </span>';
                    }
                    else
                    {
                        $ch.=''.$cushead.' Name<span style="color:green;" id="prohisfromtospan">( From '.$oldcustomerdname.' To '.$customerdname.' ) </span>';
                    }                   
                }
                if($age!=$oldage)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Age<span style="color:green;" id="prohisfromtospan">( From '.$oldage.' To '.$age.' ) </span>';
                    }
                    else
                    {
                        $ch.='Age<span style="color:green;" id="prohisfromtospan">( From '.$oldage.' To '.$age.' ) </span>';
                    }                   
                }
                if($sex!=$oldsex)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Sex<span style="color:green;" id="prohisfromtospan">( From '.$oldsex.' To '.$sex.' ) </span>';
                    }
                    else
                    {
                        $ch.='Sex<span style="color:green;" id="prohisfromtospan">( From '.$oldsex.' To '.$sex.' ) </span>';
                    }                   
                }
                ...
                if($ch!='')
                {
                $sqluse=mysqli_query($con, "insert into pairusehistory set usetype='CUSTOMERS', createdon='$times',  createdby='".$_SESSION["unqwerty"]."', useid='$id', useremarks='".$ch."' ");
                }
                header("Location: customerview.php?id=".$id."&remarks=Added Successfully");
            } 
        // }
    //     else
    //         {
          ...
          <div class="accordion-item mb-1">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
              <div class="accordion-body text-sm">
                <div class="row justify-content-center" <?=((in_array('Customer Id', $fieldedit))?'':'style="display:none;"')?>>
    <div class="col-lg-6">
        <div class="form-group row">
            <div class="col-sm-4">
            <label for="customerid" class="custom-label vendorid" data-toggle="tooltip" title="<?= $infomainaccessuser['modulename'] ?> Id" data-placement="top"><?= $infomainaccessuser['modulename'] ?> Id</label>
              ...
              <input type="text" class="form-control  form-control-sm" id="customerid" name="customerid" placeholder="<?= $infomainaccessuser['modulename'] ?> Id" disabled value="<?= $anss['customercode'] ?>">
                                                    ...
                                                    <div class="row justify-content-center" <?=((in_array('Customer Public Id', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                     ...
                                                     <div class="row justify-content-center" <?=((in_array('Customer Private Id', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
...
<div class="col-sm-8">
<input type="text" class="form-control  form-control-sm" id="age" name="age" placeholder="Age" value="<?= $anss['age'] ?>">
</div>
</div>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" class="form-control  form-control-sm" id="sex" name="sex" placeholder="Sex" value="<?= $anss['sex'] ?>">
</div>
</div>
</div>
</div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8" onclick="andus()">
                                                                    <select
                                                                        ...
                                                                        <?php
                                                                        $sqliss = mysqli_query($con, "select * from paircustomers where (franchisesession='".$_SESSION["franchisesession"]."' or cvisiblity='PUBLIC') and (createdid='$companymainid' and moduletype='Customers') and id='".$id."'");
...
?>
        <div class="accordion" id="accordionRental" <?=((in_array('Customers Visibility', $fieldedit))?'':'style="display:none;"')?>>
                                            ...
                                            <div id="collapseFive" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body text-sm">
                                                            ...
                                                            <!-- <div class="form-check form-check-inline">
                                                                ...
                                                                <div id="gstrtypesh">
                                                                <div class="row justify-content-center" <?=((in_array('GST Registration Type', $fieldedit))?'':'style="display:none;"')?>>
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-4">
                                                                ...
                                                                <div id="placeofsupply" <?=((in_array('Place Of Supply', $fieldedit))?'':'style="display:none;"')?>>
                                                                <div class="row justify-content-center">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group row">
                                                                            <div class="col-sm-4">
