...
/* if($quotationterm=='CASH')
{
$sql=mysqli_query($con, "insert into salespayments set createdon='$createdon', customername='$customername', customerid='$customerid', receiptno='$quotationno', receiptdate='$quotationdate', amount='$quotationamount', paymentmode='CASH', notes='-'");
} */
...
.adjust:focus{
        border: 1px solid #3f94eb !important;
        box-shadow: 1px 1px 6px 0.1px #3f94eb;
        outline: none;
}
table thead th {
height: 10px;
...
@media screen and (min-device-width: 993px) and (max-device-width: 1107px) {
.row .col-lg-12{
  padding-bottom: 45px;
  padding-top: 0px;
}
}
@media screen and (min-device-width: 1107px) and (max-device-width: 1127px) {
.row .col-lg-12{
  padding-bottom: 48px;
  padding-top: 0px;
}
}
@media screen and (min-device-width: 1128px) and (max-device-width: 1145px) {
.row .dobox{
  padding-bottom: 48px;
  padding-top: 0px;
}
}
@media screen and (min-device-width: 1199px) and (max-device-width: 1300px) {
.row .col-lg-12{
  padding-bottom: 45px;
  padding-top: 0px;
}
...
$sqliet=mysqli_query($con, "select quotation, quotationprefix, (quotationsuffix+1) as quotationsuffix from pairfranchises where tdelete='0' and id='".$_SESSION['franchisesession']."' order by id desc");
...
<a class="customcont-heading" style="padding: 7px 0 7px;font-size: 18px;">Customer Information</a>
</div>
</button>
</h5>
...
<div class="col-sm-8">
<input type="text" class="form-control  form-control-sm" id="customername" name="customername" required placeholder="Customer Name" style="height: 21px;padding-top: 1.5px;">
</div>
  </div>
</div>
</div>
...
<input type="text" autocomplete="off"  class="form-control  form-control-sm" name="area" id="area"  placeholder="Street" style="height: 21px;padding-top: 1.5px;">
</div>
<div class="col-sm-3">
<input type="text" autocomplete="off"  class="form-control  form-control-sm" name="city" id="city" placeholder="City/Town" style="height: 21px;padding-top: 1.5px;">
</div>
  </div>
</div>
</div>
...
<input type="text" autocomplete="off"  class="form-control  form-control-sm" name="state" id="state" placeholder="State" style="height: 21px;padding-top: 1.5px;">
</div>
<div class="col-sm-2 mtcolumn">
<input type="number" autocomplete="off" class="form-control  form-control-sm" name="pincode" id="pincode" min="0" placeholder="Pin" style="height: 21px;padding-top: 1.5px;">
</div>
<div class="col-sm-3 mtcolumn">
<input type="text" autocomplete="off"  class="form-control  form-control-sm" name="district" id="district" placeholder="Country/Region" style="height: 21px;padding-top: 1.5px;">
</div>
  </div>
</div>
</div>
...
<button class="accordion-button font-weight-bold" type="button">
<div class="customcont-header ml-0 mb-1" style="height: 30px;">
<a class="customcont-heading" style="padding: 7px 0 7px;font-size: 18px;">Quotation Information</a>
</div>
</button>
</h5>
...
<div class="col-lg-12" style="height:26px;">
  <div class="form-group row">
  <div class="col-lg-4">
<label for="quotationno" class="custom-label"><span class="text-danger">Quotation No. *</span></label>
</div>
<div class="col-lg-8">
<input type="text" class="form-control  form-control-sm" id="quotationno" name="quotationno" required value="<?=$infoet['quotationprefix']?><?=str_pad((float)$infoet['quotationsuffix']+1, 0, "0", STR_PAD_LEFT)?>" readonly style="height: 21px;padding-top: 1.5px;">
</div>
  </div>
</div>
<div class="col-lg-12" style="height:26px;">
  <div class="form-group row">
  <div class="col-lg-4">
<label for="quotationdate" class="custom-label">Quotation Date</label>
</div>
  <div class="col-lg-8">
<input type="date" class="form-control  form-control-sm" id="quotationdate" name="quotationdate" readonly required value="<?=date('Y-m-d')?>" style="height: 21px;padding-top: 1.5px;">
  </div>
  </div>
</div>
<div class="col-lg-12" style="height:26px;">
  <div class="form-group row">
  <div class="col-lg-4">
<label for="quotationterm" class="custom-label">Quotation Term</label>
</div>
  <div class="col-lg-8">
 <select required class="form-control  form-control-sm" name="quotationterm" id="quotationterm" style="height: 21px;padding-top: 1.5px;">
...
<div class="col-lg-12" style="display:none">
  <div class="form-group">
<label for="orderdcno">Order Number</label>
<input type="text" class="form-control  form-control-sm" id="orderdcno" name="orderdcno">
  </div>
</div>
<div class="col-lg-12" style="display:none">
  <div class="form-group">
...
<button class="accordion-button font-weight-bold" type="button">
<div class="customcont-header ml-0 mb-1" style="height: 30px;">
<a class="customcont-heading" style="padding: 7px 0 7px;font-size: 18px;">Item Information</a>
</div>
</button>
</h5>
<div id="collapseOne" class="accordion-collapse collapse show"
...
<thead>
<tr><th style="display:none"></th><th></th><th>ITEM DETAILS</th><th style="display:none">DESCRIPTION</th><th style="display:none">HSN</th><th style="display:none">MRP</th><th>QUANTITY</th><th style="background-color:#F4F6F7;">RATE</th><th style="background-color:#F4F6F7;">TAX</th><th style="display:none">Discount</th><th>AMOUNT</th><th></th></tr>
</thead>
<tbody>
<tr>
...
<td data-label="ITEM DETAILS"><input type="hidden" name="productid[]" id="productid1"><input type="text" name="productname[]" id="productname1" required class="form-control form-control-sm bordernoneinput" ></td>
...
<td data-label="QUANTITY"><input type="number" min="0" step="0.01" name="quantity[]" required id="quantity1" class="form-control form-control-sm bordernoneinput" onChange="productcalc(1)"></td>
<td style="background-color: #F4F6F7;" data-label="RATE"><div class="input-group"><div class="input-group-prepend"><div class="input-group-text" style="color:#495057;background-color: #F4F6F7;"><?php echo $res[0]; ?></div></div><input type="number" min="0" step="0.01" name="productrate[]"  required id="productrate1" class="form-control form-control-sm bordernoneinput" onChange="productcalc(1)" style="background-color: #F4F6F7;"></div></td>
<td style="background-color: #F4F6F7;" data-label="TAX"><input type="number" min="0" step="0.01" name="vat[]" id="vat1" class="form-control form-control-sm bordernoneinput" style="background-color: #F4F6F7;"></td>
...
<td data-label="AMOUNT"><div class="input-group"><div class="input-group-prepend"><div class="input-group-text" style="color:#495057"><?php echo $res[0]; ?></i></div></div><input type="number" min="0" step="0.01" name="productvalue[]" id="productvalue1" class="form-control form-control-sm bordernoneinput"style="background:none;" ></div></td>
...
<a class="purchaseadd-row btn btn-primary btn-sm btn-custom-grey addan" style="background-color: #e9ecef;"><i style="font-size: 14px;color:#0066cc" class="fa fa-plus-circle"></i> Add another line</a></p>
...
<div class="p-3">
 <div class="row mb-1">
<div class="col-6" >Sub Total <span class="pull-right">:</span> <i class="fa fa-rupee"></i></div>
<div class="col-6">
  ...
  <div class="row mb-1" >
<div class="col-6" > Total Tax <span class="pull-right">:</span> <i class="fa fa-rupee"></i></div>
<div class="col-6">
...
<div class="col-6" >
  ...
  <div class="row mb-1" >
<div class="col-6" > Freight<span class="pull-right">:</span> <i class="fa fa-rupee"></i></div>
<div class="col-6" >
  ...
  <div class="row mb-1" >
<div class="col-6" > Round off<span class="pull-right">:</span> <i class="fa fa-rupee"></i></div>
<div class="col-6">
...
<div class="col-6" > <strong>Grand Total<span class="pull-right">:</span></strong> <i class="fa fa-rupee"></i></div>
<div class="col-6">
...
{
markup = '<tr><td class="priority" style="display:none"> '+lineNo+'</td><td><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 512 512" xml:space="preserve" class="icon icon-drag align-text-bottom" style="color:#cccccc"><circle cx="153.6" cy="451" r="61"></circle><circle cx="153.6" cy="256" r="61"></circle><circle cx="153.6" cy="61" r="61"></circle><circle cx="358.4" cy="256" r="61"></circle><circle cx="358.4" cy="61" r="61"></circle><circle cx="358.4" cy="451" r="61"></circle></svg></td><td data-label="ITEM DETAILS"><input type="hidden" name="productid[]" id="productid'+lineNo+'"><input type="text" name="productname[]" id="productname'+lineNo+'" class="form-control form-control-sm bordernoneinput" ></td><td style="display:none"><input type="text" name="productnotes[]" id="productnotes'+lineNo+'" class="form-control form-control-sm bordernoneinput"></td><td style="display:none"><input type="text" name="producthsn[]" id="producthsn'+lineNo+'" class="form-control form-control-sm bordernoneinput"></td><td style="display:none"><input type="number" min="0" step="0.01" name="mrp[]" id="mrp'+lineNo+'" class="form-control form-control-sm bordernoneinput"></td><td data-label="QUANTITY"><input type="number" min="0" step="0.01" name="quantity[]" id="quantity'+lineNo+'" class="form-control form-control-sm bordernoneinput" onChange="productcalc('+lineNo+')"></td><td data-label="RATE" style="background-color: #F4F6F7;"><div class="input-group"><div class="input-group-prepend"><div class="input-group-text" style="color:#495057;background-color: #F4F6F7;"><?php echo $res[0]; ?></div></div><input type="number" min="0" step="0.01" name="productrate[]" readonly  id="productrate'+lineNo+'" class="form-control form-control-sm bordernoneinput" style="color:#495057;background-color: #F4F6F7;" onChange="productcalc('+lineNo+')"></div></td><td data-label="TAX" style="background-color: #F4F6F7;"><input type="number" min="0" step="0.01" name="vat[]" readonly id="vat'+lineNo+'" class="form-control form-control-sm bordernoneinput" style="color:#495057;background-color: #F4F6F7;"></td><td style="display:none"><input type="number" min="0" step="0.01" name="prodiscount[]" id="prodiscount'+lineNo+'" class="form-control form-control-sm bordernoneinput" onChange="productcalc('+lineNo+')"></td><td data-label="AMOUNT"><div class="input-group"><div class="input-group-prepend"><div class="input-group-text" style="color:#495057;"><?php echo $res[0]; ?></div></div><input type="number" min="0" step="0.01" name="productvalue[]" id="productvalue'+lineNo+'" class="form-control form-control-sm bordernoneinput" style="background:none" readonly ></div></td><td><a class="btn-delete" style="cursor:pointer"><img src="assets/img/delete-row.png" width="15" height="15" style="border-radius: 10px;"></a></td></tr>';
