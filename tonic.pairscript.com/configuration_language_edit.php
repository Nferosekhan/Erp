<?php
include('lcheck.php');
if($language=='0'||$permissionconfig=='0')
{
  header('Location: dashboard.php');
}
if(isset($_POST['submit'])){
    header('location:configuration_language_view.php');
    $sql=mysqli_query($con,"select id from parilanguage");
    while($result=mysqli_fetch_assoc($sql))
    {
        $id=$result['id'];
    }
    $update=mysqli_query($con,"update paircontrols set languages='".$id."' where username='".$_SESSION['unqwerty']."' or usernewname='".$_SESSION['unqwerty']."' ");
}
?>
<!DOCTYPE html>
<html lang="en">
...
?>
    <title>
        Configuration &gt; Language &gt; Change Language
    </title>
    <style>
                    ...
                    <div class="col-12">
                        <div class="card mb-4 mt-5">
                            <div class="card-body py-2"
                                ...
                                <p style="color:black;font-size: 14.6px;border-bottom: 1px solid #dee2e6;" class="mb-0"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration </a><span>&gt;</span><a href="configuration_language_view.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Language </a> <span>&gt;</span> Change Language  <!-- <i class="fa fa-file-import"></i> --></p>
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show"
                                               >
                                                <div class="accordion-body text-sm">
                                                    <p style="padding-left: 20px;font-size: 18px;"> <i
                                                            class='fas fa-pencil-square-o'></i> <span
                                                            style="color:black;">Change language</span></p>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select style=" width: 100%"
                                                                        ...
                                                                        <?php
$sqlis = mysqli_query($con, "select language from parilanguage");
while ($infos = mysqli_fetch_array($sqlis)) {
?>
                                                                        <option value="<?= $infos['language'] ?>">
                                                                            <?= $infos['language'] ?>
                                                                        </option>
                                                                        <?php
}
?>
                                                            ...
                                                            <span class="label">Save</span> <span class="spinner"></span>
                                                                    ...
                                                                    href="configuration_language_view.php">Cancel</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
document.getElementById("configureunits").innerHTML = "New Language";
$("#configureunits").show();
});
});
</script>
