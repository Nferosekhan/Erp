<?php
include('lcheck.php');
if (isset($_POST['purchasereturnsubmit'])) {
$csvMimes = array('text/x-comma-separated-values', 'text/comma-separated-values', 'application/octet-stream', 'application/vnd.ms-excel', 'application/x-csv', 'text/x-csv', 'text/csv', 'application/csv', 'application/excel', 'application/vnd.msexcel', 'text/plain');
if(!empty($_FILES['purchasereturnsfile'] ['name']) && in_array($_FILES['purchasereturnsfile'] ['type'], $csvMimes)){
if(is_uploaded_file($_FILES['purchasereturnsfile'] ['tmp_name'])){
$csvFile=fopen($_FILES['purchasereturnsfile'] ['tmp_name'],'r');
fgetcsv($csvFile);
...
$purchasereturndate=mysqli_real_escape_string($con, $line[5]);
$purchasereturnno=mysqli_real_escape_string($con, $line[6]);
$purchasereturnterm=mysqli_real_escape_string($con, $line[7]);
$duedate=mysqli_real_escape_string($con, $line[8]);
$duedates=mysqli_real_escape_string($con, $line[9]);
$purchasereturnamount=mysqli_real_escape_string($con, $line[10]);
...
$dlno20=mysqli_real_escape_string($con, $line[65]);
$dlno21=mysqli_real_escape_string($con, $line[66]);
$cstno=mysqli_real_escape_string($con, $line[67]);
$manufacturer=mysqli_real_escape_string($con, $line[68]);
$mrp=mysqli_real_escape_string($con, $line[69]);
$noofpacks=mysqli_real_escape_string($con, $line[70]);
$prodiscount=mysqli_real_escape_string($con, $line[71]);
$discount=mysqli_real_escape_string($con, $line[72]);
$discountamount=mysqli_real_escape_string($con, $line[73]);
$freightamount=mysqli_real_escape_string($con, $line[74]);
$roundoff=mysqli_real_escape_string($con, $line[75]);
$editedon=mysqli_real_escape_string($con, $line[76]);
$sqlpurchasereturns="INSERT INTO pairpurchasereturns set franchisesession='$franchisesession',createdon='$createdon',createdid='$createdid',createdby='$createdby',paidstatus='$paidstatus',purchasereturndate='$purchasereturndate',purchasereturnno='$purchasereturnno',purchasereturnterm='$purchasereturnterm',duedate='$duedate',duedates='$duedates',purchasereturnamount='$purchasereturnamount',vendorname='$vendorname',vendorid='$vendorid',area='$area',city='$city',pincode='$pincode',state='$state',district='$district',sarea='$sarea',scity='$scity',sdistrict='$sdistrict',sstate='$sstate',spincode='$spincode',gstno='$gstno',gstrtype='$gstrtype',mobile='$mobile',workphone='$workphone',batch='$batch',expdate='$expdate',productid='$productid',productname='$productname',producthsn='$producthsn',itemmodule='$itemmodule',vat='$vat',quantity='$quantity',productrate='$productrate',productvalue='$productvalue',taxvalue='$taxvalue',productnetvalue='$productnetvalue',totalitems='$totalitems',totalvatamount='$totalvatamount',taxtype='$taxtype',cgst25='$cgst25',sgst25='$sgst25',gst25='$gst25',cgst6='$cgst6',sgst6='$sgst6',gst6='$gst6',cgst9='$cgst9',sgst9='$sgst9',gst9='$gst9',cgst14='$cgst14',sgst14='$sgst14',gst14='$gst14',tax25='$tax25',tax6='$tax6',tax9='$tax9',tax14='$tax14',totalamount='$totalamount',totalquantity='$totalquantity',grandtotal='$grandtotal',pos='$pos',sameasbilling='$sameasbilling',vendorinfodefault='$vendorinfodefault',unit='$unit',dlno20='$dlno20',dlno21='$dlno21',cstno='$cstno',manufacturer='$manufacturer',mrp='$mrp',noofpacks='$noofpacks',prodiscount='$prodiscount',discount='$discount',discountamount='$discountamount',freightamount='$freightamount',roundoff='$roundoff',editedon='$editedon'";
$resultpurchasereturns=mysqli_query($con,$sqlpurchasereturns);
      }
        if($resultpurchasereturns){
          header("Location: purchasereturns.php?remarks=Imported Successfully");
        }
    else{
          header("Location: purchasereturns.php?error=".mysqli_errno($con));
    }
    }
  }
  else{
    // $all="invalid purchasereturns type";
  }
}
?>
<!DOCTYPE html>
...
<div class="card-body p-3">
 ...
 <p class="mb-3" style="color:black;font-size:20px;margin-top: -8px;"> <i class="fa fa-file-import"></i> Purchase Return Import</p>

<div class="alert alert-info text-white">
Kindly Note that the New Purchase Return List should contains existing Purchase Return Name, otherwise it has been Overrided.
</div>
...
<div class="col-sm-4">
<label for="firstname" class="custom-label"><span class="text-danger">Purchase Returns CSV File *</span></label>
</div>
<div class="col-sm-8">
<input type="file" class="form-control  form-control-sm" required id="purchasereturnsfile" name="purchasereturnsfile" accept=".csv">
</div>
</div>
</div>
</div>
...
<input class="btn btn-primary btn-sm btn-custom" type="submit" name="purchasereturnsubmit" value="Save">  <a class="btn btn-primary btn-sm btn-custom-grey" href="purchasereturns.php">Cancel</a>
</div>
</div>
</form>
