...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start" id="sidenav-main"
    ...
    <div class="sidenav-header sticky-top" id="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="dashboard.php" style="background-color:#ffffff; height:47px; text-align:left;">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item ">
                ...
                <div class="collapse collapseshow show"
                    ...
                    ?>
                        <li class="nav-item ddaass <?=($current_file_name=='dashboard.php')?'active':''?>">
                            <a id="dashboard"
                                style="margin-left: 0px;margin-top: -4px;margin-bottom: 5px;padding-bottom: 9px;padding-top: 9px;font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;font-size: .9375rem;height:30px;"
                                class="nav-link das" href="dashboard.php"
                                onclick="javascript:window.open('dashboard.php','_self')">
