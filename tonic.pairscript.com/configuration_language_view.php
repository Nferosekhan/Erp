                    ...
                    <div class="col-12">
                        <div class="card mb-4 mt-5">
                            <div class="card-body p-3"
                                ...
                                <p class="mb-0" style="font-size: 14.6px;color: black;position: relative;top: -12px;border-bottom: 1px solid #dee2e6;"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration</a> <span>&gt;</span> Language</p>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <span style="float:right" class="mb-0">
                                            ...
                                            <form action="franchisechange.php" method="get">
                                                <a class="btn btn-primary btn-sm btn-custom-grey"
                                                    href="configuration_language_edit.php"
                                ...
                                <form action="" onsubmit="return checkvalidate()" method="post"
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                            ...
                                            <p class="m-3" style="color:black;font-size: 18px;">Language
                                                Details</p>
                                            <div class="row m-3" style="align-items: center;">
                                                <div class="col-sm-3 col-md-2 col-6" style="color:black;font-size: 13px;">
                                                    Language Name
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                            ...
                                            <div class="table-responsive m-3">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php
	  $sqluse=mysqli_query($con, "select * from pairusehistory where usetype='LANGUAGE' and useid='$companymainid'");
