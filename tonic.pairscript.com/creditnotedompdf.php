...
if (($_GET['term']=='creditnote')&&($_GET['sizes']=='a4')) {
...
$sqlismainaccessfield=mysqli_query($con, "select * from pairmainaccess where userid='$companymainid' and moduletype='Credit Notes' order by id  asc");
...
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Credit Notes' order by id  asc");
...
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
 ...
 {
	  $creditnoteno=mysqli_real_escape_string($con, $_GET['creditnoteno']);
	  $creditnotedate=mysqli_real_escape_string($con, $_GET['creditnotedate']);
 $sql=mysqli_query($con, "select * from paircreditnotes where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and creditnoteno='$creditnoteno' and creditnotedate='$creditnotedate' order by id asc");
$count=1;
...
<span style="'.(($access['creditnotebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['creditnotebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['creditnotebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['creditnotebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['creditnoteprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['creditnoteprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 31%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['creditnotebranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['creditnotebranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['creditnoteprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['creditnoteprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 31%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
...
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['bank']).'</span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;'.(($access['creditnotebank']=='1')?'':'position:relative;top:-30px;margin-bottom:-10px;').'">Name </span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;'.(($access['creditnotebank']=='1')?'':'position:relative;top:-30px;margin-bottom:-10px;').'">: </span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;width: 56%;'.(($access['creditnotebank']=='1')?'overflow: hidden;white-space: nowrap;':'white-space: pre-line;position:relative;top:-18px;margin-bottom:-23px;min-height:39px;max-height:39px;overflow:hidden;').'font-size: 12px !important;text-align: left !important;">'.($info['names']).'</span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['accountnumber']).'</span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['ifsccode']).'</span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['branchandcity']).'</span>
</span>
</div>
<div style="border:1px solid #cccccc;padding-top:2.8px;text-align: left;border-bottom:none;margin-bottom:-28px;">
<span style="width: 33%;display:inline-block;background-color:#eee;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:1px 6px !important;font-size:13px;white-space: nowrap;'.(((in_array('Billing Address', $fieldview))||(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Billing '.((in_array('Billing Address', $fieldview))?'Address':'').'</strong></span>
<span style="width: 33%;display:inline-block;background-color:#eee;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:1px 6px !important;font-size:13px;white-space: nowrap;'.(((in_array('Shipping Address', $fieldview))||(in_array('Shipping Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Shipping '.((in_array('Shipping Address', $fieldview))?'Address':'').'</strong></span>
...
<br>
<strong style="display:inline-block;'.(($rows[0]['customername']!=''&&(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'font-weight:bold;font-size: 13px !important;width: 245px;overflow: hidden;height: 15px;white-space: nowrap;">'.(($rows[0]['customername']!='')?((($rows[0]['customername']))):'').'</strong>
<span style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['area']!='')||($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!=''))&&(in_array('Billing Address', $fieldview))&&(((($rows[0]['area']!='')))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;width: 245px;overflow: hidden;height:20px;">'.((($rows[0]['area']))).'</span>
<span style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['area']!='')||($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!=''))&&(in_array('Billing Address', $fieldview))&&(((($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!='')))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;width: 245px;overflow: hidden;height:20px;"><span style="display: inline-flex;max-width: 80px;overflow: hidden;position:relative;top:3px;">'.($rows[0]['city']).' '.(((($rows[0]['city']!='')&&($rows[0]['state']!=''))?',':'')).'</span>'.($rows[0]['state']).' '.(((($rows[0]['state']!='')&&($rows[0]['pincode']!=''))?',':'')).' '.($rows[0]['pincode']).' '.(((($rows[0]['state']!='')&&($rows[0]['district']!='')||($rows[0]['pincode']!='')&&($rows[0]['district']!=''))?',':'')).' '.($rows[0]['district']).'</span>
...
<span style="width: 33%;display:inline-block;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:6px 6px 3px 6px !important;margin-bottom:-22px;">
<br>
<strong style="display:inline-block;'.(($rows[0]['customername']!=''&&(in_array('Shipping Name', $fieldview)))?'':'visibility:hidden;').'font-weight:bold;font-size: 13px !important;width: 245px;overflow: hidden;height: 15px;white-space: nowrap;">'.(($rows[0]['customername']!='')?((($rows[0]['customername']))):'').'</strong>
<span style="'.((in_array('Shipping Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['sarea']!='')||($rows[0]['scity']!='')||($rows[0]['sstate']!='')||($rows[0]['spincode']!='')||($rows[0]['sdistrict']!=''))&&(in_array('Shipping Address', $fieldview))&&((($rows[0]['sarea']!=''))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;width: 245px;overflow: hidden;height:20px;">'.((($rows[0]['sarea']))).'</span>
<span style="'.((in_array('Shipping Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['sarea']!='')||($rows[0]['scity']!='')||($rows[0]['sstate']!='')||($rows[0]['spincode']!='')||($rows[0]['sdistrict']!=''))&&(in_array('Shipping Address', $fieldview))&&(($rows[0]['scity']!='')||($rows[0]['sstate']!='')||($rows[0]['spincode']!='')||($rows[0]['sdistrict']!='')))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;width: 245px;overflow: hidden;height:20px;"><span style="display: inline-flex;max-width: 80px;overflow: hidden;position:relative;top:3px;">'.($rows[0]['scity']).' '.(((($rows[0]['scity']!='')&&($rows[0]['sstate']!=''))?',':'')).'</span>'.($rows[0]['sstate']).' '.(((($rows[0]['sstate']!='')&&($rows[0]['spincode']!=''))?',':'')).' '.($rows[0]['spincode']).' '.(((($rows[0]['sstate']!='')&&($rows[0]['sdistrict']!='')||($rows[0]['spincode']!='')&&($rows[0]['sdistrict']!=''))?',':'')).' '.($rows[0]['sdistrict']).'</span>
...
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['creditnoteprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['creditnoteprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Place Of Supply </span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['creditnoteprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['creditnoteprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.(($infomainaccessuser['creditnoteprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['creditnoteprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?$rows[0]['pos']:'').'</b></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['creditnoteno']).'</strong></span><span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['creditnotedate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['creditnoteterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
$sqlitaxes=mysqli_query($con, "select * from paircreditnotes where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and creditnoteno='$creditnoteno' and creditnotedate='$creditnotedate' order by id asc");
...
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;font-size: 12px !important;text-align: center !important;position:relative;top:25px;">Printed </span>
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48.5%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:13px;"><b> </b></span>
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;font-size: 12px !important;text-align: center !important;position:relative;top:25px;font-weight:bold;left:63px;">Pages </span>
...
<tr>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;'.((in_array('Item Details', $fieldview))?'':'display:none !important;').'text-align:left;min-width:'.($widthforitems).'px ;max-width:'.($widthforitems).'px ;">ITEM DETAILS</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;'.((in_array('Category', $fieldview))?'':'display:none !important;').'text-align: left;max-width:31px;min-width:31px;">'.($access['txtnamecategory']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;'.((in_array('Hsn or Sac', $fieldview))?'':'display:none !important;').'text-align: left;max-width:48px;">HSN/SAC</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'text-align: left;">BATCH</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'text-align: left;max-width:35px !important;min-width:35px !important;">EXPIRY</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: right !important;'.((in_array('Mrp', $fieldview))?'':'display:none !important;').'">MRP</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: right !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'">RATE</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: left !important;min-width:18px;max-width:18px;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.($access['txtprodiscreditnote']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtycreditnote']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: right !important;'.((in_array('GST Percentage', $fieldview))?'':'display:none !important;').'max-width: 28px !important;min-width: 28px !important;">GST %</th>';
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxablecreditnote']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align:right !important;min-width:47px;max-width:47px;">AMOUNT</th>';
}
$html .= '</tr>
</thead>
<tbody>';
...
$html .= '
	 ...
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;max-width: 31px !important;min-width: 31px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Category', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['manufacturer']!='')?$row['manufacturer']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;max-width: 48px !important;min-width: 48px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Hsn or Sac', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['producthsn']!='')?$row['producthsn']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;max-width: 58px !important;min-width: 58px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['batch']!='')?$row['batch']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;max-width: 35px !important;min-width: 35px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['expdate']!='')?date($dateforexp,strtotime($row['expdate'])):'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;text-align: right;max-width: 45px !important;min-width: 45px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Mrp', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['mrp']!='0')?(number_format((float)$row['mrp'],2,'.','')):'0.00')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;text-align: right;max-width: 46px !important;min-width: 46px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['productrate']!='0')?(number_format((float)$row['productrate'],2,'.','')):'Free')).'</span></td>
	 ...
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;text-align: right;max-width: 18px !important;min-width: 18px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.($row['quantity']).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;text-align: right;max-width: 28px !important;min-width: 28px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('GST Percentage', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.($row['vat']).'%</span></td>';
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;text-align:right;max-width: 47px !important;min-width: 47px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;"><span style="display: block;overflow: hidden;height: 19px;">'.((number_format((float)$row['productvalue'],2,'.',''))).'</span></td>';
}
if ((in_array('Amount', $fieldview))) {
$html .= '<td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 3px !important;text-align:right;max-width: 47px !important;min-width: 47px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;"><span style="display: block;overflow: hidden;height: 19px;">'.((number_format((float)$row['productnetvalue'],2,'.',''))).'</span></td>';
}
$html .= '</tr>';
if($row['vat']==5)
{
...
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display:block;height:23px;padding-left:36px;position:relative;top:6px;">Printed</span>
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'width: 1%;display:inline-block;margin-right: -4.5px;position:relative;top:6px;padding:6px !important;font-size:12px;white-space: nowrap;text-align:right;overflow:hidden;">&nbsp;</span><strong style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'font-size:12px !important;display:inline-block;white-space: nowrap;text-align:center;overflow:hidden;width:95%;position:relative;top:-9px;left:-10px;">Pages</strong>
</span>
<span style="width: 33%;display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:6px 3px 0px 3px !important;font-size:12px;white-space: nowrap;border-bottom:0px solid #cccccc;margin-top:10px;margin-bottom:-11px;">
...
$mask = 'dompdf/Credit Notes-*.*';
array_map('unlink', glob($mask));
$output = $dompdf->output();
file_put_contents("dompdf/".$_GET['names'].".pdf", $output);
} 
if (($_GET['term']=='creditnote')&&($_GET['sizes']=='a5')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['creditnotebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['creditnotebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['creditnotebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['creditnoteprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['creditnoteprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['creditnotebranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['creditnotebranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['creditnoteprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['creditnoteprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
<span style="width: 32%;display:inline-block;margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
<div style="border:1px solid #cccccc;padding-top:2.8px;text-align: left;border-bottom:none;margin-bottom:-28px;">
<span style="width: 33%;display:inline-block;background-color:#eee;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:1px 6px !important;font-size:13px;white-space: nowrap;'.(((in_array('Billing Address', $fieldview))||(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Billing '.((in_array('Billing Address', $fieldview))?'Address':'').'</strong></span>
...
<span style="width: 33%;display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:6px 3px 0px 3px !important;font-size:12px;white-space: nowrap;border-bottom:0px solid #cccccc;margin-top:10px;margin-bottom:-11px;">
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;;font-size: 12px !important;text-align: center !important;position:relative;top:25px;">Printed </span>
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48.5%;font-size: 12px !important;text-align: left !important;position:relative;top:13px;"><b> </b></span>
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;;font-size: 12px !important;text-align: center !important;position:relative;top:25px;font-weight:bold;left:63px;">Pages </span>
...
if (($_GET['term']=='creditnote')&&($_GET['sizes']=='a52')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
$html .= '</span>
<span style="width: '.((($access['creditnotebank']=='0' && $access['creditnotename']=='0' && $access['creditnoteaccnumber']=='0' && $access['creditnoteifsccode']=='0' && $access['creditnotebranchandcity']=='0')?'82%':'50%')).';display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<strong style="font-size:14px;vertical-align: top;display: inline-flex;white-space: nowrap;width: 312px;overflow: hidden;">'.($info['franchisename']).'</strong>
<span style="font-size:12px;margin: 0px !important;display: inline-flex;width: '.((($access['creditnotebank']=='0' && $access['creditnotename']=='0' && $access['creditnoteaccnumber']=='0' && $access['creditnoteifsccode']=='0' && $access['creditnotebranchandcity']=='0')?'617px':'360px')).';overflow: hidden;white-space: nowrap;">'.($info['street']).' '.($info['city']).' '.($info['pincode']).' '.($info['state']).' '.($info['country']).' </span>
<span style="'.(($access['creditnotebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['creditnotebranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['creditnotebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['creditnotebranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
...
<span style="width: 32%;'.((($access['creditnotebank']=='0' && $access['creditnotename']=='0' && $access['creditnoteaccnumber']=='0' && $access['creditnoteifsccode']=='0' && $access['creditnotebranchandcity']=='0')?'display: none;':'display:inline-block;')).'margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
...
<div style="border:1px solid #cccccc;padding-top:2.8px;text-align: left;border-bottom:none;margin-bottom:-28px;">
<span style="width: 66%;display:inline-block;background-color:#eee;margin-right: -9px;border-right: 1px solid #cccccc;padding:1px 12px !important;font-size:13px;white-space: nowrap;'.(((in_array('Billing Address', $fieldview))||(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Billing '.((in_array('Billing Address', $fieldview))?'Address':'').'</strong></span>
<span style="width: 33.6%;display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;font-size:15px;white-space: nowrap;"></span>
</div>
<div style="border:1px solid #cccccc;padding-top:3px;text-align: left;border-top:none;border-bottom:none;height:115px !important;">
<span style="width: 66%;display:inline-block;margin-right: -9px;border-right: 1px solid #cccccc;padding:6px 12px !important;margin-bottom:-22px;">
<br>
<strong style="display:inline-block;'.(($rows[0]['customername']!=''&&(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'font-weight:bold;font-size: 13px !important;width: 490px;overflow: hidden;height: 15px;white-space: nowrap;">'.(($rows[0]['customername']!='')?((($rows[0]['customername']))):'').'</strong>
<span style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['area']!='')||($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!=''))&&(in_array('Billing Address', $fieldview))&&(((($rows[0]['area']!='')||($rows[0]['city']!='')))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;width: 490px;overflow: hidden;height:20px;">'.((($rows[0]['area']))).'</span>
<span style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['area']!='')||($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!=''))&&(in_array('Billing Address', $fieldview))&&(((($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!='')))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;width: 490px;overflow: hidden;height:20px;">'.((($rows[0]['city']))).' '.(((($rows[0]['city']!='')&&($rows[0]['state']!=''))?',':'')).' '.((($rows[0]['state']))).' '.(((($rows[0]['state']!='')&&($rows[0]['pincode']!=''))?',':'')).' '.($rows[0]['pincode']).' '.(((($rows[0]['state']!='')&&($rows[0]['district']!='')||($rows[0]['pincode']!='')&&($rows[0]['district']!=''))?',':'')).' '.($rows[0]['district']).'</span>
<span style="'.((in_array('Work Phone', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 29%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Work Phone </span>
<span style="'.((in_array('Work Phone', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 67%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.($rows[0]['workphone']).'</b></span>
<span style="'.(((in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').''.((($infomainaccessuser['creditnoteprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['creditnoteprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 29%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.(((($infomainaccessuser['creditnoteprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['creditnoteprintgstin']!='hide'))?'GSTIN':'')).' </span>
<span style="'.(((in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').''.((($infomainaccessuser['creditnoteprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['creditnoteprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))||(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 67%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">'.(($infomainaccessuser['creditnoteprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['creditnoteprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))?': '.$rows[0]['gstno']:'').'</b><span style=" '.((in_array('Mobile Phone', $fieldview))?'display: inline-block;':'display:none;').'white-space: nowrap;width: 200px;overflow: hidden;padding-top:6px;text-align:right;"><span style="display: block;width: 100%;"><span style="display: inline-block;width: 50%;"> Mobile Phone</span><b style="display: inline-block;width: 50%;"> : '.($rows[0]['mobile']).'</b></span></span></span>
</span>
<span style="width: 29%;display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;margin-bottom:-22px;vertical-align:middle;">
<span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Number</span></span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Date</span></span>
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['creditnotedate']))).'</strong></span>
<span style="'.(((in_array('Credit Note Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="'.(((in_array('Credit Note Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Time</span></span>
<span style="'.(((in_array('Credit Note Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.date('h:i:s A',strtotime($rows[0]['creditnotetime'])).'</strong></span>
<span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Payment</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Term</span></span>
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['creditnoteterm']).'</strong></span>
</span>
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;'.((in_array('Category', $fieldview))?'':'display:none !important;').'text-align: left;max-width:33px;min-width:33px;">'.($access['txtnamecategory']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;'.((in_array('Hsn or Sac', $fieldview))?'':'display:none !important;').'text-align: left;max-width:45px;min-width:45px;">HSN/SAC</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'text-align: left;min-width:35px;max-width:35px;">BATCH</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'text-align: left;min-width:35px;max-width:35px;">EXPIRY</th>
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'min-width:47px;max-width:47px;">RATE</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:34px;max-width:34px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtycreditnote']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('GST Percentage', $fieldview))?'':'display:none !important;').'min-width:28px;max-width:28px;">GST %</th>';
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxablecreditnote']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:47px;max-width:47px;">AMOUNT</th>';
}
$html .= '</tr>
</thead>
<tbody>';
...
$netamount= (float)$row['productvalue']+$vatamount+$vatamount;
$html .= '<tr style="height:13px !important;">
	 <td style="border: 1px solid #cccccc;padding:0px 6px !important;max-width: '.($widthforitems).'px  !important;min-width: '.($widthforitems).'px  !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;font-size:13px;'.((in_array('Item Details', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;font-size:13px !important;">'.($row['productname']).'</span>';
$html .= '
</td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;max-width: 33px !important;min-width: 33px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Category', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['manufacturer']!='')?$row['manufacturer']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;max-width: 45px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Hsn or Sac', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['producthsn']!='')?$row['producthsn']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;max-width: 35px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['batch']!='')?$row['batch']:'')).'</span></td>
	 ...
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align: right;max-width: 22px !important;min-width: 22px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Mrp', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['mrp']!='0')?(number_format((float)$row['mrp'],2,'.','')):'0.00')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align: right;max-width: 47px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.((($row['productrate']!='0')?(number_format((float)$row['productrate'],2,'.','')):'Free')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align: right;max-width: 34px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.($row['quantity']).'</span></td>
	 <td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align: right;max-width: 28px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('GST Percentage', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 19px;">'.($row['vat']).'%</span></td>';
if ((in_array('Taxable Value', $fieldview))) {
...
if ((in_array('Amount', $fieldview))) {
$html .= '<td style="font-size: 12px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align:right;max-width: 47px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;"><span style="display: block;overflow: hidden;height: 19px;">'.((number_format((float)$row['productnetvalue'],2,'.',''))).'</span></td>';
}
$html .= '</tr>';
if($row['vat']==5)
{
...
if (($_GET['term']=='creditnote')&&($_GET['sizes']=='dt')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['creditnotebank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['creditnotename']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['creditnoteaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['creditnoteifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['creditnotebranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="width: 33%;display:inline-block;background-color:#fff;margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:13px;white-space: nowrap;'.(((in_array('Shipping Address', $fieldview))||(in_array('Shipping Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Shipping '.((in_array('Shipping Address', $fieldview))?'Address':'').'</strong></span>
...
<br>
<strong style="display:inline-block;'.(($rows[0]['customername']!=''&&(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'font-weight:bold;font-size: 13px !important;display: inline-block;width: 293px;overflow: hidden;height: 15px;white-space: nowrap;">'.(($rows[0]['customername']!='')?((($rows[0]['customername']))):'').'</strong>
<span style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['area']!='')||($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!=''))&&(in_array('Billing Address', $fieldview))&&(((($rows[0]['area']!='')))))?'':'visibility:hidden;').'white-space: normal;font-size:12px;display: inline-block;width: 293px;overflow: hidden;min-height:30px;max-height:30px;line-height:13.8px;">'.((($rows[0]['area']))).'</span>
<span style="'.((in_array('Billing Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['city']!='')||($rows[0]['area']!='')||($rows[0]['city']!='')||($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!=''))&&(in_array('Billing Address', $fieldview))&&(((($rows[0]['state']!='')||($rows[0]['pincode']!='')||($rows[0]['district']!='')||($rows[0]['city']!='')))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;display: inline-block;width: 293px;overflow: hidden;height:15px;"><span style="font-size: 12px;display: inline-flex;max-width: 111px;overflow: hidden;">'.($rows[0]['city']).'</span> '.(((($rows[0]['city']!='')&&($rows[0]['state']!=''))?',':'')).' <span style="font-size: 12px;display: inline-flex;max-width: 60px;overflow: hidden;">'.($rows[0]['state']).'</span> '.(((($rows[0]['city']!='')&&($rows[0]['state']!='')&&($rows[0]['pincode']!=''))?',':'')).' <span style="font-size: 12px;display: inline-flex;max-width: 39px;overflow: hidden;">'.($rows[0]['pincode']).'</span> '.(((($rows[0]['city']!='')&&($rows[0]['state']!='')&&($rows[0]['district']!='')||($rows[0]['pincode']!='')&&($rows[0]['district']!=''))?',':'')).' <span style="font-size: 12px;display: inline-flex;max-width: 30px;overflow: hidden;">'.($rows[0]['district']).'</span></span>
...
<span style="width: 33%;display:inline-block;margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;margin-bottom:-22px;">
<br>
<strong style="display:inline-block;'.(($rows[0]['customername']!=''&&(in_array('Shipping Name', $fieldview)))?'':'visibility:hidden;').'font-weight:bold;font-size: 13px !important;display: inline-block;width: 293px;overflow: hidden;height: 15px;white-space: nowrap;">'.(($rows[0]['customername']!='')?((($rows[0]['customername']))):'').'</strong>
<span style="'.((in_array('Shipping Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['sarea']!='')||($rows[0]['scity']!='')||($rows[0]['sstate']!='')||($rows[0]['spincode']!='')||($rows[0]['sdistrict']!=''))&&(in_array('Shipping Address', $fieldview))&&(((($rows[0]['sarea']!='')))))?'':'visibility:hidden;').'white-space: normal;font-size:12px;display: inline-block;width: 293px;overflow: hidden;min-height:30px;max-height:30px;line-height:13.8px;">'.((($rows[0]['sarea']))).'</span>
<span style="'.((in_array('Shipping Address', $fieldview))?'display:inline-block;':'display:none;').''.(((($rows[0]['scity']!='')||($rows[0]['sarea']!='')||($rows[0]['scity']!='')||($rows[0]['sstate']!='')||($rows[0]['spincode']!='')||($rows[0]['sdistrict']!=''))&&(in_array('Shipping Address', $fieldview))&&(((($rows[0]['sstate']!='')||($rows[0]['spincode']!='')||($rows[0]['sdistrict']!='')||($rows[0]['scity']!='')))))?'':'visibility:hidden;').'white-space: nowrap;font-size:12px;display: inline-block;width: 293px;overflow: hidden;height:15px;"><span style="font-size: 12px;display: inline-flex;max-width: 111px;overflow: hidden;">'.($rows[0]['scity']).'</span> '.(((($rows[0]['scity']!='')&&($rows[0]['sstate']!=''))?',':'')).' <span style="font-size: 12px;display: inline-flex;max-width: 60px;overflow: hidden;">'.($rows[0]['sstate']).'</span> '.(((($rows[0]['scity']!='')&&($rows[0]['sstate']!='')&&($rows[0]['spincode']!=''))?',':'')).' <span style="font-size: 12px;display: inline-flex;max-width: 39px;overflow: hidden;">'.($rows[0]['spincode']).'</span> '.(((($rows[0]['scity']!='')&&($rows[0]['sstate']!='')&&($rows[0]['sdistrict']!='')||($rows[0]['spincode']!='')&&($rows[0]['sdistrict']!=''))?',':'')).' <span style="font-size: 12px;display: inline-flex;max-width: 30px;overflow: hidden;">'.($rows[0]['sdistrict']).'</span></span>
<span style="'.((in_array('Mobile Phone', $fieldview))?'':'visibility:hidden;').'display: inline-flex;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-3px;">Mobile Phone </span>
<span style="'.((in_array('Mobile Phone', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-3px;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.($rows[0]['mobile']).'</b></span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['creditnoteprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['creditnoteprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-10px;">Place Of Supply </span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['creditnoteprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['creditnoteprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-10px;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.(($infomainaccessuser['creditnoteprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['creditnoteprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?$rows[0]['pos']:'').'</b></span>
</span>
...
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Number</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 20px !important;text-align: left !important;"><strong>: '.($rows[0]['creditnoteno']).'</strong></span><span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Date</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['creditnotedate']))).'</strong></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Payment</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Term</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['creditnoteterm']).'</strong></span>
</span>
</div>
</header>
<footer>
<div style="border:1px dashed #000000;padding-top:30px;text-align: left;border-top:none;border-bottom:none;">
...
<td style="padding: 0px 3px !important;font-size: 10px !important;text-align: right !important;border-top: 1px dashed #000000 !important;border-bottom: 1px dashed #000000 !important;border-right: 1px dashed #000000 !important;border-left: 1px dashed #000000 !important;padding-right: 15px;'.(($_GET['icsgst']=='igstshow')?'':'display:none;').'" colspan="2">
'.number_format((int)$newgstpercent[$i]).'%
</td>
<td style="padding: 0px 3px !important;font-size: 10px !important;border-top: 1px dashed #000000 !important;border-bottom: 1px dashed #000000 !important;border-right: 1px dashed #000000 !important;border-left: 1px dashed #000000 !important;text-align: right !important;'.(($_GET['icsgst']=='igstshow')?'':'display:none;').'" colspan="2">
<span style="display: inline-block;white-space: nowrap;width: 60px;overflow: hidden;">'.($newigst[$i]).'</span>
</td>
<td style="padding: 0px 3px !important;font-size: 10px !important;text-align: right !important;border-top: 1px dashed #000000 !important;border-bottom: 1px dashed #000000 !important;border-right: 1px dashed #000000 !important;border-left: 1px dashed #000000 !important;padding-right: 15px;">
'.number_format((int)$newgstpercent[$i]).'%
</td>
<td style="padding: 0px 3px !important;font-size: 10px !important;text-align: right !important;border-top: 1px dashed #000000 !important;border-bottom: 1px dashed #000000 !important;border-right: 1px dashed #000000 !important;border-left: 1px dashed #000000 !important;">
<span style="display: inline-block;white-space: nowrap;width: 100%;overflow: hidden;">'.($newgst[$i]).'</span>
</td>
</tr>';
}
...
<td style="padding: 0px 3px !important;border-top: 1px dashed #000000 !important;border-bottom: 1px dashed #000000 !important;border-right: 1px dashed #000000 !important;border-left: 1px dashed #000000 !important;font-size: 10px !important;text-align: right !important;padding-right: 15px;">
</td>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;'.((in_array('Category', $fieldview))?'':'display:none !important;').'text-align: left;max-width:33px;min-width:33px;">'.($access['txtnamecategory']).'</th>
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;'.((in_array('Hsn or Sac', $fieldview))?'':'display:none !important;').'text-align: left;max-width:41px;min-width:41px;">HSN/SAC</th>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'text-align: left;max-width:44px;min-width:44px;">EXPIRY</th>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtycreditnote']).'</th>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;max-width: 17px !important;min-width: 17px !important;overflow: hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.$access['txtprodiscreditnote'].'</th>
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('GST Percentage', $fieldview))?'':'display:none !important;').'min-width:28px;max-width:28px;">GST %</th>';
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:40px;max-width:40px;">'.($access['txttaxablecreditnote']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
$html .= '<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:40px;max-width:40px;">AMOUNT</th>';
}
$html .= '</tr>
</thead>
<tbody>';
...
$netamount= (float)$row['productvalue']+$vatamount+$vatamount;
$html .= '<tr style="height:13px !important;">
	 <td style="border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;max-width: '.($widthforitems).'px  !important;min-width: '.($widthforitems).'px  !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;font-size:13px;'.((in_array('Item Details', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;font-size:13px !important;">'.($row['productname']).'</span>';
$html .= '
</td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;max-width: 33px !important;min-width: 33px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Category', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['manufacturer']!='')?$row['manufacturer']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;max-width: 41px !important;min-width: 41px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Hsn or Sac', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['producthsn']!='')?$row['producthsn']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;max-width: 45px !important;min-width: 45px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['batch']!='')?$row['batch']:'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;max-width: 44px !important;min-width: 44px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.(($access['batchexpiryval']==1)?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['expdate']!='')?date($dateforexp,strtotime($row['expdate'])):'')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align: right;max-width: 40px !important;min-width: 40px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Mrp', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['mrp']!='0')?(number_format((float)$row['mrp'],2,'.','')):'0.00')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align: right;max-width: 18px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.($row['quantity']).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align: right;max-width: 40px !important;min-width: 40px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['productrate']!='0')?(number_format((float)$row['productrate'],2,'.','')):'Free')).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align: right;max-width: 17px !important;min-width: 17px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.((($row['prodiscounttype']=='0')?($row['prodiscount']).'%':(number_format((float)$row['prodiscount'],2,'.','')))).'</span></td>
	 <td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align: right;max-width: 28px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('GST Percentage', $fieldview))?'':'display:none !important;').'"><span style="display: block;overflow: hidden;height: 18px;">'.($row['vat']).'%</span></td>';
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align:right;max-width: 40px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;"><span style="display: block;overflow: hidden;height: 18px;">'.((number_format((float)$row['productvalue'],2,'.',''))).'</span></td>';
}
if ((in_array('Amount', $fieldview))) {
$html .= '<td style="font-size: 12px !important;border: 1px dashed #000000;border-bottom: 0px dashed #fff !important;border-top: 0px dashed #fff !important;padding:0px 6px !important;text-align:right;max-width: 40px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;"><span style="display: block;overflow: hidden;height: 18px;">'.((number_format((float)$row['productnetvalue'],2,'.',''))).'</span></td>';
}
$html .= '</tr>';
if($row['vat']==5)
{
...
<div style="border:1px dashed #000000;padding:0px !important;text-align: left;border-top:none;border-bottom:0px dashed #000000;">';
	 $dateformat = mysqli_query($con,"select * from paricountry");
	 $datefetch = mysqli_fetch_array($dateformat);
	 if ($datefetch['date']=='DD/MM/YYYY') {
	 $date = 'd/m/Y h:i:s';
...
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'display:block;height:16px;padding-left:54px;position:relative;top:0px;">Printed</span>
<span style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'width: 1%;display:inline-block;margin-right: -4.5px;position:relative;top:6px;padding:6px !important;font-size:12px;white-space: nowrap;text-align:right;overflow:hidden;">&nbsp;</span><strong style="'.(((in_array('Printed On', $fieldview)))?'':'visibility:hidden;').'font-size:12px !important;display:inline-block;white-space: nowrap;text-align:center;overflow:hidden;width:95%;position:relative;top:-9px;left:-10px;">Pages</strong>
</span>
<span style="width: 33%;display:inline-block;margin-right: -4.5px;border-right: 0px dashed #000000;padding:6px 3px 0px 3px !important;font-size:12px;white-space: nowrap;border-bottom:0px dashed #000000;margin-top:10px;margin-bottom:-11px;">
...
if (($_GET['term']=='creditnote')&&($_GET['sizes']=='threeinch')) {
  // Instantiate and use the dompdf class 
  $dompdf = new Dompdf();
  include('lcheck.php');
  $sqlismainaccessfield=mysqli_query($con, "select * from pairmainaccess where userid='$companymainid' and moduletype='Credit Notes' order by id  asc");
...
<head>
	...
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.min.js" integrity="sha384-cuYeSxntonz0PPNlHhBs68uyIAVpIIOZZ5JqeqvYYIcEL727kskC66kF92t6Xl2V" crossorigin="anonymous"></script>
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
	<style>@page { margin: 10px; }body { font-family: "Myriad Set Pro","Helvetica Neue",Helvetica,Arial,sans-serif;word-wrap: break-word;border:1px solid #cccccc;}table {border-collapse: collapse;}</style>
</head>
<body>
  	<header>
		<div style="text-align:center;border-bottom: 1px solid #cccccc;padding-bottom:3px;white-space: nowrap;overflow: hidden;">
			<div><b style="font-size:13px !important;">'.($infomainaccessuser['modulename']).'</b></div>
	 	</div>
		<div style="padding-top:5px;text-align: center;border-bottom: 1px solid #cccccc;padding-bottom:3px;">
			<span style="display:block;text-align:center;height:40px;">';
			 $imgs=explode(',',$info['branchimage']);
			 foreach($imgs as $img){
				if ($info['branchimage']!='') {
					$franchpath = (str_replace('../ups','ups',$img));
	 			...
	 			$html .= '<img alt="Branch Pic" src="'.($franchbase64).'" id="branch-image1" height="40" width="40" style="'.(($info['branchimage']!='')?'':'visibility:hidden;').'">';
	 		}
			$html .= '
			</span>
			<span style="display:block;text-align:center;font-size:15px !important;font-weight:bold;white-space: nowrap;overflow: hidden;">
				'.($info['franchisename']).'
			</span>
			<span style="display:block;text-align:center;font-size:10px !important;white-space: nowrap;overflow: hidden;">
				'.($info['street']).'
			</span>
			<span style="display:block;text-align:center;font-size:10px !important;white-space: nowrap;overflow: hidden;">
				'.($info['city']).'
			...
			<span style="display:block;text-align:center;font-size:10px !important;white-space: nowrap;overflow: hidden;'.(($access['creditnotebranchphone']=='0')?'visibility:hidden;':'').'">
				Phone : '.($info['mobile']).'
			</span>
		</div>
		<div style="text-align: center;border-bottom: 1px solid #cccccc;font-weight:bold;">
			<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 10px !important;text-align: left !important;">
				<span style="display: inline-block;white-space: nowrap;width: 33%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;">
					Number
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;">
					<strong>: '.($rows[0]['creditnoteno']).'</strong>
				</span>
			</span>
			<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 10px !important;text-align: right !important;">
				<span style="display: inline-block;white-space: nowrap;width: 33%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					Date
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					<strong>: '.(date($datemainphp,strtotime($rows[0]['creditnotedate']))).'</strong>
				</span>
			</span>
		</div>
	</header>
		...
		<div style="text-align: center;border-bottom: 1px solid #cccccc;">
			<div style="border: 0px solid #cccccc;width:100% !important;">
				<table style="border: 0px solid #cccccc;width:100% !important;">
					<thead style="background-color: #eee;">
						<tr>
							<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 10px !important;padding:0px 6px !important;'.((in_array('Item Details', $fieldview))?'':'display:none !important;').'text-align:left;min-width:'.($widthforitems).'px ;max-width:'.($widthforitems).'px ;">
								ITEM DETAILS
							</th>
							<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 10px !important;padding:0px 6px !important;text-align: right !important;min-width:17px;max-width:17px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">
								'.($access['txtqtycreditnote']).'
							</th>
							<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 10px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'"min-width:32px;max-width:32px;>
								RATE
							</th>
							<th style="'.((in_array('Amount', $fieldview))?'':'display:none !important;').'border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 10px !important;padding:0px 6px !important;text-align:right !important;min-width:40px;max-width:40px;">
								AMOUNT
							</th>
						</tr>
					</thead>
					...
					$html .= '
						<tr style="height:13px !important;">
							<td style="border: 1px solid #cccccc;padding:0px 6px !important;max-width: '.($widthforitems).'px  !important;min-width: '.($widthforitems).'px  !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Item Details', $fieldview))?'':'display:none !important;').'">
								<span style="font-size: 10px !important;display: block;overflow: hidden;height: 19px;">
									'.($row['productname']).'
								</span>';
					$html .= '
							</td>
						 	<td style="font-size: 10px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align: right;max-width: 17px !important;min-width: 17px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">
						 		<span style="display: block;overflow: hidden;height: 19px;">
						 			'.($row['quantity']).'
						 		</span>
						 	</td>
						 	<td style="font-size: 10px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align: right;max-width: 32px !important;min-width: 32px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;'.((in_array('Rate', $fieldview))?'':'display:none !important;').'">
						 		<span style="display: block;overflow: hidden;height: 19px;">
						 			'.((($row['productrate']!='0')?(number_format((float)$row['productrate'],2,'.','')):'Free')).'
						 		</span>
						 	</td>
							<td style="'.((in_array('Amount', $fieldview))?'':'display:none !important;').'font-size: 10px !important;border: 1px solid #cccccc;padding:0px 6px !important;text-align:right;max-width: 40px !important;min-width: 40px !important;overflow: hidden;line-height: 18px;white-space: nowrap !important;">
								<span style="display: block;overflow: hidden;height: 19px;">
									'.((number_format((float)$row['productnetvalue'],2,'.',''))).'
								</span>
							</td>
						</tr>';
						if($row['vat']==5)
	...
	<footer>
		<div style="text-align: center;padding-top:13px;margin-bottom:-95px;">
			<span style="display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 10px !important;text-align: left !important;">
				<span style="display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;visibility:hidden;">
					Total Items
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 50%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;visibility:hidden;">
					<strong>: '.($rows[0]['totalitems']).'</strong>
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;visibility:hidden;">
					Total Items
				</span>
				...
				<span style="display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;">
					Total Items
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 50%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;">
					<strong>: '.($rows[0]['totalitems']).'</strong>
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;visibility:hidden;'.((in_array('Total Tax', $fieldview))?'':'display:none;').'">
					Total Items
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 50%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;visibility:hidden;'.((in_array('Total Tax', $fieldview))?'':'display:none;').'">
					<strong>: '.($rows[0]['totalitems']).'</strong>
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;visibility:hidden;">
					Total Items
			...
			<span style="display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 10px !important;text-align: left !important;">
				<span style="display: inline-block;white-space: nowrap;width: 46%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					Sub Total
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 52%;overflow: hidden;font-size: 10px !important;position:relative;top:3px;padding-right:0px;margin-right:0px;">
					<span style="font-family: DejaVu Sans; sans-serif;">: &#8377;</span>
					<span style="display:inline-block;width:56px;text-align:right;overflow:hidden;position:relative;top:3px;">
						'.(number_format((float)$rows[0]['totalamount'],2,'.','')).'
					</span>
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 46%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					Discount
				...
				<span style="display: inline-block;white-space: nowrap;width: 52%;overflow: hidden;font-size: 10px !important;position:relative;top:3px;padding-right:0px;margin-right:0px;">
					<span style="font-family: DejaVu Sans; sans-serif;">: &#8377;</span>
					<span style="display:inline-block;width:56px;text-align:right;overflow:hidden;position:relative;top:3px;">
						'.(number_format((float)$rows[0]['discountamount'],2,'.','')).'
					</span>
				</span>
				<span style="white-space: nowrap;width: 46%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;'.((in_array('Total Tax', $fieldview))?'display: inline-block;':'display:none;').'">
					Total Tax
				</span>
				<span style="white-space: nowrap;width: 52%;overflow: hidden;font-size: 10px !important;position:relative;top:3px;padding-right:0px;margin-right:0px;'.((in_array('Total Tax', $fieldview))?'display: inline-block;':'display:none;').'">
					<span style="font-family: DejaVu Sans; sans-serif;">: &#8377;</span>
					<span style="display:inline-block;width:56px;text-align:right;overflow:hidden;position:relative;top:3px;">
						'.(number_format((float)$rows[0]['totalvatamount'],2,'.','')).'
					</span>
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 46%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					Round Off
				...
				<span style="display: inline-block;white-space: nowrap;width: 52%;overflow: hidden;font-size: 10px !important;position:relative;top:3px;padding-right:0px;margin-right:0px;">
					<span style="font-family: DejaVu Sans; sans-serif;">: &#8377;</span>
					<span style="display:inline-block;width:56px;text-align:right;overflow:hidden;position:relative;top:3px;">
						'.(number_format((float)$rows[0]['roundoff'],2,'.','')).'
					</span>
				</span>
			</span>
		</div>
		<div style="text-align: right;border-top: 1px solid #cccccc;padding-right:3px;position:relative;top:58px;border-bottom: 1px solid #cccccc;">
			<span style="display: inline-block;white-space: nowrap;width: 98%;overflow: hidden;font-size: 10px !important;text-align: right !important;">
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 15px !important;text-align: right !important;position:relative;top:3px;">
					<strong>Grand Total</strong>
				</span>
				<span style="display: inline-block;white-space: nowrap;width: 38%;overflow: hidden;font-size: 15px !important;position:relative;top:3px;padding-right:0px;margin-right:0px;">
					<span style="font-family: DejaVu Sans; sans-serif;font-weight:700;">: &#8377;</span>
					<span style="display:inline-block;width:63px;text-align:right;overflow:hidden;position:relative;top:3px;">
						<strong>'.(number_format((float)$rows[0]['grandtotal'],2,'.','')).'</strong>
					</span>
				</span>
			</span>
		</div>
		<div style="text-align: center;">
			<div><span style="font-size:10px !important;position:relative;top:58px;">'.($rows[0]['terms']).'</span></div>
		</div>
		<div style="font-size:10px !important;position:fixed;bottom:-4.5px;color: #ccc !important;text-align: center;width:100%;">
			<span style="background-color:#fff !important;">PAIRSCRIPT</span>
		</div>
	</footer>
</body>
</html>';
  $totalheightpdf = (($countt - 1) * 15) + 220;
  $dompdf->loadHtml($html);
  $customPaper = array(0,0,216,$totalheightpdf);
