...
if ($infomainaccessaccounting['groupaccess']=='0') {
...
$sqlismodules=mysqli_query($con, "select * from pairmodules where moduletype='Manual Journals' order by id  asc");
while($infomodules=mysqli_fetch_array($sqlismodules)){
  ...
  foreach ($newmodules as $newmoduleskey) {
                ...
                $modcolumncol=$coltypemod."coljournal";
                ...
                $sqlmainaccessmanjourn = "update pairmainaccess set modulecolumns='$modcolumncolchanges' where (userid='$companymainid' or createdid='$companymainid') and moduletype='Manual Journals'"; 
                $sqlmainaccessupmanjourn = mysqli_query($con, $sqlmainaccessmanjourn);
if ($sqlmainaccessupmanjourn) {
$sqlismodules=mysqli_query($con, "select * from pairmodules where moduletype='Chart of Accounts' order by id  asc");
while($infomodules=mysqli_fetch_array($sqlismodules)){
    $coltypemodule = preg_replace('/\s+/', '', $infomodules['moduletype']);
    $ansmodules = $infomodules[4];
    $newmodules = explode(',',$ansmodules);
  ...
  foreach ($newmodules as $newmoduleskey) {
                $coltypemod = preg_replace('/\s+/', '',$newmoduleskey);
                $modcolumncol=$coltypemod."colchartaccount";
                $modcolumncol=mysqli_real_escape_string($con, (isset($_POST[$modcolumncol]))?$newmoduleskey:' ');
                if($modcolumncolchanges!='')
                {
                    $modcolumncolchanges.=','.$modcolumncol;
                ...
                $sqlmainaccesschartaccountup = "update pairmainaccess set modulecolumns='$modcolumncolchanges' where (userid='$companymainid' or createdid='$companymainid') and moduletype='Chart of Accounts'"; 
                $sqlmainaccessupchartaccount = mysqli_query($con, $sqlmainaccesschartaccountup);
            }
...
?>
    <title>
        Preference &gt; <?= $row['books'] ?> &gt; <?= $infomainaccessaccounting['groupname'] ?>
    </title>
<style type="text/css">
   ...
   // notifications
    ...
    <i class="fa fa-times"></i> &nbsp;<?=$_GET['error']?></p>
     ...
     ?>
      ...
      $sqlismainaccessaccounting=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and grouptype='Accounting' order by id  asc");
      $infomainaccessaccounting=mysqli_fetch_array($sqlismainaccessaccounting);
$sqlismainaccessjournal=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Manual Journals' order by id  asc");
$infomainaccessjournal=mysqli_fetch_array($sqlismainaccessjournal);
$sqlismainaccesschartaccount=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Chart of Accounts' order by id  asc");
$infomainaccesschartaccount=mysqli_fetch_array($sqlismainaccesschartaccount);
        ?>
    ...
    <p class="mb-3" style="font-size: 14.6px;color: black;position: relative;top: 15px;"><a href="preference.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Preference </a><span>&gt;</span><a href="preference_billing.php" style="color: #1878F1"> <!-- <i class="fa fa-book"></i> -->
                                    <?= $row['books'] ?> </a> &gt; <!-- <i class="fa fa-shopping-basket"></i>  --><?= $infomainaccessaccounting['groupname'] ?></p>
                                    <div class="mt-3" style="border-top: 1px solid #dee2e6;position: relative;top: 0px;"></div>
                                    <p class="mb-2" style="font-size: 20px;color: black;position: relative;top: 12px;"><?= $infomainaccessaccounting['groupname'] ?></p>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <?php
        if ($infomainaccessjournal['moduleaccess']=='1') {
        ?>
<button class="nav-link active" id="nav-general-tab" data-bs-toggle="tab" data-bs-target="#nav-general" type="button" role="tab" aria-controls="nav-general" aria-selected="true"><div class="customcont-header ml-0">
        ...
        <a class="customcont-heading"><?= $infomainaccessjournal['modulename'] ?> 
</a>  
             
                </div></button>
                <?php
                }
                if ($infomainaccesschartaccount['moduleaccess']=='1') {
                ?>
<button class="nav-link" id="nav-chartaccount-tab" data-bs-toggle="tab" data-bs-target="#nav-chartaccount" type="button" role="tab" aria-controls="nav-chartaccount" aria-selected="true"><div class="customcont-header ml-0">
    
        <a class="customcont-heading"><?= $infomainaccesschartaccount['modulename'] ?> 
</a>  
...
<div class="tab-pane fade show active mt-4 p-3" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
    <div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="journalfield">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#journalfields"
                                                    aria-expanded="true" aria-controls="journalfields">
                                            ...
                                            <div id="journalfields" class="accordion-collapse collapse show"
                                                aria-labelledby="journalfield">
...
<div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="journalcolumn">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#journalcolumns"
                                                    aria-expanded="true" aria-controls="journalcolumns">
                                                    <div class="customcont-header ml-0 mb-1 mt-3">
                                            ...
                                            <div id="journalcolumns" class="accordion-collapse collapse show"
                                                aria-labelledby="journalcolumn">
                                                <div class="accordion-body text-sm">
                                                  <?php
...
$sqlismainaccess=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Manual Journals' order by id  asc");
...
?>
           <div class="row" style=" border-top:1.5px solid #eee; border-bottom:1.5px solid #eee; padding:5px 0">
            <div class="col-lg-2">
                <div class="custom-control custom-checkbox mr-sm-2">
                        <input type="checkbox" class="custom-control-input" name="<?= $coltypemod; ?>coljournal" id="<?= $coltypemod; ?>coljournal" <?= ((in_array($newmoduleskey, $newans)))?'checked':'' ?> <?= (($newmoduleskey=='Name'))?'disabled checked':'' ?>>
                        <label class="custom-control-label custom-label" for="<?= $coltypemod; ?>coljournal" style="font-size: 14.6px;color:royalblue !important;"> <?= $newmoduleskey; ?></label>
                      </div>
            </div>
            <div class="col-lg-10">
    ...
    <div class="col-lg-12"><hr>
        <button name="submit"
                ...
                if ($infomainaccesschartaccount['moduleaccess']=='1') {
                ?>
<div class="tab-pane fade show mt-4 p-3" id="nav-chartaccount" role="tabpanel" aria-labelledby="nav-chartaccount-tab">
    <div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="chartaccountfield">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#chartaccountfields"
                                                    aria-expanded="true" aria-controls="chartaccountfields">
                                                    <div class="customcont-header ml-0 mb-1 mt-3">
                                                        <a class="customcont-heading" style="font-size: 18px;"> Select the fields you would like to enable</a>
                                                    </div>
                                                </button>
                                            ...
                                            <div id="chartaccountfields" class="accordion-collapse collapse show"
                                                aria-labelledby="chartaccountfield">
                                                <div class="accordion-body text-sm">
</div>
</div>
</div>
<div class="accordion" id="accordionRental">
                                        <div class="accordion-item mb-1">
                                            <h5 class="accordion-header" id="chartaccountcolumn">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#chartaccountcolumns"
                                                    aria-expanded="true" aria-controls="chartaccountcolumns">
                                                    <div class="customcont-header ml-0 mb-1 mt-3">
                                                        <a class="customcont-heading" style="font-size: 18px;"> Select the columns you would like to enable</a>
                                                    </div>
                                                </button>
                                            ...
                                            <div id="chartaccountcolumns" class="accordion-collapse collapse show"
                                                aria-labelledby="chartaccountcolumn">
                                                <div class="accordion-body text-sm">
                                                  <?php
...
$sqlismainaccess=mysqli_query($con, "select * from pairmainaccess where (userid='$companymainid' and createdid='0') and moduletype='Chart of Accounts' order by id  asc");
while($infomainaccess=mysqli_fetch_array($sqlismainaccess)){
    $coltype = preg_replace('/\s+/', '', $infomainaccess['moduletype']);
    $ans = $infomainaccess[24];
    $newans = explode(',',$ans);
...
?>
           <div class="row" style=" border-top:1.5px solid #eee; border-bottom:1.5px solid #eee; padding:5px 0">
            <div class="col-lg-2">
                <div class="custom-control custom-checkbox mr-sm-2">
                        <input type="checkbox" class="custom-control-input" name="<?= $coltypemod; ?>colchartaccount" id="<?= $coltypemod; ?>colchartaccount" <?= ((in_array($newmoduleskey, $newans)))?'checked':'' ?> <?= (($newmoduleskey=='Name'))?'disabled checked':'' ?>>
                        <label class="custom-control-label custom-label" for="<?= $coltypemod; ?>colchartaccount" style="font-size: 14.6px;color:royalblue !important;"> <?= $newmoduleskey; ?></label>
                      </div>
            </div>
            <div class="col-lg-10">
