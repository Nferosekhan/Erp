...
<header>';
            $paidamount=0;
                ...
                $sqlsalespay=mysqli_query($con,"select amount from pairsalespayhistory where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and invoiceno='".$invoiceno."' and invoicedate='".$invoicedate."' order by id desc");
...
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 18%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 80%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 18%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 47%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['invprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 13%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['invprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 19%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['invbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 18%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['invbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 47%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['invprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 13%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['invprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 19%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
</div>
...
<span style="'.(($infomainaccessuser['invoiceprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['invoiceprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($infomainaccessuser['invoiceprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['invoiceprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.($rows[0]['gstno']).'</b></span>
</span>
...
<span style="'.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Place Of Supply </span>
<span style="'.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.($rows[0]['pos']).'</b></span>
</span>
...
<span style="'.(((in_array('Invoice Information', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceno']).'</strong></span><span style="'.(((in_array('Invoice Information', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
...
<span style="'.(((in_array('Invoice Information', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['invoicedate']))).'</strong></span>
...
<span style="'.(((in_array('Invoice Information', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
<span style="display: inline-block;white-space: nowrap;width: 60px;overflow: hidden;">'.($newtaxes[$i]).'</span>
</td>
...
<span style="display: inline-block;white-space: nowrap;width: 23px;overflow: hidden;">'.($newcgst[$i]).'</span>
</td>
<td style="border-right: 1px solid #cccccc;padding: 0px 3px !important;border-bottom: 1px solid #cccccc;font-size: 8px !important;text-align: right !important;padding-right: 15px;">
2.5%
</td>
<td style="border-right: 1px solid #cccccc;padding: 0px 3px !important;border-bottom: 1px solid #cccccc;font-size: 8px !important;text-align: right !important;">
<span style="display: inline-block;white-space: nowrap;width: 23px;overflow: hidden;">'.($newsgst[$i]).'</span>
</td>
...
<span style="display: inline-block;white-space: nowrap;width: 23px;overflow: hidden;">'.($newgst[$i]).'</span>
</td>
</tr>';
}
}
...
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
...
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
...
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
...
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
...
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
</span>
</div>
<div style="border:1px solid #cccccc;padding-top:5px;text-align: left;border-bottom:none;margin-bottom:-28px;">
<span style="width: 33%;display:inline-block;background-color:#eee;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:1px 6px !important;font-size:15px;white-space: nowrap;"><strong>Billing Address</strong></span>
