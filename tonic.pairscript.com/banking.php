<?php
include('lcheck.php');
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and grouptype='Banking' order by id  asc");
...
<body class="g-sidenav-show" style="background-color:#F1F2F6">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-0 " style="overflow-y: scroll !important;">
   <?php
	...
	<a class="customcont-heading customcont-heading-active" style="font-family:'Myriad Set Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">Banking</a>
	</div>
