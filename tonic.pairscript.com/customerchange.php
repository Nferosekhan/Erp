	...
	{	
		...
		{	
			...
			else
			{
				...
				$sqluse=mysqli_query($con, "insert into pairusehistory set usetype='CUSTOMER', createdon='$times',  createdby='".$_SESSION["unqwerty"]."', useid='$id', useremarks='$useremarks' ");
				...
				header("Location: customerview.php?id=".$id."&remarks=Updated Successfully");
			} 
	    }
		else
			{
				header("Location: customers.php?error=This record is Not Found! Kindly check in All Users List");
			}
	}
	else
			{
