	 ...
	 <div style="max-width: 1650px;">
       ...
       <?php
                      ...
                      <?php
                                                ...
                                                ?>
                                                <?php
                                            if ($access['payreceivevendornamelist']!=0) {
                                                ?>
                      <td class="text-uppercase" style="width:50px;"><span style="font-size:13px;color:black;">Vendor Name</span></td>
                      <?php
                                            }
                                                ?>
                                                <?php
...
$sql=mysqli_query($con,"select id, createdon, term, receiptdate, receiptno, cancelstatus, vendorid, vendorname, paymentmode, amount, notes from pairsalespayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and type='purchaseorder' order by id desc");
$count=1;
