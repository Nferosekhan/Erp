<?php
include('lcheck.php');
 if((isset($_GET['deliverychallanno']))&&(isset($_GET['deliverychallandate'])))
 {
     $deliverychallanno=mysqli_real_escape_string($con, $_GET['deliverychallanno']);
     $deliverychallandate=mysqli_real_escape_string($con, $_GET['deliverychallandate']);
 $sql=mysqli_query($con, "select * from pairdeliverychallans where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and deliverychallanno='$deliverychallanno' and deliverychallandate='$deliverychallandate' order by id asc");
...
$datefetch = mysqli_fetch_array($dateformat);
if ($datefetch['date']=='DD/MM/YYYY') {
if (($access['deliverychprintexpdate']=='0')&&($access['deliverychprintexpmonth']=='0')&&($access['deliverychprintexpyear']=='0')) {
$dateforexp = '';
$widthforexp = '5%';
}
if (($access['deliverychprintexpdate']=='1')&&($access['deliverychprintexpmonth']=='1')&&($access['deliverychprintexpyear']=='1')) {
$dateforexp = 'd/m/Y';
$widthforexp = '10%';
}
if (($access['deliverychprintexpdate']=='0')&&($access['deliverychprintexpmonth']=='1')&&($access['deliverychprintexpyear']=='1')) {
$dateforexp = 'm/Y';
$widthforexp = '7%';
}
if (($access['deliverychprintexpdate']=='1')&&($access['deliverychprintexpmonth']=='0')&&($access['deliverychprintexpyear']=='1')) {
$dateforexp = 'd/Y';
$widthforexp = '7%';
}
if (($access['deliverychprintexpdate']=='1')&&($access['deliverychprintexpmonth']=='1')&&($access['deliverychprintexpyear']=='0')) {
$dateforexp = 'd/m';
$widthforexp = '7%';
}
if (($access['deliverychprintexpdate']=='1')&&($access['deliverychprintexpmonth']=='0')&&($access['deliverychprintexpyear']=='0')) {
$dateforexp = 'd';
$widthforexp = '5%';
}
if (($access['deliverychprintexpdate']=='0')&&($access['deliverychprintexpmonth']=='1')&&($access['deliverychprintexpyear']=='0')) {
$dateforexp = 'm';
$widthforexp = '5%';
}
if (($access['deliverychprintexpdate']=='0')&&($access['deliverychprintexpmonth']=='0')&&($access['deliverychprintexpyear']=='1')) {
$dateforexp = 'Y';
$widthforexp = '5%';
}
}
...
?>
<a class="btn btn-primary btn-sm btn-custom-grey" href="deliverychallanedit.php?deliverychallanno=<?=$deliverychallanno?>&deliverychallandate=<?=$deliverychallandate?>" style="margin:4.5px 4.5px !important;"><i class="fa fa-pencil-alt"></i> <span class="mobreswords"> Edit</span></a>
 <?php 
}
?>
<a href="javascript:;" class="btn btn-primary btn-sm btn-custom-grey" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" style="margin:4.5px 4.5px !important;padding-bottom: 3px !important;" onclick="more()">
              ...
              <i class="fa fa-caret-down" id="more" style="color: #3c3c46 !important;position: relative;top: -12px;left: 130px;"></i>   
               <li class="nav-item" style="margin-top:-22px !important;">
                  <a class="nav-link" href="deliverychallancancel.php?deliverychallanno=<?=$deliverychallanno?>&deliverychallandate=<?=$deliverychallandate?>&cancelstatus=<?=($rows[0]['cancelstatus']=='0')?'1':'0'?>" onclick="return confirm('Are you sure want to <?=($rows[0]['cancelstatus']=='0')?'Cancel':'Enable'?> this Delivery Challan?')">
...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
      ...
      <tbody>
        <?php
      $sqluse=mysqli_query($con, "select * from pairusehistory where usetype='DELIVERYCH' and useid='$deliverychallanno' order by createdon desc");
...
<?php
$sqlismainaccessuser=mysqli_query($con, "select moduleno, moduleprefix, modulesuffix,deliverychallanprintgsttreatment,deliverychallanprintgstin,modulename,deliverychprintpos from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Delivery Challans' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-lg-8 col-md-12 justify-content-center">
            ...
            $paidamount=0;
                $currentbalance=0;
                $currentamount=(float)$rows[0]['deliverychallanamount'];
                $sqlsalespay=mysqli_query($con,"select amount from pairsalespayhistory where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and invoiceno='".$deliverychallanno."' and invoicedate='".$deliverychallandate."' order by id desc");
                while($infosalespay=mysqli_fetch_array($sqlsalespay))
                {
                    $paidamount+=(float)$infosalespay['amount'];
                }
                $currentbalance=((float)$rows[0]['deliverychallanamount']-$paidamount);
            if($currentbalance==0)
            {
                ?>
            ...
            ?>
<?php
if($info['deliverychallantemplate']=='1')
{
    ?>
<div id="printalble">
...
<td style="">
<table width="100%">
<tr style="<?=($access['deliverychbranchphone']=='0')?'display:none;':''?>">
...
<tr>
<td width="10%" style="font-size:12px;padding: 0px !important;line-height: 15px !important;<?=($access['deliverychbranchemail']=='0')?'visibility:hidden;':''?>">E-mail </td>
<td width="90%" style="font-size:12px;padding: 0px !important;line-height: 15px !important;"><input type="text" readonly value=": <?=$info['email']?>" style="padding:0px;color:black;width: 206px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 12px;<?=($access['deliverychbranchemail']=='0')?'visibility:hidden;':''?>" class="form-control form-control-sm"><span style="<?=(($access['deliverychprintdlno20']=='1')?'display:inline-flex;':'display:none;')?>white-space: nowrap;width: 169px;overflow: hidden;float: right;margin-right: 9px;">DL No 20 &nbsp; : <?=$info['dlno20']?></span></td>
</tr>
<tr>
<td width="10%" style="font-size:12px;padding: 0px !important;line-height: 15px !important;<?=($access['deliverychbranchgstin']=='0')?'visibility:hidden;':''?>">GSTIN </td>
<td width="90%" style="font-size:12px;padding: 0px !important;line-height: 15px !important;"><span style="display: inline-flex;white-space: nowrap;width: 134px;overflow: hidden;<?=($access['deliverychbranchgstin']=='0')?'visibility:hidden;':''?>">: <?=$info['gstno']?></span><span style="<?=(($access['deliverychprintdlno21']=='1')?'display:inline-flex;':'display:none;')?>white-space: nowrap;width: 169px;overflow: hidden;float: right;margin-right: 9px;">DL No 21 &nbsp; : <?=$info['dlno21']?></span></td>
</tr>
</table>
</td>
</tr>
...
<td width="34.5%">
<table width="100%">
<tr <?=(($access['deliverychbank']=='1')?'':'style="display:none;"')?>>
...
<tr <?=(($access['deliverychname']=='1')?'':'style="display:none;"')?>>
...
<tr <?=(($access['deliverychaccnumber']=='1')?'':'style="display:none;"')?>>
...
<tr <?=(($access['deliverychifsccode']=='1')?'':'style="display:none;"')?>>
...
<tr <?=(($access['deliverychbranchandcity']=='1')?'':'style="display:none;"')?>>
...
<?php
if (($infomainaccessuser['deliverychallanprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['deliverychallanprintgstin']!='hide')) {
?>
...
<td width="62%" style="font-size:12px;padding: 0px !important;line-height: 15px !important;">: 
<?php
if (($infomainaccessuser['deliverychprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['deliverychprintpos']!='hide')) {
?>
...
<?php
if ((in_array('Delivery Challan Information', $fieldview))) {
?>
<tr>
...
<td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;text-align: left !important;" width="45%">: <b><?=$rows[0]['deliverychallanno']?></b></td>
</tr>
<tr>
...
<?php
    ...
    ?>
<td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;text-align: left !important;" width="45%">: <b><?=date($date,strtotime($rows[0]['deliverychallandate']))?></b></td>
</tr>
<tr>
...
<td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;text-align: left !important;" width="45%">: <b><?=$rows[0]['deliverychallanterm']?></b></td>
</tr>
<?php
}
?>
...
$deliverych = '<tr><td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;" width="55%"><input type="text" readonly value="'. $infomainaccessuser['modulename'] .'" style="padding:0px;color:black;width: 56px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 14px;" class="form-control form-control-sm"> <input type="text" readonly value="Number" style="padding:0px;color:black;width: 54px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 14px;" class="form-control form-control-sm"> </td><td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;text-align: left !important;" width="45%">: <b>'.$rows[0]['deliverychallanno'].'</b></td></tr><tr><td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;" width="55%"><input type="text" readonly value="'. $infomainaccessuser['modulename'] .'" style="padding:0px;color:black;width: 56px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 14px;" class="form-control form-control-sm"> <input type="text" readonly value="Date" style="padding:0px;color:black;width: 54px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 14px;" class="form-control form-control-sm"> </td> </td><td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;text-align: left !important;" width="45%">: <b>'.date($date,strtotime($rows[0]['deliverychallandate'])).'</b></td></tr><tr><td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;" width="55%"><input type="text" readonly value="Payment" style="padding:0px;color:black;width: 56px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 14px;" class="form-control form-control-sm"> <input type="text" readonly value="Term" style="padding:0px;color:black;width: 54px !important;height: 18px !important;border: none !important;outline: none !important;display: inline-flex;font-size: 14px;" class="form-control form-control-sm"> </td><td style="padding: 0px !important;font-size: 14px !important;line-height: 15px !important;text-align: left !important;" width="45%">: <b>'.$rows[0]['deliverychallanterm'].'</b></td></tr>';
}
$taxable ='';
$tax ='';
if ((in_array('Taxable Value', $fieldview))) {
...
elseif($info['deliverychallantemplate']=='0')
{
    ?>
<div id="printalble">
<div class="table-responsive" style="width: max-content !important;height: max-content !important;max-width:max-content !important; max-height:max-content !important;min-width:max-content !important; min-height:max-content !important;">
...
elseif($info['deliverychallantemplate']=='2')
{
?>
<div id="printalble">
<div class="table-responsive" style="width: max-content !important;height: max-content !important;max-width:max-content !important; max-height:max-content !important;min-width:max-content !important; min-height:max-content !important;">
...
?>
             ...
             <p align="right" class="mt-3" style="margin-right:-25px; cursor:pointer" id="templatetext">Template: '<?=($info['deliverychallantemplate']=='1')?'24.13cm X 15.75cm':''?><?=($info['deliverychallantemplate']=='0')?'Standard A4 Portrait':''?><?=($info['deliverychallantemplate']=='2')?'Standard A5 Landscape':''?> ' <a data-bs-toggle="modal" data-bs-target="#changedeliverychallanModal" class="text-blue">Change</a></p>
             </div>
...
<!-- Modal -->
<div class="modal fade" id="changedeliverychallanModal" tabindex="-1" role="dialog" aria-labelledby="changedeliverychallanModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="changedeliverychallanModalLabel">Choose Template</h5>
        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
if (r == true) {
    window.location.href='changetemplate.php?template=deliverychallan&no=<?=$deliverychallanno?>&date=<?=$deliverychallandate?>&temptype=0&submt=submt';
} else {
...
var r = confirm('Are you sure want to Change this Template?');
if (r == true) {
    window.location.href='changetemplate.php?template=deliverychallan&no=<?=$deliverychallanno?>&date=<?=$deliverychallandate?>&temptype=2&submt=submt';
} else {
...
var r = confirm('Are you sure want to Change this Template?');
if (r == true) {
    window.location.href='changetemplate.php?template=deliverychallan&no=<?=$deliverychallanno?>&date=<?=$deliverychallandate?>&temptype=1&submt=submt';
} else {
...
<?php
if($info['deliverychallantemplate']=='0')
{
    ?>
<script>
...
$.ajax({
type: "GET",
url: 'deliverychdompdf.php?term=deliverych&names=Delivery Challans-<?=$_GET['deliverychallanno']?>-<?=$_GET['deliverychallandate']?>&deliverychallanno=<?=$_GET['deliverychallanno']?>&deliverychallandate=<?=$_GET['deliverychallandate']?>&sizes=a4',
...
$("#time").html(Timer);
 var req = new XMLHttpRequest();
  req.open("GET", "dompdf/Delivery Challans-<?=$_GET['deliverychallanno']?>-<?=$_GET['deliverychallandate']?>.pdf", true);
...
$("#timedownload").html(Timer);
 var req = new XMLHttpRequest();
  ...
  req.onload = function (event) {
    ...
    link.download="Delivery Challans-<?=$_GET['deliverychallanno']?>-<?=$_GET['deliverychallandate']?>.pdf";
    link.click();
  };
...
?>
<?php
if($info['deliverychallantemplate']=='2')
{
    ?>
<script>
...
$.ajax({
type: "GET",
url: 'deliverychdompdf.php?term=deliverych&names=Delivery Challans-<?=$_GET['deliverychallanno']?>-<?=$_GET['deliverychallandate']?>&deliverychallanno=<?=$_GET['deliverychallanno']?>&deliverychallandate=<?=$_GET['deliverychallandate']?>&sizes=a5',
success: function (result) {
if (result && result.length > 0) {       
result=$.parseJSON( result );
Timer=result.timer;
...
$.ajax({
type: "GET",
url: 'deliverychdompdf.php?term=deliverych&names=Delivery Challans-<?=$_GET['deliverychallanno']?>-<?=$_GET['deliverychallandate']?>&deliverychallanno=<?=$_GET['deliverychallanno']?>&deliverychallandate=<?=$_GET['deliverychallandate']?>&sizes=dt',
success: function (result) {
if (result && result.length > 0) {       
result=$.parseJSON( result );
Timer=result.timer;
...
header("Location:deliverychallans.php?error=No Information Found");
}
}
else{
header("Location:deliverychallans.php?error=No Information Found");  
