...
if(($id!="")&&($val!=""))
	{		
		...
		{	
			// Query if email exists in db
			$sqlup = "update pairunits set createdon='$times', createdid='$companymainid', createdby='".$_SESSION["unqwerty"]."',is_active='$val' where id='$id'";
			...
			{
				header("Location: units.php?error=This record is Not Found! Kindly check in All Users List");
			}
	}
	else
			{
