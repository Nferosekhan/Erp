...
if (($infomainaccessuser['useraccesscreate']==1&&$infomainaccessuser['createdid']!=0)||($infomainaccessuser['createdid']==0)) {
       ...
       <?php
							...
							<?php
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where franchiseid='".$_SESSION['franchisesession']."' and moduletype='Payments Made For Purchase Return' order by id  asc");
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
...
$sql=mysqli_query($con,"select id, createdon, term, receiptdate, receiptno, cancelstatus, vendorid, vendorname, paymentmode, amount, notes,publicid from pairpurchasereturnpayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' order by id desc limit ".(($access['purreturnpaypageload']=='pagenum')?'10':'15')."");
$count=1;
...
$sqltotlist = mysqli_query($con,"select COUNT(DISTINCT receiptno,receiptdate) from pairpurchasereturnpayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid'");
...
$.ajax({
type: "GET",
url: 'listpurreturnpaysearch.php?term=' + sIndex + '',
...
$.ajax({
type: "GET",
url: 'listpurreturnpaysearch.php?term=<?=$i?>0',
success: function (result) {
$("#myTable").html(result);
},
error: function (error) {
