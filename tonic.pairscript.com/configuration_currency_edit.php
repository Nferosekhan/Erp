...
if (isset($_POST['submit'])) {
   header('location:configuration_currency_view.php');
   $sql=mysqli_query($con,"select id from paircurrency");
    while($result=mysqli_fetch_assoc($sql))
    {
        $id=$result['id'];
    }
    $update=mysqli_query($con,"update paircontrols set currencies='".$id."' where username='".$_SESSION['unqwerty']."' or usernewname='".$_SESSION['unqwerty']."' ");
}
?>
<!DOCTYPE html>
<html lang="en">
...
?>
    <title>
        Configuration &gt; Currencies &gt; Currency &gt; Change Currency
    </title>
    <style>
                        ...
                        <div class="card mb-4 mt-5">
                            <div class="card-body p-3"
                                ...
                                <p style="color:black;font-size: 14.6px;border-bottom: 1px solid #dee2e6;" class="mb-3"><a href="config.php" style="color: #1878F1"><!-- <i class="fa fa-sliders"></i> --> Configuration </a><span>&gt;</span><a href="configuration_currency_list.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Currencies </a> <span>&gt;</span><a href="configuration_currency_view.php" style="color: #1878F1"><!-- <i class="fa fa-book"></i> -->
                                   Currency </a> <span>&gt;</span> Change Currency  <!-- <i class="fa fa-file-import"></i> --></p>
                                <p class="mb-3" style="color:black;font-size: 20px;"><i
                                        class="fa fa-pencil-square-o"></i> Edit Currency</p>
...
?>
                                                                    ...
                                                                    <div class="col-lg-12"><hr>
                                                                        <button
                                                                            ...
                                                                            href="configuration_currency_view.php">Cancel</a>
                                                                    </div>
                                                                </div>
                                        </div>
