...
<tr>
<td width="50%">#</td>
<td width="50%">: <b><?=$rows[0]['projectno']?></b></td>
</tr>
<tr>
<td width="50%">Date</td>
<td width="50%">: <b><?=date('d/m/Y',strtotime($rows[0]['projectdate']))?></b></td>
</tr>
<tr>
<td width="50%">Reference No</td>
<td width="50%">: <?=$rows[0]['billingmethod']?></td>
</tr>
<tr>
<td width="50%">Reference Date</td>
<td width="50%">: <?=date('d/m/Y',strtotime($rows[0]['projectname']))?></td>
</tr>
</table>
</td>
<td width="50%" style="border:1px solid #cccccc">
...
<td width="50%">: <b><?=$rows[0]['description']?></b></td>
</tr>
</table>
</td>
</tr>
...
<td style="border:1px solid #cccccc; text-align:right"><?=number_format((float)$row['projectdebit'],2,'.','')?></td> 
<td style="border:1px solid #cccccc; text-align:right"><?=number_format((float)$row['projectcredit'],2,'.','')?></td> 
...
<tr>
	...
	<td style="text-align:right"><?=number_format((float)$rows[0]['subprojectdebit'],2,'.','')?></td>
	<td style="text-align:right"><?=number_format((float)$rows[0]['subprojectcredit'],2,'.','')?></td>
</tr>
<tr style="font-size:18px;">
	<td colspan="4">Total Rs.</td>
	<td style="text-align:right"><?=number_format((float)$rows[0]['totalprojectdebit'],2,'.','')?></td>
	<td style="text-align:right"><?=number_format((float)$rows[0]['totalprojectcredit'],2,'.','')?></td>
</tr>
