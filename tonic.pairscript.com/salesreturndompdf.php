...
if (($_GET['term']=='salesreturn')&&($_GET['sizes']=='a4')) {
...
$sqlismainaccessfield=mysqli_query($con, "select * from pairmainaccess where userid='$companymainid' and moduletype='Sales Returns' order by id  asc");
...
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Sales Returns' order by id  asc");
...
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
 ...
 $sql=mysqli_query($con, "select * from pairsalesreturns where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and salesreturnno='$salesreturnno' and salesreturndate='$salesreturndate' order by id asc");
$count=1;
...
<span style="'.(($access['salereturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['salereturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['salereturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['salereturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['salereturnprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['salereturnprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 31%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['salereturnbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['salereturnbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['salereturnprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['salereturnprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 31%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
...
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['bank']).'</span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;'.(($access['salereturnbank']=='1')?'':'position:relative;top:-30px;margin-bottom:-10px;').'">Name </span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;'.(($access['salereturnbank']=='1')?'':'position:relative;top:-30px;margin-bottom:-10px;').'">: </span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;width: 56%;'.(($access['salereturnbank']=='1')?'overflow: hidden;white-space: nowrap;':'white-space: pre-line;position:relative;top:-18px;margin-bottom:-23px;min-height:39px;max-height:39px;overflow:hidden;').'font-size: 12px !important;text-align: left !important;">'.($info['names']).'</span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['accountnumber']).'</span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['ifsccode']).'</span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['salereturnprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['salereturnprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Place Of Supply </span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['salereturnprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['salereturnprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.(($infomainaccessuser['salereturnprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['salereturnprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?$rows[0]['pos']:'').'</b></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['salesreturnno']).'</strong></span><span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['salesreturndate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['salesreturnterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
$sqlitaxes=mysqli_query($con, "select * from pairsalesreturns where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and salesreturnno='$salesreturnno' and salesreturndate='$salesreturndate' order by id asc");
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: left !important;min-width:18px;max-width:18px;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.($access['txtprodissalereturn']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtysalereturn']).'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxablesalereturn']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
...
$mask = 'dompdf/Sales Returns-*.*';
array_map('unlink', glob($mask));
$output = $dompdf->output();
file_put_contents("dompdf/".$_GET['names'].".pdf", $output);
} 
if (($_GET['term']=='salesreturn')&&($_GET['sizes']=='a5')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['salereturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['salereturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['salereturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['salereturnprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['salereturnprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['salereturnbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['salereturnbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['salereturnprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['salereturnprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
<span style="width: 32%;display:inline-block;margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
<div style="border:1px solid #cccccc;padding-top:2.8px;text-align: left;border-bottom:none;margin-bottom:-28px;">
<span style="width: 33%;display:inline-block;background-color:#eee;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:1px 6px !important;font-size:13px;white-space: nowrap;'.(((in_array('Billing Address', $fieldview))||(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Billing '.((in_array('Billing Address', $fieldview))?'Address':'').'</strong></span>
...
if (($_GET['term']=='salesreturn')&&($_GET['sizes']=='a52')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
$html .= '</span>
<span style="width: '.((($access['salereturnbank']=='0' && $access['salereturnname']=='0' && $access['salereturnaccnumber']=='0' && $access['salereturnifsccode']=='0' && $access['salereturnbranchandcity']=='0')?'82%':'50%')).';display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<strong style="font-size:14px;vertical-align: top;display: inline-flex;white-space: nowrap;width: 312px;overflow: hidden;">'.($info['franchisename']).'</strong>
<span style="font-size:12px;margin: 0px !important;display: inline-flex;width: '.((($access['salereturnbank']=='0' && $access['salereturnname']=='0' && $access['salereturnaccnumber']=='0' && $access['salereturnifsccode']=='0' && $access['salereturnbranchandcity']=='0')?'617px':'360px')).';overflow: hidden;white-space: nowrap;">'.($info['street']).' '.($info['city']).' '.($info['pincode']).' '.($info['state']).' '.($info['country']).' </span>
<span style="'.(($access['salereturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['salereturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['salereturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['salereturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
...
<span style="width: 32%;'.((($access['salereturnbank']=='0' && $access['salereturnname']=='0' && $access['salereturnaccnumber']=='0' && $access['salereturnifsccode']=='0' && $access['salereturnbranchandcity']=='0')?'display: none;':'display:inline-block;')).'margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
...
<span style="'.(((in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').''.((($infomainaccessuser['salereturnprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['salereturnprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 29%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.(((($infomainaccessuser['salereturnprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['salereturnprintgstin']!='hide'))?'GSTIN':'')).' </span>
<span style="'.(((in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').''.((($infomainaccessuser['salereturnprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['salereturnprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))||(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 67%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">'.(($infomainaccessuser['salereturnprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['salereturnprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))?': '.$rows[0]['gstno']:'').'</b><span style=" '.((in_array('Mobile Phone', $fieldview))?'display: inline-block;':'display:none;').'white-space: nowrap;width: 200px;overflow: hidden;padding-top:6px;text-align:right;"><span style="display: block;width: 100%;"><span style="display: inline-block;width: 50%;"> Mobile Phone</span><b style="display: inline-block;width: 50%;"> : '.($rows[0]['mobile']).'</b></span></span></span>
</span>
<span style="width: 29%;display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;margin-bottom:-22px;vertical-align:middle;">
<span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Number</span></span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Date</span></span>
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['salesreturndate']))).'</strong></span>
<span style="'.(((in_array('Sales Return Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="'.(((in_array('Sales Return Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Time</span></span>
<span style="'.(((in_array('Sales Return Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.date('h:i:s A',strtotime($rows[0]['salesreturntime'])).'</strong></span>
<span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Payment</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Term</span></span>
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['salesreturnterm']).'</strong></span>
</span>
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:34px;max-width:34px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtysalereturn']).'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxablesalereturn']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
...
if (($_GET['term']=='salesreturn')&&($_GET['sizes']=='dt')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['salereturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['salereturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['salereturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['salereturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['salereturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['salereturnprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['salereturnprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-10px;">Place Of Supply </span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['salereturnprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['salereturnprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-10px;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.(($infomainaccessuser['salereturnprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['salereturnprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?$rows[0]['pos']:'').'</b></span>
</span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Number</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 20px !important;text-align: left !important;"><strong>: '.($rows[0]['salesreturnno']).'</strong></span><span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Date</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['salesreturndate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Term</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['salesreturnterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtysalereturn']).'</th>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;max-width: 17px !important;min-width: 17px !important;overflow: hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.$access['txtprodissalereturn'].'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:40px;max-width:40px;">'.($access['txttaxablesalereturn']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
...
if (($_GET['term']=='salesreturn')&&($_GET['sizes']=='threeinch')) {
  // Instantiate and use the dompdf class 
  $dompdf = new Dompdf();
  include('lcheck.php');
  $sqlismainaccessfield=mysqli_query($con, "select * from pairmainaccess where userid='$companymainid' and moduletype='Sales Returns' order by id  asc");
...
<body>
  	<header>
		...
		<div style="padding-top:5px;text-align: center;border-bottom: 1px solid #cccccc;padding-bottom:3px;">
			...
			<span style="display:block;text-align:center;font-size:10px !important;white-space: nowrap;overflow: hidden;'.(($access['salereturnbranchphone']=='0')?'visibility:hidden;':'').'">
				Phone : '.($info['mobile']).'
			</span>
		</div>
		<div style="text-align: center;border-bottom: 1px solid #cccccc;font-weight:bold;">
			<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 10px !important;text-align: left !important;">
				...
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;">
					<strong>: '.($rows[0]['salesreturnno']).'</strong>
				</span>
			</span>
			<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 10px !important;text-align: right !important;">
				...
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					<strong>: '.(date($datemainphp,strtotime($rows[0]['salesreturndate']))).'</strong>
				</span>
			</span>
		</div>
	</header>
