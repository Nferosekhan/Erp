...
$sql=mysqli_query($con,"select id, createdon, term, receiptdate, receiptno, cancelstatus, vendorid, vendorname, paymentmode, amount, notes,publicid,privateid from pairdebitnotepayments where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' ".$_GET['typesforlisting']." order by id desc limit ".$_GET['term'].",".(($access['purreturnpaypageload']=='pagenum')?'10':'15')."");
$count=1;
