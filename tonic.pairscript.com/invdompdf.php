...
if (($_GET['term']=='invoice')&&($_GET['sizes']=='a42')) {
...
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Invoices' order by id  asc");
...
<span style="width: 13%;display:inline-block;border-right: 0px solid #cccccc;padding:9px 6px !important;text-align:right;margin-top:18px;height:80px;">';
...
$html .= '</span>';
//<span style="width: 6%;display:inline-block;border-right: 0px solid #cccccc;padding:9px 6px !important;text-align:right;margin-top:18px;height:80px;">
// if ($info['upiid']!='') {
// $qrcodeBase64 = htmlspecialchars($_GET['qrcode']);
// }
// else{
// $qrcodeBase64 = '';
// }
// 	 $html .= '<img alt="Qr Code Pic" src="'.($qrcodeBase64).'" id="branch-image1" height="80" width="80" style="'.(($info['upiid']!='')?'':'visibility:hidden;').'">';</span>
$html .= '
...
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['invprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['invprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 31%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['invbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['invbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['invprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['invprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 31%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
...
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['bank']).'</span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;'.(($access['invbank']=='1')?'':'position:relative;top:-30px;margin-bottom:-10px;').'">Name </span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;'.(($access['invbank']=='1')?'':'position:relative;top:-30px;margin-bottom:-10px;').'">: </span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;width: 56%;'.(($access['invbank']=='1')?'overflow: hidden;white-space: nowrap;':'white-space: pre-line;position:relative;top:-18px;margin-bottom:-23px;min-height:39px;max-height:39px;overflow:hidden;').'font-size: 12px !important;text-align: left !important;">'.($info['names']).'</span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['accountnumber']).'</span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['ifsccode']).'</span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 39%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 1%;overflow: hidden;font-size: 12px !important;text-align: left !important;">:</span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 56%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Place Of Supply </span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?$rows[0]['pos']:'').'</b></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceno']).'</strong></span><span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['invoicedate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
$sqlitaxes=mysqli_query($con, "select * from pairinvoices where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and invoiceno='$invoiceno' and invoicedate='$invoicedate' order by id asc");
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: left !important;min-width:18px;max-width:18px;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.($access['txtprodisinv']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtyinv']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: left !important;min-width:18px;max-width:18px;'.((in_array('Pack', $fieldview))?'':'display:none !important;').'">PACK</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxableinv']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
...
// $mask = 'dompdf/Invoices-*.*';
// array_map('unlink', glob($mask));
// $output = $dompdf->output();
// file_put_contents("dompdf/".$_GET['names'].".pdf", $output);
}
if (($_GET['term']=='invoice')&&($_GET['sizes']=='a4')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
if (($_GET['term']=='invoice')&&($_GET['sizes']=='a5')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['invprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['invprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['invbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['invbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['invprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['invprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
<span style="width: 32%;display:inline-block;margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
<div style="border:1px solid #cccccc;padding-top:2.8px;text-align: left;border-bottom:none;margin-bottom:-28px;">
<span style="width: 33%;display:inline-block;background-color:#eee;margin-right: -4.5px;border-right: 1px solid #cccccc;padding:1px 6px !important;font-size:13px;white-space: nowrap;'.(((in_array('Billing Address', $fieldview))||(in_array('Billing Name', $fieldview)))?'':'visibility:hidden;').'"><strong>Billing '.((in_array('Billing Address', $fieldview))?'Address':'').'</strong></span>
...
if (($_GET['term']=='invoice')&&($_GET['sizes']=='a52')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
$html .= '</span>
<span style="width: '.((($access['invbank']=='0' && $access['invname']=='0' && $access['invaccnumber']=='0' && $access['invifsccode']=='0' && $access['invbranchandcity']=='0')?'82%':'50%')).';display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<strong style="font-size:14px;vertical-align: top;display: inline-flex;white-space: nowrap;width: 312px;overflow: hidden;">'.($info['franchisename']).'</strong>
<span style="font-size:12px;margin: 0px !important;display: inline-flex;width: '.((($access['invbank']=='0' && $access['invname']=='0' && $access['invaccnumber']=='0' && $access['invifsccode']=='0' && $access['invbranchandcity']=='0')?'617px':'360px')).';overflow: hidden;white-space: nowrap;">'.($info['street']).' '.($info['city']).' '.($info['pincode']).' '.($info['state']).' '.($info['country']).' </span>
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['invbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 41%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
...
<span style="width: 32%;'.((($access['invbank']=='0' && $access['invname']=='0' && $access['invaccnumber']=='0' && $access['invifsccode']=='0' && $access['invbranchandcity']=='0')?'display: none;':'display:inline-block;')).'margin-right: -4.5px;border-right: 0px dashed #000000;padding:1px 6px !important;font-size:15px;white-space: nowrap;vertical-align: top;">
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
...
<span style="'.(((in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').''.((($infomainaccessuser['invoiceprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['invoiceprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 29%;overflow: hidden;font-size: 12px !important;text-align: left !important;">'.(((($infomainaccessuser['invoiceprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['invoiceprintgstin']!='hide'))?'GSTIN':'')).' </span>
<span style="'.(((in_array('GSTIN', $fieldview))&&(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').''.((($infomainaccessuser['invoiceprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['invoiceprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))||(in_array('Mobile Phone', $fieldview)))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 67%;overflow: hidden;font-size: 12px !important;text-align: left !important;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">'.(($infomainaccessuser['invoiceprintgstin']=='show')||($rows[0]['gstno']!='')&&($infomainaccessuser['invoiceprintgstin']!='hide')&&(in_array('GSTIN', $fieldview))?': '.$rows[0]['gstno']:'').'</b><span style=" '.((in_array('Mobile Phone', $fieldview))?'display: inline-block;':'display:none;').'white-space: nowrap;width: 200px;overflow: hidden;padding-top:6px;text-align:right;"><span style="display: block;width: 100%;"><span style="display: inline-block;width: 50%;"> Mobile Phone</span><b style="display: inline-block;width: 50%;"> : '.($rows[0]['mobile']).'</b></span></span></span>
</span>
<span style="width: 29%;display:inline-block;margin-right: -4.5px;border-right: 0px solid #cccccc;padding:1px 6px !important;margin-bottom:-22px;vertical-align:middle;">
<span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Number</span></span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Date</span></span>
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['invoicedate']))).'</strong></span>
<span style="'.(((in_array('Invoice Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="'.(((in_array('Invoice Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Time</span></span>
<span style="'.(((in_array('Invoice Time', $fieldview))?'display: inline-block;':'display:none;')).'white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.date('h:i:s A',strtotime($rows[0]['invoicetime'])).'</strong></span>
<span style="display: inline-block;white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Payment</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Term</span></span>
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceterm']).'</strong></span>
</span>
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:34px;max-width:34px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtyinv']).'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxableinv']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
...
if (($_GET['term']=='invoice')&&($_GET['sizes']=='dt')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['invbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['invname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['invaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['invifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['invbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-10px;">Place Of Supply </span>
<span style="'.(((in_array('Place of Supply', $fieldview))?'':'visibility:hidden;').''.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide'))?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 53%;overflow: hidden;font-size: 12px !important;text-align: left !important;position:relative;top:-10px;"><b style="display: inline-block;white-space: nowrap;width: 123px;overflow: hidden;">: '.(($infomainaccessuser['invoiceprintpos']=='show')||($rows[0]['pos']!='')&&($infomainaccessuser['invoiceprintpos']!='hide')&&(in_array('Place of Supply', $fieldview))?$rows[0]['pos']:'').'</b></span>
</span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Number</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 20px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceno']).'</strong></span><span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">'.($infomainaccessuser['modulename']).'</span>
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Date</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['invoicedate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Term</span></span>
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['invoiceterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtyinv']).'</th>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;max-width: 17px !important;min-width: 17px !important;overflow: hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.$access['txtprodisinv'].'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:40px;max-width:40px;">'.($access['txttaxableinv']).'</th>';
}
if ((in_array('Amount', $fieldview))) {
...
if (($_GET['term']=='invoice')&&($_GET['sizes']=='threeinch')) {
  // Instantiate and use the dompdf class 
  $dompdf = new Dompdf();
  include('lcheck.php');
  $sqlismainaccessfield=mysqli_query($con, "select * from pairmainaccess where userid='$companymainid' and moduletype='Invoices' order by id  asc");
...
<body>
  	<header>
		...
		<div style="padding-top:5px;text-align: center;border-bottom: 1px solid #cccccc;padding-bottom:3px;">
			...
			<span style="display:block;text-align:center;font-size:10px !important;white-space: nowrap;overflow: hidden;'.(($access['invbranchphone']=='0')?'visibility:hidden;':'').'">
				Phone : '.($info['mobile']).'
			</span>
		</div>
		<div style="text-align: center;border-bottom: 1px solid #cccccc;font-weight:bold;">
			<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 10px !important;text-align: left !important;">
				...
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 10px !important;text-align: left !important;position:relative;top:3px;">
					<strong>: '.($rows[0]['invoiceno']).'</strong>
				</span>
			</span>
			<span style="display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 10px !important;text-align: right !important;">
				...
				<span style="display: inline-block;white-space: nowrap;width: 60%;overflow: hidden;font-size: 10px !important;text-align: right !important;position:relative;top:3px;">
					<strong>: '.(date($datemainphp,strtotime($rows[0]['invoicedate']))).'</strong>
				</span>
			</span>
		</div>
	</header>
