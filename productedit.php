...
{
$id=custom_escape_string($con, $_GET['id']);
$sqlprohis = mysqli_query($con,"select * from pairproducts where id='$id' and itemmodule='Products'");
$sqlanspro = mysqli_fetch_array($sqlprohis);
$oldproname = custom_escape_string($con,$sqlanspro['productname']);
$oldcodetags = custom_escape_string($con,$sqlanspro['codetags']);
$oldbarcodeformat = custom_escape_string($con,$sqlanspro['barcodeformat']);
$oldbarcodehead = custom_escape_string($con,$sqlanspro['barcodehead']);
$oldbarcode = custom_escape_string($con,$sqlanspro['barcode']);
$oldbarcodetitle = custom_escape_string($con,$sqlanspro['barcodetitle']);
$oldunderbarcodelabel = custom_escape_string($con,$sqlanspro['underbarcodelabel']);
$oldbarcodenotes = custom_escape_string($con,$sqlanspro['barcodenotes']);
$oldprohsn = custom_escape_string($con,$sqlanspro['hsncode']);
$oldprorack = custom_escape_string($con,$sqlanspro['rack']);
$oldprounit = custom_escape_string($con,$sqlanspro['defaultunit']);
$oldprocat = custom_escape_string($con,$sqlanspro['category']);
$oldprosub = custom_escape_string($con,$sqlanspro['subcategory']);
$oldprodel = custom_escape_string($con,$sqlanspro['delivery']);
$oldprodes = custom_escape_string($con,$sqlanspro['description']);
$oldprovis = custom_escape_string($con,$sqlanspro['pvisiblity']);
$oldprotaxprefer = custom_escape_string($con,$sqlanspro['taxpref']);

$oldprointrataxs = custom_escape_string($con,$sqlanspro['intratax']);
...
$oldprointratax = custom_escape_string($con,$sqlintrahisfet['taxname'])." - ".custom_escape_string($con,$sqlintrahisfet['tax'])." %";
}
else{
$oldprointratax = '';
}
$oldprointertaxs = custom_escape_string($con,$sqlanspro['intertax']);
...
$oldprointertax = custom_escape_string($con,$sqlinterhisfet['taxname'])." - ".custom_escape_string($con,$sqlinterhisfet['tax'])." %";
}
else{
$oldprointertax = '';
}
//saletable
$prosalehis=mysqli_query($con,"select * from pairprosale where productid='$id' and itemmodule='Products'");
$prosalehisans=mysqli_fetch_array($prosalehis);
$oldprosalename = custom_escape_string($con,$prosalehisans['salename']);
$oldprosalemrp = custom_escape_string($con,$prosalehisans['salemrp']);
$oldprosalecost = custom_escape_string($con,$prosalehisans['salecost']);
$oldprosaledes = custom_escape_string($con,$prosalehisans['saledescription']);
//purchasetable
$propurhis=mysqli_query($con,"select * from pairpropurchase where productid='$id' and itemmodule='Products'");
$propurhisans=mysqli_fetch_array($propurhis);
$oldpropurname = custom_escape_string($con,$propurhisans['purchasename']);
$oldpropurmrp = custom_escape_string($con,$propurhisans['purchasemrp']);
$oldpropurcost = custom_escape_string($con,$propurhisans['purchasecost']);
$oldpropurdes = custom_escape_string($con,$propurhisans['purchasedescription']);
...
{
// $productcodes=custom_escape_string($con, $_POST['productcode']);
$productname=custom_escape_string($con, $_POST['productname']);
$codetags=custom_escape_string($con, $_POST['codetags']);
$hsncode=custom_escape_string($con, $_POST['hsncode']);
$rack=custom_escape_string($con, $_POST['rack']);
// $pvisibility=custom_escape_string($con, $_POST['visibility']);
$delivery=custom_escape_string($con, $_POST['delivery']);
$sqlcode=mysqli_query($con,"select count(productcode) from pairproducts where createdid='$companymainid' and itemmodule='Products'");
$anscode=mysqli_fetch_array($sqlcode);
// $oldcode=$anscode[0];
// if($oldcode!=$productcodes)
// {
    // $productcode=custom_escape_string($con, $_POST['productcode']);
// }
// else{
...
{
    $defaultunit=custom_escape_string($con, $_POST['defaultunit']);
...
{
    $descriptionsinfo=custom_escape_string($con, $_POST['description']);
}
else{
    $descriptionsinfo=" ";
}
...
{
    $taxpref=custom_escape_string($con, $_POST['taxpref']);
}
else{
    $taxpref=" ";
}
...
{
    $intratax=custom_escape_string($con, $_POST['intratax']);
...
$sqlintrahisfet = mysqli_fetch_array($sqlintrahis);
if (mysqli_num_rows($sqlintrahis)>0) {
$intrataxs = custom_escape_string($con,$sqlintrahisfet['taxname'])." - ".custom_escape_string($con,$sqlintrahisfet['tax'])." %";
}
else{
$intrataxs = '';
}
...
{
    $intertax=custom_escape_string($con, $_POST['intertax']);
...
$sqlinterhisfet = mysqli_fetch_array($sqlinterhis);
if (mysqli_num_rows($sqlinterhis)>0) {
$intertaxs = custom_escape_string($con,$sqlinterhisfet['taxname'])." - ".custom_escape_string($con,$sqlinterhisfet['tax'])." %";
}
else{
$intertaxs = '';
}
...
$barcode=custom_escape_string($con, $_POST['barcode']);
$barcodehead=custom_escape_string($con, $_POST['barcodehead']);
$barcodetitle=custom_escape_string($con, $_POST['barcodetitle']);
$underbarcodelabel=custom_escape_string($con, $_POST['underbarcodelabel']);
$barcodenotes=custom_escape_string($con, $_POST['barcodenotes']);
$barcodeformat=custom_escape_string($con, $_POST['barcodeformat']);
$sqlup = "update pairproducts set createdon='$times',productname='$productname', codetags='$codetags',createdid='$companymainid', createdby='".$_SESSION["unqwerty"]."', itemmodule='Products',franchisesession='".$_SESSION["franchisesession"]."',  description='$descriptionsinfo',defaultunit='$forpro',category='$category', subcategory='$subcategory',pvisiblity='$pvisibility',delivery='$delivery',taxpref='$taxpref',intratax='$intratax',intertax='$intertax',hsncode='$hsncode',rack='$rack',barcodeformat='$barcodeformat',barcode='$barcode',barcodetitle='$barcodetitle',barcodenotes='$barcodenotes',barcodehead='$barcodehead',underbarcodelabel='$underbarcodelabel' where id='$id' and itemmodule='Products'";
            $queryup = mysqli_query($con, $sqlup);
$sqlpricenamequerydel = mysqli_query($con,"delete from pairprosale where productid='$id' and itemmodule='Products'");
$anspricenames="";
$sqlpricenamequery=mysqli_query($con,"select count(salename) from pairprosale where productid='$id' and itemmodule='Products'");
...
$sqlupn = "insert into pairprosale set productid='$id',salename='$pricename',salemrp='$ansmrps',salecost='$anssellprices',saledescription='$ansdescriptions',itemmodule='Products',createdid='$companymainid'";
            $queryupn = mysqli_query($con, $sqlupn);
            $sqlupnpro = mysqli_query($con,"update pairproducts set salescost='$anssellprices' where id='$id'");
            if(!$queryupn){
               header('Location:productedit.php?error=Pricename Updated Unsuccessfully');
            }
}
else{
    $sqlupn = "insert into pairprosale set productid='$id',itemmodule='Products',createdid='$companymainid'";
            $queryupn = mysqli_query($con, $sqlupn);
            if(!$queryupn){
               header('Location:productedit.php?error=Pricename Added Unsuccessfully');
            }
}            

$sqlpricenamepurquerydel = mysqli_query($con,"delete from pairpropurchase where productid='$id' and itemmodule='Products'");
$anspricenamespur="";
$sqlpricenamepurquery=mysqli_query($con,"select count(purchasename) from pairpropurchase where productid='$id' and itemmodule='Products'");
...
$sqlupnpur = "insert into pairpropurchase set productid='$id',purchasename='$pricenamepur',purchasemrp='$ansmrpspur',purchasecost='$anssellpricespur',purchasedescription='$ansdescriptionspur',itemmodule='Products',createdid='$companymainid'";
    ...
    $sqlupn = "insert into pairpropurchase set productid='$id',itemmodule='Products',createdid='$companymainid'";
            $queryupn = mysqli_query($con, $sqlupn);
            if(!$queryupn){
               header('Location:productedit.php?error=Pricename Added Unsuccessfully');
            }
            ...
            else
            {
                ...
                if($productname!=$oldproname)
                {
                    if($ch!='')
                    {
                        $ch.='<br> '.$prohead.' Name <span style="color:green;" id="prohisfromtospan">( From '.$oldproname.' To '.$productname.' ) </span>';
                    }
                    else
                    {
                        $ch.=''.$prohead.' Name <span style="color:green;" id="prohisfromtospan">( From '.$oldproname.' To '.$productname.' ) </span>';
                    }                   
                }
                ...
                if($hsncode!=$oldprohsn)
                {
                    if($ch!='')
                    {
                        $ch.='<br> HSN Code <span style="color:green;" id="prohisfromtospan">( From '.$oldprohsn.' To '.$hsncode.' ) </span>';
                    }
                    else
                    {
                        $ch.='HSN Code <span style="color:green;" id="prohisfromtospan">( From '.$oldprohsn.' To '.$hsncode.' ) </span>';
                    }                   
                }
                if($category!=$oldprocat)
                {
                    if($ch!='')
                    {
                        $ch.='<br> '.$access['txtnamecategory'].' <span style="color:green;" id="prohisfromtospan">( From '.$oldprocat.' To '.$category.' ) </span>';
                    }
                    else
                    {
                        $ch.=''.$access['txtnamecategory'].' <span style="color:green;" id="prohisfromtospan">( From '.$oldprocat.' To '.$category.' ) </span>';
                    }                   
                }
                ...
                if($rack!=$oldprorack)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Rack <span style="color:green;" id="prohisfromtospan">( From '.$oldprorack.' To '.$rack.' ) </span>';
                    }
                    else
                    {
                        $ch.='Rack <span style="color:green;" id="prohisfromtospan">( From '.$oldprorack.' To '.$rack.' ) </span>';
                    }                   
                }
                ...
                if($barcodetitle!=$oldbarcodetitle)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Barcode Title <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodetitle.' To '.$barcodetitle.' ) </span>';
                    }
                    else
                    {
                        $ch.='Barcode Title <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodetitle.' To '.$barcodetitle.' ) </span>';
                    }                   
                }
                if($barcodehead!=$oldbarcodehead)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Barcode Subtitle <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodehead.' To '.$barcodehead.' ) </span>';
                    }
                    else
                    {
                        $ch.='Barcode Subtitle <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodehead.' To '.$barcodehead.' ) </span>';
                    }                   
                }
                if($barcodeformat!=$oldbarcodeformat)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Barcode Type <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodeformat.' To '.$barcodeformat.' ) </span>';
                    }
                    else
                    {
                        $ch.='Barcode Type <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodeformat.' To '.$barcodeformat.' ) </span>';
                    }                   
                }
                if($barcode!=$oldbarcode)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Barcode <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcode.' To '.$barcode.' ) </span>';
                    }
                    else
                    {
                        $ch.='Barcode <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcode.' To '.$barcode.' ) </span>';
                    }                   
                }
                if($underbarcodelabel!=$oldunderbarcodelabel)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Under Barcode label <span style="color:green;" id="prohisfromtospan">( From '.$oldunderbarcodelabel.' To '.$underbarcodelabel.' ) </span>';
                    }
                    else
                    {
                        $ch.='Under Barcode label <span style="color:green;" id="prohisfromtospan">( From '.$oldunderbarcodelabel.' To '.$underbarcodelabel.' ) </span>';
                    }                   
                }
                if($barcodenotes!=$oldbarcodenotes)
                {
                    if($ch!='')
                    {
                        $ch.='<br> Barcode Notes <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodenotes.' To '.$barcodenotes.' ) </span>';
                    }
                    else
                    {
                        $ch.='Barcode Notes <span style="color:green;" id="prohisfromtospan">( From '.$oldbarcodenotes.' To '.$barcodenotes.' ) </span>';
                    }                   
                }
                ...
                if($ch!='')
                {
                $sqluse=mysqli_query($con, "insert into pairusehistory set usetype='PRODUCTS', createdon='$times',  createdby='".$_SESSION["unqwerty"]."', useid='$id', useremarks='".$ch."' ");
                }
            }
            header('Location:productview.php?id='.$id.'&remarks=Updated Successfully');
...
if(isset($_POST['defaultunit']))
{
    $defaultunits=custom_escape_string($con, $_POST['defaultunit']);
...
// $hsncode=custom_escape_string($con, $_POST['hsncode']);
// //$foronline=(float)custom_escape_string($con, $_POST['foronline']);
// $purchaseaccounttype=custom_escape_string($con, $_POST['purchaseaccounttype']);
// $saleaccounttype=custom_escape_string($con, $_POST['saleaccounttype']);
// $taxpref=(float)custom_escape_string($con, $_POST['taxpref']);
// $taxratecountry=custom_escape_string($con, $_POST['taxratecountry']);
// $intratax=custom_escape_string($con, $_POST['intratax']);
// $intertax=custom_escape_string($con, $_POST['intertax']);
// $excemptionreason=custom_escape_string($con, $_POST['excemptionreason']);
// $trackinventory=(float)custom_escape_string($con, $_POST['trackinventory']);
// $inventoryaccounttype=custom_escape_string($con, $_POST['inventoryaccounttype']);
// $openingstock=(float)custom_escape_string($con, $_POST['openingstock']);
// $openingstockrate=(float)custom_escape_string($con, $_POST['openingstockrate']);
// $openingason=custom_escape_string($con, $_POST['openingason']);productcode='$productcode', productimage='$productimage', hsncode='$hsncode',, foronline='$foronline', viewaccess='$viewaccess', purchaseaccounttype='$purchaseaccounttype', saleaccounttype='$saleaccounttype', taxpref='$taxpref', taxratecountry='$taxratecountry', intratax='$intratax', intertax='$intertax', excemptionreason='$excemptionreason', trackinventory='$trackinventory', inventoryaccounttype='$inventoryaccounttype', openingstock='$openingstock', openingstockrate='$openingstockrate', openingason='$openingason'
// $msg = "";
// $msg_class = "";
//     if(($productname!=""))
//     {
...
//                 {
//                     $purchasename=custom_escape_string($con, $_POST['purchasename'][$ip]);
//                     $purchasemrp=custom_escape_string($con, $_POST['purchasemrp'][$ip]);
//                     $purchasecost=custom_escape_string($con, $_POST['purchasecost'][$ip]);
//                     $purchasediscount=custom_escape_string($con, $_POST['purchasediscount'][$ip]);
//                     $purchaseofferprice=custom_escape_string($con, $_POST['purchaseofferprice'][$ip]);
//                     $purchaseunit=custom_escape_string($con, $_POST['purchaseunit'][$ip]);
//                     $purchaseindunit=custom_escape_string($con, $_POST['purchaseindunit'][$ip]);
...
//                 {
//                     $salename=custom_escape_string($con, $_POST['salename'][$ip]);
//                     $salemrp=custom_escape_string($con, $_POST['salemrp'][$ip]);
//                     $salecost=custom_escape_string($con, $_POST['salecost'][$ip]);
//                     $salediscount=custom_escape_string($con, $_POST['salediscount'][$ip]);
//                     $saleofferprice=custom_escape_string($con, $_POST['saleofferprice'][$ip]);
//                     $saleunit=custom_escape_string($con, $_POST['saleunit'][$ip]);
//                     $saleindunit=custom_escape_string($con, $_POST['saleindunit'][$ip]);
...
// $unitname=custom_escape_string($con, $_POST['missingdefaultunit']);
// $uqc=custom_escape_string($con, $_POST['uqc']);
// if ($unitname!=$oldunitname||$uqc!=$olduqc) {
//     $unitnames=custom_escape_string($con, $_POST['missingdefaultunit']);
//     $uqcs=custom_escape_string($con, $_POST['uqc']);
...
// // $oldcategorys=$answercat['category'];
// $categorys=custom_escape_string($con,$_POST['category']);
// if ($categorys!=$oldcategorys) {
//     $categoryses=custom_escape_string($con,$_POST['category']);
...
//     $subcategory=custom_escape_string($con, $_POST['missingsubcategory']);
// if ($subcategory!=$oldsubcategorys) {
//     $subcategoryses=custom_escape_string($con,$_POST['missingsubcategory']);
...
?>
      ...
      <?php 
                                ...
                                <form action="" onsubmit="return checkvalidate()" method="post"
                                    ...
                                    <?php
     // if ((in_array('Product Information', $fieldedit))) {
        ?>
                                        ...
                                        <div class="accordion-item mb-1">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body text-sm">
                                                    <div class="row justify-content-center" <?=((in_array('Product Code', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Product Code"  disabled value="<?=$info['productcode']?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row justify-content-center" <?=((in_array('Product Public Code', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                     ...
                                                     <div class="row justify-content-center" <?=((in_array('Product Private Code', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Product Name"  required value="<?=$info['productname']?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
?>
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
                                                               ...
                                                               <div class="col-sm-8" id="uck" onclick="andus()"><select class="form-control  form-control-sm" name="defaultunit" id="defaultunit" <?=((in_array('Unit', $fieldedit))?'required':'')?>>
                                                                        ...
                                                                        <?php
                                                                        $sqliss = mysqli_query($con, "select * from pairproducts where id='".$id."' and itemmodule='Products'");
...
?>
                                                    ...
                                                    <div class="row justify-content-center" <?=((in_array('HSN Code', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="HSN Code" maxlength="100" value="<?=$info['hsncode']?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8" onclick="andus()">
                                                                    ...
                                                                    <option selected disabled><?=$access['txtnamecategory']?></option>
                                                                        ...
                                                                        $sqliss = mysqli_query($con, "select * from pairproducts where id='".$id."' and itemmodule='Products'");
                                                                        $infoss=mysqli_fetch_array($sqliss);
                                                                    $sqlic = mysqli_query($con, "select * from paircategory where (createdid='$companymainid' or createdid='0') and itemmodule='Products' and category!='' order by category asc");
  ...
  <div class="input-group-append">
    <select
                                                    ...
                                                    <div class="row justify-content-center" <?=((in_array('Rack', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control  form-control-sm" id="rack" name="rack" placeholder="Rack" value="<?=$info['rack']?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row justify-content-center" <?=((in_array('Delivery', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <?php
                                                                    $sqli = mysqli_query($con, "select delivery from pairproducts where ((franchisesession='".$_SESSION["franchisesession"]."' and pvisiblity='PRIVATE') or pvisiblity='PUBLIC') and id='".$id."' and itemmodule='Products' order by delivery asc");
                                    ...
                                    ?>
                                                    ...
                                                    ?>
                                                    <div class="accordion-item mb-1" <?=((in_array('Product Visibility', $fieldedit))?'':'style="display:none;"')?>>
...
<a class="purchaseadd-row btn btn-primary btn-sm btn-custom-grey addan" style="background-color: #e9ecef;height: 27px;padding-left: 4.5px;padding-right: 4.5px;position: relative;left: -157px;"><span style="position: relative;top: -3px;"><i style="font-size: 14px;color:#0066cc" class="fa fa-plus-circle"></i> Add another line </span></a></p>
    ...
    <input type="text" style="padding:5px 8px;border: 1px solid lightgrey;" 
                                    ...
                                    ?>-->
                                                    ...
                                                    <div class="accordion-item mb-1" <?=((in_array('Barcode Information', $fieldedit))?'':'style="display:none;"')?>>
                                            <h5 class="accordion-header" id="headingbarcode">
                                             ...
                                             <div id="collapsebarcode" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body text-sm">
                                                    <div class="row justify-content-center" <?=((in_array('Barcode Title', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Barcode Title" value="<?=$info['barcodetitle']?>" <?=(($info['barcodetitle']!='')?'readonly':'')?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row justify-content-center" <?=((in_array('Barcode Subtitle', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Barcode Subtitle" value="<?=$info['barcodehead']?>" <?=(($info['barcodehead']!='')?'readonly':'')?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row justify-content-center" <?=((in_array('Barcode Type', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="row">
                                                                      <div class="col-sm-6 my-1">
                                                                      <div class="custom-control custom-radio mr-sm-2">
                                                                        <input type="radio" class="custom-control-input" name="barcodeformat" id="ean13" value="EAN / UPC" <?= $info['barcodeformat']=='EAN / UPC'?'checked':'' ?> <?=(($info['barcodeformat']!='')?'disabled':'')?>>
                                                                        <label class="custom-control-label custom-label" for="ean13">EAN-13</label>
                                                                      </div>
                                                                      </div>
                                                                      <div class="col-sm-6 my-1">
                                                                      <div class="custom-control custom-radio mr-sm-2">
                                                                        <input type="radio" class="custom-control-input" name="barcodeformat" id="upca" value="EAN / UPC" <?= $info['barcodeformat']=='EAN / UPC'?'checked':'' ?> <?=(($info['barcodeformat']!='')?'disabled':'')?>>
                                                                        <label class="custom-control-label custom-label" for="upca">UPC-A</label>
                                                                      </div>
                                                                      </div>
                                                                      <div class="col-sm-6 my-1">
                                                                      <div class="custom-control custom-radio mr-sm-2">
                                                                        <input type="radio" class="custom-control-input" name="barcodeformat" id="code39" value="CODE39" <?= $info['barcodeformat']=='CODE39'?'checked':'' ?> <?=(($info['barcodeformat']!='')?'disabled':'')?>>
                                                                        <label class="custom-control-label custom-label" for="code39">Code-39</label>
                                                                      </div>
                                                                      </div>
                                                                      <div class="col-sm-6 my-1">
                                                                      <div class="custom-control custom-radio mr-sm-2">
                                                                        <input type="radio" class="custom-control-input" name="barcodeformat" id="itf" value="ITF" <?= $info['barcodeformat']=='ITF'?'checked':'' ?> <?=(($info['barcodeformat']!='')?'disabled':'')?>>
                                                    ...
                                                    <div class="row justify-content-center" <?=((in_array('Barcode', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Barcode" value="<?=$info['barcode']?>" <?=(($info['barcode']!='')?'readonly':'')?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row justify-content-center" <?=((in_array('Under Barcode Label', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Under Barcode Label" value="<?=$info['underbarcodelabel']?>" <?=(($info['underbarcodelabel']!='')?'readonly':'')?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row justify-content-center" <?=((in_array('Footer Note', $fieldedit))?'':'style="display:none;"')?>>
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Footer Note" value="<?=$info['barcodenotes']?>" <?=(($info['barcodenotes']!='')?'readonly':'')?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<!-- <div class="row justify-content-center">
    ...
    <input type="text" style="padding:5px 8px;border: 1px solid lightgrey;"
                                        ...
                                        <div class="accordion-item mb-1" <?=((in_array('Tax Information', $fieldedit))?'':'style="display:none;"')?>>
                                            ...
                                            <?php
                                            $sqlitax=mysqli_query($con, "select * from pairproducts where ((franchisesession='".$_SESSION["franchisesession"]."' and pvisiblity='PRIVATE') or pvisiblity='PUBLIC') and id='".$id."' and itemmodule='Products' order by productname asc");
