...
if (($_GET['term']=='purchasereturn')&&($_GET['sizes']=='a4')) {
...
$sqlismainaccessfield=mysqli_query($con, "select * from pairmainaccess where userid='$companymainid' and moduletype='Purchase Returns' order by id  asc");
...
$sqlismainaccessuser=mysqli_query($con, "select * from pairmainaccess where userid='$userid' and moduletype='Purchase Returns' order by id  asc");
...
$infomainaccessuser=mysqli_fetch_array($sqlismainaccessuser);
 ...
 $sql=mysqli_query($con, "select * from pairpurchasereturns where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and purchasereturnno='$purchasereturnno' and purchasereturndate='$purchasereturndate' order by id asc");
$count=1;
...
<span style="'.(($access['purreturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Phone </span>
<span style="'.(($access['purreturnbranchphone']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 88%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['mobile']).'</span>
<span style="'.(($access['purreturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">E-mail </span>
<span style="'.(($access['purreturnbranchemail']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['email']).'</span>
<span style="'.(($access['purreturnprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 20 </span>
<span style="'.(($access['purreturnprintdlno20']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno20']).'</span>
<span style="'.(($access['purreturnbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 10%;overflow: hidden;font-size: 12px !important;text-align: left !important;">GSTIN </span>
<span style="'.(($access['purreturnbranchgstin']=='0')?'visibility:hidden;':'').'display: inline-block;white-space: nowrap;width: 51%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['gstno']).'</span>
<span style="'.(($access['purreturnprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 14%;overflow: hidden;font-size: 12px !important;text-align: left !important;">DL No 21 </span>
<span style="'.(($access['purreturnprintdlno21']=='1')?'visibility:visible;':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 21%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['dlno21']).'</span>
</span>
...
<span style="'.(($access['purreturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['purreturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['purreturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['purreturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['purreturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['purreturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['purreturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['purreturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['purreturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 43%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['purreturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 48%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="visibility:hidden;display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['purchasereturndate']))).'</strong></span>
...
<span style="visibility:hidden;display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['purchasereturnterm']).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['purchasereturndate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['purchasereturnterm']).'</strong></span>
<span style="visibility:hidden;'.((in_array('DL No 20', $fieldview))?'display: inline-block;':'display: none;').'white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 96%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Payment Term</span></span>
<span style="visibility:hidden;display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['purchasereturnterm']).'</strong></span>
<span style="visibility:hidden;'.((in_array('DL No 21', $fieldview))?'display: inline-block;':'display: none;').'white-space: nowrap;width: 55%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><span style="display: inline-block;white-space: nowrap;width: 96%;overflow: hidden;font-size: 14px !important;text-align: left !important;position:relative;top:3px;">Payment Term</span></span>
<span style="visibility:hidden;display: inline-block;white-space: nowrap;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['purchasereturnterm']).'</strong></span>
...
$sqlitaxes=mysqli_query($con, "select * from pairpurchasereturns where franchisesession='".$_SESSION['franchisesession']."' and createdid='$companymainid' and purchasereturnno='$purchasereturnno' and purchasereturndate='$purchasereturndate' order by id asc");
...
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 3px !important;text-align: left !important;min-width:18px;max-width:18px;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.($access['txtprodispurchasereturn']).'</th>
<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtypurchasereturn']).'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:47px;max-width:47px;">'.($access['txttaxablepurchasereturn']).'</th>';
}
if ((in_array('Sale Quantity', $fieldview))) {
$html .= '<th style="border: 1px solid #cccccc;overflow:hidden;white-space: nowrap !important;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;background-color: #1BBC9B;min-width:25px;max-width:25px;white-space:nowrap !important;">'.($access['purreturntxtsqty']).'</th>';
}
$html .= '</tr>
</thead>
<tbody>';
...
$mask = 'dompdf/Purchase Returns-*.*';
array_map('unlink', glob($mask));
$output = $dompdf->output();
file_put_contents("dompdf/".$_GET['names'].".pdf", $output);
} 
if (($_GET['term']=='purchasereturn')&&($_GET['sizes']=='a5')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
if (($_GET['term']=='purchasereturn')&&($_GET['sizes']=='dt')) {
// Instantiate and use the dompdf class 
$dompdf = new Dompdf();
include('lcheck.php');
$dateformat = mysqli_query($con,"select * from paricountry");
...
<span style="'.(($access['purreturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Bank </span>
<span style="'.(($access['purreturnbank']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['bank']).'</span>
<span style="'.(($access['purreturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Name </span>
<span style="'.(($access['purreturnname']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['names']).'</span>
<span style="'.(($access['purreturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Account Number </span>
<span style="'.(($access['purreturnaccnumber']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['accountnumber']).'</span>
<span style="'.(($access['purreturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">IFSC Code </span>
<span style="'.(($access['purreturnifsccode']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['ifsccode']).'</span>
<span style="'.(($access['purreturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 35%;overflow: hidden;font-size: 12px !important;text-align: left !important;">Branch & City </span>
<span style="'.(($access['purreturnbranchandcity']=='1')?'':'visibility:hidden;').'display: inline-block;white-space: nowrap;width: 63%;overflow: hidden;font-size: 12px !important;text-align: left !important;">: '.($info['branchandcity']).'</span>
</span>
</div>
...
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.(date($date,strtotime($rows[0]['purchasereturndate']))).'</strong></span>
...
<span style="display: inline-block;white-space: nowrap;position:relative;top:-6px;width: 42%;overflow: hidden;font-size: 14px !important;text-align: left !important;"><strong>: '.($rows[0]['purchasereturnterm']).'</strong></span>
</span>
</div>
</header>
<footer>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;min-width:18px;max-width:18px;'.((in_array('Quantity', $fieldview))?'':'display:none !important;').'">'.($access['txtqtypurchasereturn']).'</th>
...
<th style="border: 1px dashed #000000;white-space: nowrap !important;max-width: 15px !important;min-width: 15px !important;overflow: hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;'.((in_array('Discount', $fieldview))?'':'display:none !important;').'">'.$access['txtprodispurchasereturn'].'</th>
...
if ((in_array('Taxable Value', $fieldview))) {
$html .= '<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align:right !important;min-width:40px;max-width:40px;"><span style="display: block;overflow: hidden;height: 18px;">'.($access['txttaxablepurchasereturn']).'</span></th>';
}
if ((in_array('Sale Quantity', $fieldview))) {
$html .= '<th style="border: 1px dashed #000000;white-space: nowrap !important;overflow:hidden;font-size: 12px !important;padding:0px 6px !important;text-align: right !important;background-color: #1BBC9B;min-width:72px;max-width:72px;">'.($access['purreturntxtsqty']).'</th>';
}
$html .= '</tr>
</thead>
<tbody>';
