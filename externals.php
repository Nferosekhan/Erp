...
/*      box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);*/
    ...
    .barcodediv button:hover {
      background-color: #d32f2f;
    }
    .barcodediv .form-group {
      margin-bottom: 15px;
    }
    .barcodediv label {
/*      font-size: 14px;*/
    ...
    .barcodediv input[type="text"], select {
      width: 100%;
      padding: 8px;
      margin-top: 5px;
